...
public class SaveJlinkArgfilesPluginTest {
    ...
    public static void main(String[] args) throws Throwable {
        ...
        Files.writeString(argfile2, "--vendor-version=\"XyzzyVM 3.14.15\" --vendor-bug-url=https:
        ...
        oa.shouldNotMatch("java.vendor.url.bug = https:
        ...
        oa.stderrShouldMatch("java.vendor.url.bug = https:
