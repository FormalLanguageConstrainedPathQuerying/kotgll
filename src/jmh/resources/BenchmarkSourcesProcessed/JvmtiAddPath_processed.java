...
public class JvmtiAddPath {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String appJar = TestCommon.getTestJar("jvmti_app.jar");         
        String addappJar = TestCommon.getTestJar("jvmti_addapp.jar");   
        String addbootJar = TestCommon.getTestJar("jvmti_addboot.jar"); 
        ...
        run(check_appcds_enabled, appJar, "-Xlog:class+load", "JvmtiApp", "noadd"); 

        System.out.println("Test case 2: add to boot classpath only - should find Hello.class in boot loader");
        run(check_appcds_disabled, appJar, "-Xlog:class+load", "JvmtiApp", "bootonly", addbootJar); 
