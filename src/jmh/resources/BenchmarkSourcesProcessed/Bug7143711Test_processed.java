...
public class Bug7143711Test {
    private static final String SCHEMA_LANGUAGE = "http:
    private static final String SCHEMA_SOURCE = "http:

    private static final String DOM_FACTORY_ID = "javax.xml.parsers.DocumentBuilderFactory";
    private static final String SAX_FACTORY_ID = "javax.xml.parsers.SAXParserFactory";

    private static final String ORACLE_FEATURE_SERVICE_MECHANISM = "http:
    ...
    public void testXPath_DOM_withSM() {
        ...
        try {
            XPathFactory xPathFactory = XPathFactory.newInstance("http:
