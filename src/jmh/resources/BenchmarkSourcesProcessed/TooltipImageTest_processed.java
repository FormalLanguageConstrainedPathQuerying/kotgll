...
public class TooltipImageTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SwingUtilities.invokeAndWait(() -> {
            ...
            tip.setTipText("<html><img width=\"100\" src=\"file:
            checkSize(tip, 100, 100);

            tip.setTipText("<html><img height=\"100\" src=\"file:
            checkSize(tip, 100, 100);

            tip.setTipText("<html><img src=\"file:
            checkSize(tip, 200, 200);

            tip.setTipText("<html><img width=\"50\" src=\"file:
            checkSize(tip, 50, 50);

            tip.setTipText("<html><img height=\"50\" src=\"file:
            checkSize(tip, 50, 50);

            tip.setTipText("<html><img width=\"100\" height=\"50\" src=\"file:
