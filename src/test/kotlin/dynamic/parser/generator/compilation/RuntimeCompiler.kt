...
object RuntimeCompiler {
    ...
    /**
     * Compile java source of lexer generated by jflex
     */
    fun compileJavaSource(filesToCompile: List<File>, outputPath: String) {
        val compiler: JavaCompiler = ToolProvider.getSystemJavaCompiler()
        val fileManager = compiler.getStandardFileManager(null, null, null)

        val options = listOf("-d", outputPath)
        // Compile the file
        compiler.getTask(null, fileManager, null, options, null, fileManager.getJavaFileObjectsFromFiles(filesToCompile)).call()
        fileManager.close()
    }
}