...
public class GeoTileUtilsTests extends ESTestCase {
    ...
    public void testStringEncode() {
        ...
        expectThrows(IllegalArgumentException.class, () -> stringEncode(0x7800000000000000L)); 
        expectThrows(IllegalArgumentException.class, () -> stringEncode(0x0000000000000001L)); 
        expectThrows(IllegalArgumentException.class, () -> stringEncode(0x0000000020000000L)); 
