...
public class SamlLogoutRequestMessageBuilderTests extends SamlTestCase {
    ...
    private static final String SP_ENTITY_ID = "http:
    private static final String IDP_ENTITY_ID = "http:
    ...
    public void init() throws Exception {
        ...
        sp = new SpConfiguration(SP_ENTITY_ID, "http:
    ...
    public void testBuildValidRequest() throws Exception {
        final SingleLogoutService sloPost = logoutService(SAMLConstants.SAML2_POST_BINDING_URI, "http:
        ...
        assertThat(logoutRequest.getDestination(), equalTo("http:
