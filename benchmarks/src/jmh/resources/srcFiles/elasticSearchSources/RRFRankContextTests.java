    ...
    public void testShardCombine() {
        ...
        List<TopDocs> topDocs = List.of(
            new TopDocs(
                null,
                new ScoreDoc[] {
                    new ScoreDoc(1, 10.0f, -1), 
                    new ScoreDoc(2, 9.0f, -1),  
                    new ScoreDoc(3, 8.0f, -1),  
                    new ScoreDoc(4, 7.0f, -1),  
                    new ScoreDoc(5, 6.0f, -1),  
                    new ScoreDoc(6, 5.0f, -1),  
                    new ScoreDoc(7, 4.0f, -1),  
                    new ScoreDoc(8, 3.0f, -1),  
                    new ScoreDoc(9, 2.0f, -1),  
                    new ScoreDoc(10, 1.0f, -1), 
                }
            ),
            new TopDocs(
                null,
                new ScoreDoc[] {
                    new ScoreDoc(8, 8.0f, -1),  
                    new ScoreDoc(9, 7.0f, -1),  
                    new ScoreDoc(10, 6.0f, -1), 
                    new ScoreDoc(11, 5.0f, -1), 
                    new ScoreDoc(12, 4.0f, -1), 
                    new ScoreDoc(13, 3.0f, -1), 
                    new ScoreDoc(14, 2.0f, -1), 
                    new ScoreDoc(15, 1.0f, -1), 
                }
            )
        );
