...
public class IpScriptFieldTermQueryTests extends AbstractIpScriptFieldQueryTestCase<IpScriptFieldTermQuery> {
    ...
    public void testMatches() {
        ...
        assertTrue(query.matches(new BytesRef[] { ip }, 1));            
        assertFalse(query.matches(new BytesRef[] { notIpRef }, 1));     
        assertFalse(query.matches(new BytesRef[] { notIpRef, ip }, 1)); 
        assertTrue(query.matches(new BytesRef[] { notIpRef, ip }, 2));  
    }
