...
public class JavaDateMathParserTests extends ESTestCase {
    ...
    public void testMergingOfMultipleParsers() {
        ...
        assertThat(parsed.toEpochMilli(), equalTo(999L));
    ...
    public void testWeekBasedDate() {
        DateFormatter formatter = DateFormatter.forPattern("strict_basic_week_date");
        assertDateMathEquals(formatter.toDateMathParser(), "2022W0101", "2022-01-03T23:59:59.999Z", 0, true, ZoneOffset.UTC);

        formatter = DateFormatter.forPattern("YYYY'W'ww[e]");
    ...
    public void testAMPM() {
        ...
        formatter = DateFormatter.forPattern("MM/dd/yyyy KK:mm a"); 
    ...
    public void testExplicitRounding() {
        ...
        assertDateMathEquals("2014-07-22||/w", "2014-07-20T22:00:00.000Z", 0, false, ZoneId.of("CET")); 
