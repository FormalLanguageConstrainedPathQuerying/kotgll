...
public class AzureStorageServiceTests extends ESTestCase {
    ...
    public void testCreateClientWithEndpointSuffix() throws IOException {
        ...
        try (AzureRepositoryPlugin plugin = pluginWithSettingsValidation(settings)) {
            ...
            assertThat(client1.getSyncClient().getAccountUrl(), equalTo("https:

            AzureBlobServiceClient client2 = azureStorageService.client("azure2", LocationMode.PRIMARY_ONLY);
            assertThat(client2.getSyncClient().getAccountUrl(), equalTo("https:
        }
    }
    ...
    public void testReinitClientSettings() throws IOException {
        ...
        try (AzureRepositoryPlugin plugin = pluginWithSettingsValidation(settings1)) {
            ...
            assertThat(client11.getSyncClient().getAccountUrl(), equalTo("https:

            AzureBlobServiceClient client12 = azureStorageService.client("azure2", LocationMode.PRIMARY_ONLY);
            assertThat(client12.getSyncClient().getAccountUrl(), equalTo("https:
            ...
            assertThat(client21.getSyncClient().getAccountUrl(), equalTo("https:
            ...
            assertThat(client23.getSyncClient().getAccountUrl(), equalTo("https:
        }
    }
    ...
    public void testRetryConfigurationForSecondaryFallbackLocationModeImpl(boolean endpointSetting) throws Exception {
        ...
        if (endpointSetting) {
            ...
            endpoint = "ignored;BlobEndpoint=https:
                + "BlobSecondaryEndpoint=https:
        }
        ...
        try (AzureRepositoryPlugin plugin = pluginWithSettingsValidation(settings)) {
            ...
            assertThat(retryOptions.getSecondaryHost(), equalTo("https:
        }
    }
    ...
    public void testInvalidSettingsRetryConfigurationForLocationModeWithSecondaryFallback() throws Exception {
        final String endpoint = "ignored;BlobEndpoint=https:
        final Settings settings = Settings.builder()
            .setSecureSettings(buildSecureSettings())
            .put("azure.client.azure1.endpoint_suffix", endpoint)
            .build();
    ...
    public void testCreateClientWithEndpoints() throws IOException {
        final Settings settings = Settings.builder()
            .setSecureSettings(buildSecureSettings())
            .put("azure.client.azure1.endpoint", "https:

            .put("azure.client.azure2.endpoint", "https:
            .put("azure.client.azure2.secondary_endpoint", "https:
            .build();
        try (AzureRepositoryPlugin plugin = pluginWithSettingsValidation(settings)) {
            final AzureStorageService azureStorageService = plugin.azureStoreService.get();
    ...
    public void testEndpointSettingValidation() {
        {
            final SettingsException e = expectThrows(
                ...
                () -> storageServiceWithSettingsValidation(
                    Settings.builder()
                        .setSecureSettings(buildSecureSettings())
                        .put("azure.client.azure1.secondary_endpoint", "https:
                        .build()
                )
            );
