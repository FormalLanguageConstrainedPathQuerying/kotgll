    ...
    private static String createOGCIndexRequest() throws Exception {
        ...
        createIndex.startObject("mappings");
        {
            createIndex.startObject("properties");
            {
                ...
                createIndex.startObject("shore").field("type", "shape").endObject(); 

                createString("aliases", createIndex); 
                createIndex.startObject("num_lanes").field("type", "integer").endObject(); 
                createIndex.startObject("centerline").field("type", "shape").endObject(); 

                createIndex.startObject("centerlines").field("type", "shape").endObject(); 

                createIndex.startObject("boundary").field("type", "shape").endObject(); 

                createIndex.startObject("position").field("type", "shape").endObject(); 

                createString("address", createIndex); 
                createIndex.startObject("footprint").field("type", "shape").endObject(); 

                createIndex.startObject("type").field("type", "keyword").endObject(); 
                createIndex.startObject("shores").field("type", "shape").endObject(); 

                createIndex.startObject("neatline").field("type", "shape").endObject(); 
