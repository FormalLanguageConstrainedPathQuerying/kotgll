...
public class RetryHttpInitializerWrapperTests extends ESTestCase {
    ...
    public void testSimpleRetry() throws Exception {
        ...
        HttpRequest request = client.getRequestFactory().buildRequest("Get", new GenericUrl("http:
    ...
    public void testRetryWaitTooLong() throws Exception {
        ...
        HttpRequest request1 = client.getRequestFactory().buildRequest("Get", new GenericUrl("http:
        try {
            request1.execute();
