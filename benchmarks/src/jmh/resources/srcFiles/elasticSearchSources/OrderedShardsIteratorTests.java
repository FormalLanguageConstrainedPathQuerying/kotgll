...
public class OrderedShardsIteratorTests extends ESAllocationTestCase {
    ...
    public void testReOrdersShardDuringIteration() {
        ...
        iterator.dePrioritizeNode(first.currentNodeId());
        assertThat(iterator.next(), isIndexShardAt("index-3", "node-3"));
        assertThat(iterator.next(), isIndexShardAt("index-2", "node-2"));
