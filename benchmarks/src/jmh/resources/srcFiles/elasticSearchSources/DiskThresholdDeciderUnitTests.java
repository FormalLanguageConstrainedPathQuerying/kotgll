...
public class DiskThresholdDeciderUnitTests extends ESAllocationTestCase {
    ...
    private void doTestCannotAllocateDueToLackOfDiskResources(boolean testMaxHeadroom) {
        ...
        Map<String, DiskUsage> leastAvailableUsages = Map.of("node_0", new DiskUsage("node_0", "node_0", "_na_", totalBytes, 0)); 
    ...
    public void testDecidesYesIfWatermarksIgnored() {
        ...
        allFullUsages.put("node_0", new DiskUsage("node_0", "node_0", "_na_", 100, 0)); 
        allFullUsages.put("node_1", new DiskUsage("node_1", "node_1", "_na_", 100, 0)); 
    ...
    public void testCannotForceAllocateOver100PercentUsage() {
        ...
        Map<String, DiskUsage> leastAvailableUsages = Map.of("node_0", new DiskUsage("node_0", "node_0", "_na_", 100, 0)); 
        Map<String, DiskUsage> mostAvailableUsage = Map.of("node_0", new DiskUsage("node_0", "node_0", "_na_", 100, 0)); 
