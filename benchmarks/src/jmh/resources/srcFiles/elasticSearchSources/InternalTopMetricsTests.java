        ...
        return new InternalTopMetrics(
            ...
            List.of(
                new InternalTopMetrics.TopMetric(
                    ...
                    SortValue.from(1),
                    Arrays.asList(
                        new MetricValue(DocValueFormat.RAW, SortValue.from(1)),   
                        new MetricValue(DocValueFormat.RAW, SortValue.from(5.0)), 
                        new MetricValue(DocValueFormat.RAW, SortValue.from(new BytesRef("cat"))), 
                        null                                                      
                    )
                )
            ),
