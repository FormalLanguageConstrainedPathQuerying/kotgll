...
public abstract class AggregatorTestCase extends ESTestCase {
    ...
    private static final List<String> TYPE_TEST_BLACKLIST = List.of(
        ObjectMapper.CONTENT_TYPE, 
        GeoShapeFieldMapper.CONTENT_TYPE, 
        DenseVectorFieldMapper.CONTENT_TYPE, 
        SparseVectorFieldMapper.CONTENT_TYPE, 

        NestedObjectMapper.CONTENT_TYPE, 
        PassThroughObjectMapper.CONTENT_TYPE, 
        CompletionFieldMapper.CONTENT_TYPE, 
        FieldAliasMapper.CONTENT_TYPE 
    );
    ...
    private IndexSearcher newIndexSearcher(IndexReader indexReader, boolean supportsParallelCollection) throws IOException {
        return new ContextIndexSearcher(
            ...
            indexReader instanceof DirectoryReader ? randomBoolean() : false, 
            this.threadPoolExecutor,
            this.threadPoolExecutor.getMaximumPoolSize(),
            supportsParallelCollection ? 1 /* forces multiple slices */ : Integer.MAX_VALUE 
        );
    }
