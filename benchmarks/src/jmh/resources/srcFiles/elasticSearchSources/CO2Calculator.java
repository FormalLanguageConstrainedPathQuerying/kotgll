...
final class CO2Calculator {
    ...
    private static final double DEFAULT_CO2_TONS_PER_KWH = 0.000379069d; 
    private static final double DEFAULT_KILOWATTS_PER_CORE_X86 = 7.0d / 1000.0d; 
    private static final double DEFAULT_KILOWATTS_PER_CORE_ARM64 = 2.8d / 1000.0d; 
    private static final double DEFAULT_KILOWATTS_PER_CORE = DEFAULT_KILOWATTS_PER_CORE_X86; 
