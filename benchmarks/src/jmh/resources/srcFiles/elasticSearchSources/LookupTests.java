...
public class LookupTests extends ESTestCase {
    ...
    public interface V extends Y, Z {} 

    public interface U extends X {      
        String getString2(int x, int y);    

        String getString1(int param0);      
    ...
    public interface S extends U, X {} 

    public static class AA implements X {}                           

    public static class AB extends AA implements S {                  
    ...
    public static class AC extends AB implements V {                  
        public String getString2(int x, int y) {
            return "" + x + y;
        }     
    }

    public static class AD extends AA implements X, S, T {            
        public String getString2(int x, int y) {
            return "" + x + y;
        }     
