...
public class ExpirationCallbackTests extends ESTestCase {
    ...
    public void testPostExpirationDelay() throws Exception {
        ...
        assertThat(post.delay(expiryDate, expiryDate), equalTo(min)); 
    ...
    public void testPreExpirationDelay() throws Exception {
        ...
        long now = System.currentTimeMillis();
        long expiryDate = now + expiryDuration.getMillis();
        assertThat(pre.delay(expiryDate, expiryDate), nullValue()); 
    ...
    private void assertExpirationCallbackDelay(
        ...
        int deltaAfterLatestMatch = between(latestValidTriggerDelay + 1, Integer.MAX_VALUE); 
