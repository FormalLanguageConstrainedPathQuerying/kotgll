...
public class TransportSamlInitiateSingleSignOnActionTests extends IdpSamlTestCase {
    ...
    public void testGetResponseForRegisteredSp() throws Exception {
        ...
        request.setSpEntityId("https:
        request.setAssertionConsumerService("https:
        ...
        assertThat(response.getEntityId(), equalTo("https:
        assertThat(response.getPostUrl(), equalTo("https:
        ...
        assertThat(response.getSamlResponse(), containsString("https:
    }
    ...
    public void testGetResponseForNotRegisteredSpInIdpInitiated() throws Exception {
        ...
        Exception e = expectThrows(Exception.class, () -> future.get());
        assertThat(e.getCause().getMessage(), containsString("https:
    ...
    private TransportSamlInitiateSingleSignOnAction setupTransportAction(boolean withSecondaryAuth) throws Exception {
        final Settings settings = Settings.builder()
            ...
            .put("xpack.idp.entity_id", "https:
            .put("xpack.idp.sso_endpoint.redirect", "https:
            .put("xpack.idp.organization.url", "https:
        ...
        mockRegisteredServiceProvider(serviceResolver, "https:
        mockRegisteredServiceProvider(serviceResolver, "https:
    ...
    private void assertContainsAttributeWithValue(String message, String attribute, String value) {
        assertThat(message, containsString(Strings.format("""
            <saml2:Attribute FriendlyName="%s" Name="https:
