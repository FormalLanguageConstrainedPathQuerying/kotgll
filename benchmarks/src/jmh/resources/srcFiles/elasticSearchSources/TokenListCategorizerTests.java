...
public class TokenListCategorizerTests extends CategorizationTestCase {
    ...
    public void testWeightCalculator() throws IOException {
        ...
        assertThat(weightCalculator.calculateWeight("Info"), equalTo(3)); 
        assertThat(weightCalculator.calculateWeight("my_host"), equalTo(1)); 
        assertThat(weightCalculator.calculateWeight("web"), equalTo(3)); 
        assertThat(weightCalculator.calculateWeight("service"), equalTo(3)); 
        assertThat(weightCalculator.calculateWeight("starting"), equalTo(31)); 
        assertThat(weightCalculator.calculateWeight("user123"), equalTo(1)); 
        assertThat(weightCalculator.calculateWeight("a"), equalTo(1)); 
        assertThat(weightCalculator.calculateWeight("cool"), equalTo(3)); 
        assertThat(weightCalculator.calculateWeight("web"), equalTo(3)); 
        assertThat(weightCalculator.calculateWeight("service"), equalTo(13)); 
        assertThat(weightCalculator.calculateWeight("called"), equalTo(13)); 
        assertThat(weightCalculator.calculateWeight("my_service"), equalTo(1)); 
        assertThat(weightCalculator.calculateWeight("is"), equalTo(3)); 
        assertThat(weightCalculator.calculateWeight("starting"), equalTo(6)); 
