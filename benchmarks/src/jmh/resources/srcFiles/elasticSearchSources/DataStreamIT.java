...
public class DataStreamIT extends ESIntegTestCase {
    ...
    public void testAutoCreateV1TemplateNoDataStream() {
        ...
        v1Request.order(Integer.MAX_VALUE); 
    ...
    public void testSegmentsSortedOnTimestampDesc() throws Exception {
        ...
        indexDocs("metrics-foo", numDocs1); 
        int numDocs2 = randomIntBetween(2, 10);
        indexDocs("metrics-foo", numDocs2); 
        int numDocs3 = randomIntBetween(2, 10);
        indexDocs("metrics-foo", numDocs3); 
        ...
        assertResponse(
            ...
            resp -> {
                ...
                long timestamp1 = Long.valueOf(hits[0].field(DEFAULT_TIMESTAMP_FIELD).getValue()); 
                long timestamp2 = Long.valueOf(hits[0 + numDocs3].field(DEFAULT_TIMESTAMP_FIELD).getValue()); 
                long timestamp3 = Long.valueOf(hits[0 + numDocs3 + numDocs2].field(DEFAULT_TIMESTAMP_FIELD).getValue());  
