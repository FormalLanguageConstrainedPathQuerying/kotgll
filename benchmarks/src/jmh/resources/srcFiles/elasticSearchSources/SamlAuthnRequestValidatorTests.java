...
public class SamlAuthnRequestValidatorTests extends IdpSamlTestCase {
    ...
    public void setupValidator() throws Exception {
        ...
        when(idp.getEntityId()).thenReturn("https:
        when(idp.getSingleSignOnEndpoint(SAML2_REDIRECT_BINDING_URI)).thenReturn(new URL("https:
        final SamlServiceProvider sp1 = Mockito.mock(SamlServiceProvider.class);
        when(sp1.getEntityId()).thenReturn("https:
        when(sp1.getAssertionConsumerService()).thenReturn(new URL("https:
        ...
        when(sp2.getEntityId()).thenReturn("https:
        when(sp2.getAssertionConsumerService()).thenReturn(new URL("https:
        ...
        mockRegisteredServiceProvider(idp, "https:
        mockRegisteredServiceProvider(idp, "https:
    ...
    public void testValidAuthnRequest() throws Exception {
        ...
        assertThat(response.getSpEntityId(), equalTo("https:
