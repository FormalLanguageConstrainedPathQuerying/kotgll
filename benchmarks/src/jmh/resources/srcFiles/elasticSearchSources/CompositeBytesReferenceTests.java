...
public class CompositeBytesReferenceTests extends AbstractBytesReferenceTestCase {
    ...
    public void testSliceIsNotCompositeIfMatchesSingleSubSlice() {
        ...
        assertThat(bytesRef.slice(13, 10), Matchers.not(Matchers.instanceOf(CompositeBytesReference.class))); 
        assertThat(bytesRef.slice(12, 15), Matchers.not(Matchers.instanceOf(CompositeBytesReference.class))); 
    }
