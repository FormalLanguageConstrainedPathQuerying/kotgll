...
public class SamlIdentityProviderBuilderTests extends IdpSamlTestCase {
    ...
    public void testAllSettings() throws Exception {
        ...
        Settings settings = Settings.builder()
            ...
            .put(IDP_SSO_REDIRECT_ENDPOINT.getKey(), "https:
            .put(IDP_SSO_POST_ENDPOINT.getKey(), "https:
            .put(IDP_SLO_REDIRECT_ENDPOINT.getKey(), "https:
            .put(IDP_SLO_POST_ENDPOINT.getKey(), "https:
            ...
            .put(IDP_ORGANIZATION_URL.getKey(), "https:
        ...
        assertThat(idp.getSingleSignOnEndpoint(SAML2_REDIRECT_BINDING_URI).toString(), equalTo("https:
        assertThat(idp.getSingleSignOnEndpoint(SAML2_POST_BINDING_URI).toString(), equalTo("https:
        assertThat(idp.getSingleLogoutEndpoint(SAML2_REDIRECT_BINDING_URI).toString(), equalTo("https:
        assertThat(idp.getSingleLogoutEndpoint(SAML2_POST_BINDING_URI).toString(), equalTo("https:
        assertThat(idp.getAllowedNameIdFormats(), hasSize(1));
        assertThat(idp.getAllowedNameIdFormats(), Matchers.contains(TRANSIENT));
        assertThat(
            idp.getOrganization(),
            equalTo(new SamlIdentityProvider.OrganizationInfo("organization_name", "organization_display_name", "https:
        );
