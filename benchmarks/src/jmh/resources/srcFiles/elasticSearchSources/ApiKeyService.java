...
public class ApiKeyService {
    ...
    private static final long EVICTION_WARNING_THRESHOLD = 15L * EVICTION_MONITOR_INTERVAL_SECONDS; 
    ...
    static String buildDelimitedStringWithLimit(final int limit, final String... values) {
        ...
        final int capacityForOmittedInfoText = 5; 
