...
public class Ec2NetworkTests extends ESTestCase {
    ...
    public void testNetworkHostUnableToResolveEc2() {
        AccessController.doPrivileged(
            (PrivilegedAction<String>) () -> System.setProperty(EC2_METADATA_SERVICE_OVERRIDE_SYSTEM_PROPERTY, "http:
        );
        ...
        try {
            ...
            assertThat(
                e.getMessage(),
                equalTo("IOException caught when fetching InetAddress from [http:
            );
        }
    }
