...
public class TasksIT extends ESIntegTestCase {
    ...
    public void testTransportBulkTasks() {
        registerTaskManagerListeners(TransportBulkAction.NAME);  
        registerTaskManagerListeners(TransportBulkAction.NAME + "[s]");  
        registerTaskManagerListeners(TransportBulkAction.NAME + "[s][p]");  
        registerTaskManagerListeners(TransportBulkAction.NAME + "[s][r]");  
        createIndex("test");
        ensureGreen("test"); 
