    ...
    */
    ...
    public void testNormalizedReturnValues() throws Exception {
        ...
        for (int onValue = 0; onValue < TEST_VALUES.length; onValue += 9) {
            newDurationTester(((Boolean) TEST_VALUES[onValue]).booleanValue(), 
                    ((Boolean) NORM_VALUES[onValue]).booleanValue(), 
                    (BigInteger) TEST_VALUES[onValue + 1], 
                    (BigInteger) NORM_VALUES[onValue + 1], 
                    (BigInteger) TEST_VALUES[onValue + 2], 
                    (BigInteger) NORM_VALUES[onValue + 2], 
                    (BigInteger) TEST_VALUES[onValue + 3], 
                    (BigInteger) NORM_VALUES[onValue + 3], 
                    (BigInteger) TEST_VALUES[onValue + 4], 
                    (BigInteger) NORM_VALUES[onValue + 4], 
                    (BigInteger) TEST_VALUES[onValue + 5], 
                    (BigInteger) NORM_VALUES[onValue + 5], 
                    (BigDecimal) TEST_VALUES[onValue + 6], 
                    (BigDecimal) NORM_VALUES[onValue + 6], 
                    ((Long) TEST_VALUES[onValue + 7]).longValue(), 
                    ((Long) NORM_VALUES[onValue + 7]).longValue(), 
                    (String) TEST_VALUES[onValue + 8], 
                    (String) NORM_VALUES[onValue + 8]); 

            newDurationDayTimeTester(((Boolean) TEST_VALUES[onValue]).booleanValue(), 
                    ((Boolean) NORM_VALUES[onValue]).booleanValue(), 
                    BigInteger.ZERO, 
                    BigInteger.ZERO, 
                    BigInteger.ZERO, 
