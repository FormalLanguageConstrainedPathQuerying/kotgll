...
public class ExpectContinueResetTest {
    ...
    public void setup() throws Exception {
        ...
        warmup = URI.create("http:
        partialResponseResetNoError = URI.create("http:
        partialResponseResetError = URI.create("http:
        fullResponseResetNoError = URI.create("http:
        fullResponseResetError = URI.create("http:
