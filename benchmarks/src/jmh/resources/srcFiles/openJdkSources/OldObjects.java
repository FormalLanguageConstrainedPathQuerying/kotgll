...
final public class OldObjects {
    ...
    public static final int MIN_SIZE = 99901; 
    public final static int LEAK_CONTEXT = 100; 
    public final static int ROOT_CONTEXT = 100; 
    public final static int MAX_CHAIN_LENGTH = LEAK_CONTEXT + ROOT_CONTEXT; 
