...
public final class Math {
    ...
    public static float fma(float a, float b, float c) {
        if (Float.isFinite(a) && Float.isFinite(b) && Float.isFinite(c)) {
            if (a == 0.0 || b == 0.0) {
                ...
                return (new BigDecimal((double)a * (double)b) 
                        .add(new BigDecimal((double)c)))      
                    .floatValue();                            
            }
        } else {
    ...
    public static double ulp(double d) {
        ...
        return switch(exp) {
            case Double.MAX_EXPONENT + 1 -> Math.abs(d);      
            case Double.MIN_EXPONENT - 1 -> Double.MIN_VALUE; 
            default -> {
    ...
    public static float ulp(float f) {
        ...
        return switch(exp) {
            case Float.MAX_EXPONENT + 1 -> Math.abs(f);     
            case Float.MIN_EXPONENT - 1 -> Float.MIN_VALUE; 
            default -> {
