...
final class Int512Vector extends IntVector {
    ...
    public final Int512Vector broadcast(int e) {
        return (Int512Vector) super.broadcastTemplate(e);  
    }
    ...
    Int512Vector uOp(FUnOp f) {
        return (Int512Vector) super.uOpTemplate(f);  
    }
    ...
    Int512Vector uOp(VectorMask<Integer> m, FUnOp f) {
        return (Int512Vector)
            super.uOpTemplate((Int512Mask)m, f);  
    }
    ...
    Int512Vector bOp(Vector<Integer> v, FBinOp f) {
        return (Int512Vector) super.bOpTemplate((Int512Vector)v, f);  
    }
    ...
    public Int512Vector lanewise(Unary op) {
        return (Int512Vector) super.lanewiseTemplate(op);  
    }

    @Override
    @ForceInline
    public Int512Vector lanewise(Unary op, VectorMask<Integer> m) {
        return (Int512Vector) super.lanewiseTemplate(op, Int512Mask.class, (Int512Mask) m);  
    }

    @Override
    @ForceInline
    public Int512Vector lanewise(Binary op, Vector<Integer> v) {
        return (Int512Vector) super.lanewiseTemplate(op, v);  
    }

    @Override
    @ForceInline
    public Int512Vector lanewise(Binary op, Vector<Integer> v, VectorMask<Integer> m) {
        return (Int512Vector) super.lanewiseTemplate(op, Int512Mask.class, v, (Int512Mask) m);  
    }
    ...
    lanewiseShift(VectorOperators.Binary op, int e) {
        return (Int512Vector) super.lanewiseShiftTemplate(op, e);  
    }
    ...
    lanewiseShift(VectorOperators.Binary op, int e, VectorMask<Integer> m) {
        return (Int512Vector) super.lanewiseShiftTemplate(op, Int512Mask.class, e, (Int512Mask) m);  
    }
    ...
    lanewise(Ternary op, Vector<Integer> v1, Vector<Integer> v2) {
        return (Int512Vector) super.lanewiseTemplate(op, v1, v2);  
    }
    ...
    lanewise(Ternary op, Vector<Integer> v1, Vector<Integer> v2, VectorMask<Integer> m) {
        return (Int512Vector) super.lanewiseTemplate(op, Int512Mask.class, v1, v2, (Int512Mask) m);  
    }
    ...
    Int512Vector addIndex(int scale) {
        return (Int512Vector) super.addIndexTemplate(scale);  
    }
    ...
    public final int reduceLanes(VectorOperators.Associative op,
        ...
        return super.reduceLanesTemplate(op, Int512Mask.class, (Int512Mask) m);  
    }
    ...
    public final long reduceLanesToLong(VectorOperators.Associative op,
                                        VectorMask<Integer> m) {
        return (long) super.reduceLanesTemplate(op, Int512Mask.class, (Int512Mask) m);  
    }

    @ForceInline
    public VectorShuffle<Integer> toShuffle() {
        return super.toShuffleTemplate(Int512Shuffle.class); 
    }
    ...
    public final Int512Mask test(Test op) {
        return super.testTemplate(Int512Mask.class, op);  
    }

    @Override
    @ForceInline
    public final Int512Mask test(Test op, VectorMask<Integer> m) {
        return super.testTemplate(Int512Mask.class, op, (Int512Mask) m);  
    }
    ...
    public final Int512Mask compare(Comparison op, Vector<Integer> v) {
        return super.compareTemplate(Int512Mask.class, op, v);  
    }

    @Override
    @ForceInline
    public final Int512Mask compare(Comparison op, int s) {
        return super.compareTemplate(Int512Mask.class, op, s);  
    }
    ...
    public Int512Vector slice(int origin, Vector<Integer> v) {
        return (Int512Vector) super.sliceTemplate(origin, v);  
    }

    @Override
    @ForceInline
    public Int512Vector slice(int origin) {
        return (Int512Vector) super.sliceTemplate(origin);  
    }

    @Override
    @ForceInline
    public Int512Vector unslice(int origin, Vector<Integer> w, int part) {
        return (Int512Vector) super.unsliceTemplate(origin, w, part);  
    }
    ...
    public Int512Vector unslice(int origin) {
        return (Int512Vector) super.unsliceTemplate(origin);  
    }
    ...
    static final class Int512Mask extends AbstractMask<Integer> {
        ...
        Int512Vector toVector() {
            return (Int512Vector) super.toVectorTemplate();  
        }
    ...
    IntVector fromArray0(int[] a, int offset, VectorMask<Integer> m, int offsetInRange) {
        return super.fromArray0Template(Int512Mask.class, a, offset, (Int512Mask) m, offsetInRange);  
    }
    ...
    IntVector fromMemorySegment0(MemorySegment ms, long offset, VectorMask<Integer> m, int offsetInRange) {
        return super.fromMemorySegment0Template(Int512Mask.class, ms, offset, (Int512Mask) m, offsetInRange);  
    }
