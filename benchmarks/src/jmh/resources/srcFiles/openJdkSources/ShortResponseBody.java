...
public abstract class ShortResponseBody {
    ...
    static final int REQUESTS_PER_CLIENT = 10; 
    static final long PAUSE_FOR_GC = 5; 
    static final long PAUSE_FOR_PEER = 5; 
