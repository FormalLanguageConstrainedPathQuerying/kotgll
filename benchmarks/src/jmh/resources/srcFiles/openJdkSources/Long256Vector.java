...
final class Long256Vector extends LongVector {
    ...
    public final Long256Vector broadcast(long e) {
        return (Long256Vector) super.broadcastTemplate(e);  
    }
    ...
    Long256Vector uOp(FUnOp f) {
        return (Long256Vector) super.uOpTemplate(f);  
    }
    ...
    Long256Vector uOp(VectorMask<Long> m, FUnOp f) {
        return (Long256Vector)
            super.uOpTemplate((Long256Mask)m, f);  
    }
    ...
    Long256Vector bOp(Vector<Long> v, FBinOp f) {
        return (Long256Vector) super.bOpTemplate((Long256Vector)v, f);  
    }
    ...
    public Long256Vector lanewise(Unary op) {
        return (Long256Vector) super.lanewiseTemplate(op);  
    }

    @Override
    @ForceInline
    public Long256Vector lanewise(Unary op, VectorMask<Long> m) {
        return (Long256Vector) super.lanewiseTemplate(op, Long256Mask.class, (Long256Mask) m);  
    }

    @Override
    @ForceInline
    public Long256Vector lanewise(Binary op, Vector<Long> v) {
        return (Long256Vector) super.lanewiseTemplate(op, v);  
    }

    @Override
    @ForceInline
    public Long256Vector lanewise(Binary op, Vector<Long> v, VectorMask<Long> m) {
        return (Long256Vector) super.lanewiseTemplate(op, Long256Mask.class, v, (Long256Mask) m);  
    }
    ...
    lanewiseShift(VectorOperators.Binary op, int e) {
        return (Long256Vector) super.lanewiseShiftTemplate(op, e);  
    }
    ...
    lanewiseShift(VectorOperators.Binary op, int e, VectorMask<Long> m) {
        return (Long256Vector) super.lanewiseShiftTemplate(op, Long256Mask.class, e, (Long256Mask) m);  
    }
    ...
    lanewise(Ternary op, Vector<Long> v1, Vector<Long> v2) {
        return (Long256Vector) super.lanewiseTemplate(op, v1, v2);  
    }
    ...
    lanewise(Ternary op, Vector<Long> v1, Vector<Long> v2, VectorMask<Long> m) {
        return (Long256Vector) super.lanewiseTemplate(op, Long256Mask.class, v1, v2, (Long256Mask) m);  
    }
    ...
    Long256Vector addIndex(int scale) {
        return (Long256Vector) super.addIndexTemplate(scale);  
    }
    ...
    public final long reduceLanes(VectorOperators.Associative op,
                                    VectorMask<Long> m) {
        return super.reduceLanesTemplate(op, Long256Mask.class, (Long256Mask) m);  
    }
    ...
    public final long reduceLanesToLong(VectorOperators.Associative op,
                                        VectorMask<Long> m) {
        return (long) super.reduceLanesTemplate(op, Long256Mask.class, (Long256Mask) m);  
    }

    @ForceInline
    public VectorShuffle<Long> toShuffle() {
        return super.toShuffleTemplate(Long256Shuffle.class); 
    }
    ...
    public final Long256Mask test(Test op) {
        return super.testTemplate(Long256Mask.class, op);  
    }

    @Override
    @ForceInline
    public final Long256Mask test(Test op, VectorMask<Long> m) {
        return super.testTemplate(Long256Mask.class, op, (Long256Mask) m);  
    }
    ...
    public final Long256Mask compare(Comparison op, Vector<Long> v) {
        return super.compareTemplate(Long256Mask.class, op, v);  
    }

    @Override
    @ForceInline
    public final Long256Mask compare(Comparison op, long s) {
        return super.compareTemplate(Long256Mask.class, op, s);  
    }
    ...
    public Long256Vector slice(int origin, Vector<Long> v) {
        return (Long256Vector) super.sliceTemplate(origin, v);  
    }

    @Override
    @ForceInline
    public Long256Vector slice(int origin) {
        return (Long256Vector) super.sliceTemplate(origin);  
    }

    @Override
    @ForceInline
    public Long256Vector unslice(int origin, Vector<Long> w, int part) {
        return (Long256Vector) super.unsliceTemplate(origin, w, part);  
    }
    ...
    public Long256Vector unslice(int origin) {
        return (Long256Vector) super.unsliceTemplate(origin);  
    }
    ...
    static final class Long256Mask extends AbstractMask<Long> {
        ...
        Long256Vector toVector() {
            return (Long256Vector) super.toVectorTemplate();  
        }
    ...
    LongVector fromArray0(long[] a, int offset, VectorMask<Long> m, int offsetInRange) {
        return super.fromArray0Template(Long256Mask.class, a, offset, (Long256Mask) m, offsetInRange);  
    }
    ...
    LongVector fromMemorySegment0(MemorySegment ms, long offset, VectorMask<Long> m, int offsetInRange) {
        return super.fromMemorySegment0Template(Long256Mask.class, ms, offset, (Long256Mask) m, offsetInRange);  
    }
