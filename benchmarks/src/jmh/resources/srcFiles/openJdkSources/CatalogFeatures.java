 ...
 *      parser.setProperty(CatalogFeatures.Feature.FILES.getPropertyName(), "file:
 * }</pre>
 * <p>
 ...
 * <pre>{@literal
   ...
   <xi:include href="https:

   can be resolved using a URI entry:
   <uri name="https:
   or
   <uriSuffix uriSuffix="disclaimer.xml" uri="file:
 * }</pre>
 * </td>
 * </tr>
 * <tr>
 ...
 * <pre>{@literal
   The following import element:
    <xsd:import namespace="https:
                schemaLocation="https:

   can be resolved using a URI entry:
   <uri name="https:
   or
   <uriSuffix uriSuffix="XSDImport_person.xsd" uri="file:
   or
   <uriSuffix uriSuffix="https:
 * }</pre>
 * </td>
 * </tr>
 * <tr>
 ...
 * <pre>{@literal
   ...
   <xsd:include schemaLocation="https:

   can be resolved using a URI entry:
   <uri name="https:
   or
   <uriSuffix uriSuffix="XSDInclude_person.xsd" uri="file:
 * }</pre>
 * </td>
 * </tr>
 * <tr>
 ...
 * <pre>{@literal
   The following include element:
   <xsl:include href="https:

   can be resolved using a URI entry:
   <uri name="https:
   or
   <uriSuffix uriSuffix="include.xsl" uri="file:
 * }</pre>
 * </td>
 * </tr>
 * <tr>
 ...
 * <pre>{@literal
   ...
   <xsl:variable name="dummy" select="document('https:

   can be resolved using a URI entry:
   <uri name="https:
   or
   <uriSuffix uriSuffix="list.xml" uri="file:
 * }</pre>
 * </td>
 * </tr>
 * </tbody>
