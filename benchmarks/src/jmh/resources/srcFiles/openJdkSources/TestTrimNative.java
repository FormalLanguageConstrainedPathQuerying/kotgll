...
public class TestTrimNative {
    ...
    static final int totalAllocationsSize = 128 * 1024 * 1024; 
    ...
    private static String[] prepareOptions(String[] extraVMOptions, String[] programOptions) {
        ...
        allOptions.add("-XX:-ExplicitGCInvokesConcurrent"); 
    ...
    public static void main(String[] args) throws Exception {
        ...
        switch (args[0]) {
            ...
            case "trimNativeLowIntervalStrict": {
                ...
                long ms2 = System.currentTimeMillis();
                int maxTrimsExpected = (int)(ms2 - ms1); 
