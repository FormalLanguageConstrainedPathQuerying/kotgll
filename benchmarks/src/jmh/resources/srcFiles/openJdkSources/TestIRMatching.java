...
public class TestIRMatching {
    ...
    private static void runCheck(String[] args , Constraint... constraints) {
        try {
            TestFramework framework = new TestFramework(constraints[0].getKlass()); 
            if (args != null) {
...
class MultipleFailOnGood {
    ...
    @IR(applyIfOr = {"TLABRefillWasteFraction", "99", "TLABRefillWasteFraction", "100"}, failOn = {IRNode.LOOP, IRNode.CALL}) 
    public void good1() {
        forceInline();
    }
    ...
    @Test
    @IR(failOn = {IRNode.STORE_OF_CLASS, "MyClass"}) 
    public void good6() {
        myClassSub.iFld = 42;
    }

    @Test
    @IR(failOn = {IRNode.STORE_OF_CLASS, "MyClassSub"}) 
    public void good7() {
...
class GoodCount {
    ...
    public void good9() {
        result = iFld + MyClass.lFldStatic + myClass.iFld; 
    }
...
class Calls {
    ...
    @IR(failOn = {IRNode.CALL_OF_METHOD, "dontInline",  
                  IRNode.STATIC_CALL_OF_METHOD, "dontInline"}) 
...
class AllocArray {
    ...
    @IR(failOn = {IRNode.ALLOC_ARRAY_OF, "MyClasss"}) 
    @IR(failOn = {IRNode.ALLOC_ARRAY_OF, "ir_framework/tests/MySubClass"}) 
...
class Loads {
    ...
    @IR(failOn = {IRNode.LOOP, IRNode.LOOP}, counts = {IRNode.LOOP, "0", IRNode.LOAD, "1"}) 
    ...
    @IR(failOn = {IRNode.LOAD_OF_FIELD, "iFld2", IRNode.LOAD_OF_CLASS, "Load"}) 
...
class Traps {
    ...
    @Test
    @IR(failOn = IRNode.TRAP) 
    @IR(failOn = IRNode.NULL_CHECK_TRAP) 
    ...
    @Test
    @IR(failOn = IRNode.TRAP) 
    @IR(failOn = IRNode.INTRINSIC_OR_TYPE_CHECKED_INLINING_TRAP) 
...
class UnhandledTrap {
    ...
    @Test
    @IR(failOn = IRNode.TRAP) 
    @IR(failOn = IRNode.UNHANDLED_TRAP) 
    @IR(failOn = {IRNode.PREDICATE_TRAP,
                  IRNode.UNSTABLE_IF_TRAP,
                  IRNode.NULL_CHECK_TRAP,
                  IRNode.NULL_ASSERT_TRAP,
...
class CheckCastArray {
    ...
    @Test
    @IR(failOn = IRNode.CHECKCAST_ARRAY) 
    @IR(failOn = {IRNode.CHECKCAST_ARRAY_OF, "MyClass", 
                  IRNode.CHECKCAST_ARRAY_OF, "ir_framework/tests/MyClass"}) 
    ...
    @Test
    @IR(failOn = IRNode.CHECKCAST_ARRAYCOPY) 
