...
public class NumberRegression {
    ...
    public void Test4086575() {
        ...
        System.out.println("nf: " + nf.format(1234)); 
        System.out.println("nf: " + nf.format(-1234)); 
    ...
    */
    ...
    public void Test4093610()
    {
        ...
        roundingTest(df, 12.15, "12.2"); 
        roundingTest(df, 12.25, "12.2"); 
        roundingTest(df, 12.45, "12.4"); 
        roundingTest(df, 12.450000001,"12.5"); 
        roundingTest(df, 12.55, "12.6"); 
        roundingTest(df, 12.650000001,"12.7"); 
        roundingTest(df, 12.75, "12.8"); 
        roundingTest(df, 12.750000001,"12.8"); 
        roundingTest(df, 12.85, "12.8"); 
        roundingTest(df, 12.850000001,"12.9"); 
        roundingTest(df, 12.950000001,"13");   
    ...
    public void Test4114639()
    {
        ...
        if (result != null) fail("Should return null but got : " + result); 
    }
