...
public class SeededSecureRandomTest {
    ...
    public static void main(String[] args) throws Exception {
        try {
            ...
            Asserts.assertNE(get(), get()); 
            Asserts.assertEQ(get(1L), get(1L)); 
            Asserts.assertEQ(get(10L), get(10L)); 
            Asserts.assertNE(get(1L), get(10L)); 

            System.setProperty(PROP, "10");
            Asserts.assertEQ(get(), get()); 
            Asserts.assertNE(get(), get(1L)); 
            Asserts.assertEQ(get(), get(10L)); 
            Asserts.assertEQ(get(1L), get(1L)); 
            Asserts.assertEQ(get(10L), get(10L)); 
            Asserts.assertNE(get(1L), get(10L)); 
        } finally {
