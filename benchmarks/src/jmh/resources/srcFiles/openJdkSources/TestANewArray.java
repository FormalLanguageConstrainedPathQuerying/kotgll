...
public class TestANewArray {
    ...
    static String classCName = null; 

    static final int test_Dimension_254 = 254; 
    static final int test_Dimension_255 = 255; 
    static final int test_Dimension_264 = 264; 
    ...
    public static byte[] dumpClassFile(int cfv, int testDimension264, String arrayDim) throws Exception {
        ...
        {   
            ...
            mv.visitTypeInsn(ANEWARRAY, arrayDim); 
            mv.visitInsn(RETURN);
            mv.visitMaxs(2, 2);
            mv.visitEnd();
        }
