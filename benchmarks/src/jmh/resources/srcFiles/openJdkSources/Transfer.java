...
public class Transfer {
    ...
    @Test
    public void transferToNoThrow() throws IOException { 
    ...
    @Test
    public void xferTest02() throws Exception { 
    ...
    @Test
    public void xferTest03() throws Exception { 
    ...
    @Test
    public void xferTest06() throws Exception { 
    ...
    @Test
    public void xferTest07() throws Exception { 
        File source = File.createTempFile("source", null);
        source.deleteOnExit();
    ...
    @Test
    public void xferTest09() throws Exception { 
        File source = File.createTempFile("source", null);
        source.deleteOnExit();
