...
public class HiDPIRobotScreenCaptureTest {
    ...
    static void checkRectColor(BufferedImage image, Rectangle rect, Color expectedColor) {
        ...
        final Point[] pointsToCheck = new Point[] {
                ...
                new Point(rect.x + rect.width - OFFSET, rect.y + OFFSET),              
                new Point(rect.x + rect.width / 2, rect.y + rect.height / 2),          
                new Point(rect.x + OFFSET, rect.y + rect.height - OFFSET),             
                new Point(rect.x + rect.width - OFFSET, rect.y + rect.height - OFFSET) 
        };
