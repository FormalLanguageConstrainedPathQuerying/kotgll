...
class CompletenessAnalyzer {
    ...
    private static final int XMODIFIER     = 0b1000000000000;           
    ...
    static enum TK {
        ...
        UNDERSCORE(TokenKind.UNDERSCORE, XDECL1|XEXPR),  
        ...
        BOOLEAN(TokenKind.BOOLEAN, XEXPR1|XDECL1|XTERM),  
        BYTE(TokenKind.BYTE, XEXPR1|XDECL1|XTERM),  
        CHAR(TokenKind.CHAR, XEXPR1|XDECL1|XTERM),  
        DOUBLE(TokenKind.DOUBLE, XEXPR1|XDECL1|XTERM),  
        FLOAT(TokenKind.FLOAT, XEXPR1|XDECL1|XTERM),  
        INT(TokenKind.INT, XEXPR1|XDECL1|XTERM),  
        LONG(TokenKind.LONG, XEXPR1|XDECL1|XTERM),  
        SHORT(TokenKind.SHORT, XEXPR1|XDECL1|XTERM),  
        VOID(TokenKind.VOID, XEXPR1|XDECL1),  

        ABSTRACT(TokenKind.ABSTRACT, XDECL1 | XMODIFIER),  
        FINAL(TokenKind.FINAL, XDECL1 | XMODIFIER),  
        NATIVE(TokenKind.NATIVE, XDECL1 | XMODIFIER),  
        STATIC(TokenKind.STATIC, XDECL1 | XMODIFIER),  
        STRICTFP(TokenKind.STRICTFP, XDECL1 | XMODIFIER),  
        PRIVATE(TokenKind.PRIVATE, XDECL1 | XMODIFIER),  
        PROTECTED(TokenKind.PROTECTED, XDECL1 | XMODIFIER),  
        PUBLIC(TokenKind.PUBLIC, XDECL1 | XMODIFIER),  
        TRANSIENT(TokenKind.TRANSIENT, XDECL1 | XMODIFIER),  
        VOLATILE(TokenKind.VOLATILE, XDECL1 | XMODIFIER),  
