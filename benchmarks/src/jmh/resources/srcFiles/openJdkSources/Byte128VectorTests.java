...
public class Byte128VectorTests extends AbstractVectorTest {
    ...
    static void smokeTest2() {
        ...
        ByteVector a = io.add((byte)1); 
        ByteVector b = a.neg();  
        byte[] abValues = bothToArray(a,b); 
        VectorShuffle<Byte> zip0 = VectorShuffle.makeZip(SPECIES, 0);
        VectorShuffle<Byte> zip1 = VectorShuffle.makeZip(SPECIES, 1);
        ByteVector zab0 = a.rearrange(zip0,b); 
        ByteVector zab1 = a.rearrange(zip1,b); 
        byte[] zabValues = bothToArray(zab0, zab1); 
