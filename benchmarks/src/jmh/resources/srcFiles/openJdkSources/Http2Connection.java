...
class Http2Connection  {
    ...
    private static final int MAX_CLIENT_STREAM_ID = Integer.MAX_VALUE; 
    private static final int MAX_SERVER_STREAM_ID = Integer.MAX_VALUE - 1; 
    ...
    private int numReservedClientStreams = 0; 
    private int numReservedServerStreams = 0; 
