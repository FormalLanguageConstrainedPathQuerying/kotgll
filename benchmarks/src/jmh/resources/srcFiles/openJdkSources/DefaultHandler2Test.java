...
public class DefaultHandler2Test {
    ...
    public void testParse01() {
        ...
        try {
            ...
            System.out.println(saxFac.getFeature("http:

            saxFac.setFeature("http:
    ...
    public void testParse03() {
        ...
        try {
            ...
            System.out.println("XMLReader : " + xmlReader.getProperty("http:

            SAXParserFactory saxFac = SAXParserFactory.newInstance();
            SAXParser parser = saxFac.newSAXParser();
            parser.setProperty("http:
            System.out.println("SAXParser : " + parser.getProperty("http:

            try {
                ParserAdapter adapter = new ParserAdapter(parser.getParser());
                System.out.println("ParserAdapter : " + adapter.getProperty("http:
    ...
    public void testParse04() {
        ...
        try {
            DefaultHandler handler = new MyDefaultHandler2();
            XMLReader xmlReader = XMLReaderFactory.createXMLReader();
            System.out.println(xmlReader.getFeature("http:
            xmlReader.setProperty("http:
            xmlReader.setProperty("http:
    ...
    public void testParse06() {
        ...
        try {
            ...
            AssertJUnit.assertTrue(filterImpl.getProperty("http:
