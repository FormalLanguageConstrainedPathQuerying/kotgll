...
public class Short256VectorTests extends AbstractVectorTest {
    ...
    static void smokeTest2() {
        ...
        ShortVector a = io.add((short)1); 
        ShortVector b = a.neg();  
        short[] abValues = bothToArray(a,b); 
        VectorShuffle<Short> zip0 = VectorShuffle.makeZip(SPECIES, 0);
        VectorShuffle<Short> zip1 = VectorShuffle.makeZip(SPECIES, 1);
        ShortVector zab0 = a.rearrange(zip0,b); 
        ShortVector zab1 = a.rearrange(zip1,b); 
        short[] zabValues = bothToArray(zab0, zab1); 
