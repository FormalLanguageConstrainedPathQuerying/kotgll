...
final class Long512Vector extends LongVector {
    ...
    public final Long512Vector broadcast(long e) {
        return (Long512Vector) super.broadcastTemplate(e);  
    }
    ...
    Long512Vector uOp(FUnOp f) {
        return (Long512Vector) super.uOpTemplate(f);  
    }
    ...
    Long512Vector uOp(VectorMask<Long> m, FUnOp f) {
        return (Long512Vector)
            super.uOpTemplate((Long512Mask)m, f);  
    }
    ...
    Long512Vector bOp(Vector<Long> v, FBinOp f) {
        return (Long512Vector) super.bOpTemplate((Long512Vector)v, f);  
    }
    ...
    public Long512Vector lanewise(Unary op) {
        return (Long512Vector) super.lanewiseTemplate(op);  
    }

    @Override
    @ForceInline
    public Long512Vector lanewise(Unary op, VectorMask<Long> m) {
        return (Long512Vector) super.lanewiseTemplate(op, Long512Mask.class, (Long512Mask) m);  
    }

    @Override
    @ForceInline
    public Long512Vector lanewise(Binary op, Vector<Long> v) {
        return (Long512Vector) super.lanewiseTemplate(op, v);  
    }

    @Override
    @ForceInline
    public Long512Vector lanewise(Binary op, Vector<Long> v, VectorMask<Long> m) {
        return (Long512Vector) super.lanewiseTemplate(op, Long512Mask.class, v, (Long512Mask) m);  
    }
    ...
    lanewiseShift(VectorOperators.Binary op, int e) {
        return (Long512Vector) super.lanewiseShiftTemplate(op, e);  
    }
    ...
    lanewiseShift(VectorOperators.Binary op, int e, VectorMask<Long> m) {
        return (Long512Vector) super.lanewiseShiftTemplate(op, Long512Mask.class, e, (Long512Mask) m);  
    }
    ...
    lanewise(Ternary op, Vector<Long> v1, Vector<Long> v2) {
        return (Long512Vector) super.lanewiseTemplate(op, v1, v2);  
    }
    ...
    lanewise(Ternary op, Vector<Long> v1, Vector<Long> v2, VectorMask<Long> m) {
        return (Long512Vector) super.lanewiseTemplate(op, Long512Mask.class, v1, v2, (Long512Mask) m);  
    }
    ...
    Long512Vector addIndex(int scale) {
        return (Long512Vector) super.addIndexTemplate(scale);  
    }
    ...
    public final long reduceLanes(VectorOperators.Associative op,
                                    VectorMask<Long> m) {
        return super.reduceLanesTemplate(op, Long512Mask.class, (Long512Mask) m);  
    }
    ...
    public final long reduceLanesToLong(VectorOperators.Associative op,
                                        VectorMask<Long> m) {
        return (long) super.reduceLanesTemplate(op, Long512Mask.class, (Long512Mask) m);  
    }
    ...
    public final Long512Mask test(Test op) {
        return super.testTemplate(Long512Mask.class, op);  
    }

    @Override
    @ForceInline
    public final Long512Mask test(Test op, VectorMask<Long> m) {
        return super.testTemplate(Long512Mask.class, op, (Long512Mask) m);  
    }
    ...
    public final Long512Mask compare(Comparison op, Vector<Long> v) {
        return super.compareTemplate(Long512Mask.class, op, v);  
    }

    @Override
    @ForceInline
    public final Long512Mask compare(Comparison op, long s) {
        return super.compareTemplate(Long512Mask.class, op, s);  
    }
    ...
    public Long512Vector slice(int origin, Vector<Long> v) {
        return (Long512Vector) super.sliceTemplate(origin, v);  
    }

    @Override
    @ForceInline
    public Long512Vector slice(int origin) {
        return (Long512Vector) super.sliceTemplate(origin);  
    }

    @Override
    @ForceInline
    public Long512Vector unslice(int origin, Vector<Long> w, int part) {
        return (Long512Vector) super.unsliceTemplate(origin, w, part);  
    }
    ...
    public Long512Vector unslice(int origin) {
        return (Long512Vector) super.unsliceTemplate(origin);  
    }
    ...
    LongVector fromArray0(long[] a, int offset, VectorMask<Long> m, int offsetInRange) {
        return super.fromArray0Template(Long512Mask.class, a, offset, (Long512Mask) m, offsetInRange);  
    }
    ...
    LongVector fromMemorySegment0(MemorySegment ms, long offset, VectorMask<Long> m, int offsetInRange) {
        return super.fromMemorySegment0Template(Long512Mask.class, ms, offset, (Long512Mask) m, offsetInRange);  
    }
