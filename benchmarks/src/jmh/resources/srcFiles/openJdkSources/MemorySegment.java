 ...
 *
 * {@snippet lang=java:
 * VarHandle intAtOffsetHandle = ValueLayout.JAVA_INT.varHandle(); 
 * int value = (int) intAtOffsetHandle.get(segment, 10L);          
 * }
 *
 ...
 * int value = (int) intAtOffsetAndIndexHandle.get(segment, 2L, 3L); 
 * }
 *
 * <p>
 ...
 *         MethodHandles.insertCoordinates(intAtOffsetAndIndexHandle, 1, 0L); 
 * int value = (int) intAtIndexHandle.get(segment, 3L);                       
 * }
 *
 ...
 * slice.get(ValueLayout.JAVA_INT, 20); 
 * arena.close();
 * slice.get(ValueLayout.JAVA_INT, 0); 
 *}
 ...
 * byteSegment.get(ValueLayout.JAVA_INT, 0); 
 * }
 *
 ...
 * longSegment.get(ValueLayout.JAVA_INT, 0); 
 * }
 *
 ...
 * {@snippet lang=java :
 * MemorySegment byteSegment = MemorySegment.ofArray(new byte[10]);
 * byteSegment.get(ValueLayout.JAVA_INT_UNALIGNED, 0); 
 * }
 *
 ...
 *
 * {@snippet lang = java:
 * MemorySegment z = segment.get(ValueLayout.ADDRESS, ...);   
 * MemorySegment ptr = z.reinterpret(16);                     
 * int x = ptr.getAtIndex(ValueLayout.JAVA_INT, 3);           
 *}
 * <p>
 ...
 *       MemorySegment z = segment.get(ValueLayout.ADDRESS, ...);    
 *       ptr = z.reinterpret(16, arena, null);                       
 *       int x = ptr.getAtIndex(ValueLayout.JAVA_INT, 3);            
 * }
 * int x = ptr.getAtIndex(ValueLayout.JAVA_INT, 3);                  
 *}
 ...
 * MemorySegment ptr = segment.get(intArrPtrLayout, ...);         
 * int x = ptr.getAtIndex(ValueLayout.JAVA_INT, 3);               
 *}
 * <p>
