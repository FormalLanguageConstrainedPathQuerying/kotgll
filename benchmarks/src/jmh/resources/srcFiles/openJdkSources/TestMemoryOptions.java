...
public class TestMemoryOptions {
    ...
    static {
        ...
        tc.setMemorySizeTestParam(48128, 'k'); 
        testCases.add(tc);

        tc = new TestCase("MemorySizeValue2Positive", false);
        tc.setMemorySizeTestParam(17391, 'k'); 
        testCases.add(tc);
        ...
        tc.setGlobalBufferSizeTestParam(917, 'k');
        tc.setGlobalBufferCountTestParam(31, 'b');
        tc.setThreadBufferSizeTestParam(760832, 'b'); 
        testCases.add(tc);
