...
final class Long64Vector extends LongVector {
    ...
    public final Long64Vector broadcast(long e) {
        return (Long64Vector) super.broadcastTemplate(e);  
    }
    ...
    Long64Vector uOp(FUnOp f) {
        return (Long64Vector) super.uOpTemplate(f);  
    }
    ...
    Long64Vector uOp(VectorMask<Long> m, FUnOp f) {
        return (Long64Vector)
            super.uOpTemplate((Long64Mask)m, f);  
    }
    ...
    Long64Vector bOp(Vector<Long> v, FBinOp f) {
        return (Long64Vector) super.bOpTemplate((Long64Vector)v, f);  
    }
    ...
    public Long64Vector lanewise(Unary op) {
        return (Long64Vector) super.lanewiseTemplate(op);  
    }

    @Override
    @ForceInline
    public Long64Vector lanewise(Unary op, VectorMask<Long> m) {
        return (Long64Vector) super.lanewiseTemplate(op, Long64Mask.class, (Long64Mask) m);  
    }

    @Override
    @ForceInline
    public Long64Vector lanewise(Binary op, Vector<Long> v) {
        return (Long64Vector) super.lanewiseTemplate(op, v);  
    }

    @Override
    @ForceInline
    public Long64Vector lanewise(Binary op, Vector<Long> v, VectorMask<Long> m) {
        return (Long64Vector) super.lanewiseTemplate(op, Long64Mask.class, v, (Long64Mask) m);  
    }
    ...
    lanewiseShift(VectorOperators.Binary op, int e) {
        return (Long64Vector) super.lanewiseShiftTemplate(op, e);  
    }
    ...
    lanewiseShift(VectorOperators.Binary op, int e, VectorMask<Long> m) {
        return (Long64Vector) super.lanewiseShiftTemplate(op, Long64Mask.class, e, (Long64Mask) m);  
    }
    ...
    lanewise(Ternary op, Vector<Long> v1, Vector<Long> v2) {
        return (Long64Vector) super.lanewiseTemplate(op, v1, v2);  
    }
    ...
    lanewise(Ternary op, Vector<Long> v1, Vector<Long> v2, VectorMask<Long> m) {
        return (Long64Vector) super.lanewiseTemplate(op, Long64Mask.class, v1, v2, (Long64Mask) m);  
    }
    ...
    Long64Vector addIndex(int scale) {
        return (Long64Vector) super.addIndexTemplate(scale);  
    }
    ...
    public final long reduceLanes(VectorOperators.Associative op,
                                    VectorMask<Long> m) {
        return super.reduceLanesTemplate(op, Long64Mask.class, (Long64Mask) m);  
    }
    ...
    public final long reduceLanesToLong(VectorOperators.Associative op,
                                        VectorMask<Long> m) {
        return (long) super.reduceLanesTemplate(op, Long64Mask.class, (Long64Mask) m);  
    }

    @ForceInline
    public VectorShuffle<Long> toShuffle() {
        return super.toShuffleTemplate(Long64Shuffle.class); 
    }
    ...
    public final Long64Mask test(Test op) {
        return super.testTemplate(Long64Mask.class, op);  
    }

    @Override
    @ForceInline
    public final Long64Mask test(Test op, VectorMask<Long> m) {
        return super.testTemplate(Long64Mask.class, op, (Long64Mask) m);  
    }
    ...
    public final Long64Mask compare(Comparison op, Vector<Long> v) {
        return super.compareTemplate(Long64Mask.class, op, v);  
    }

    @Override
    @ForceInline
    public final Long64Mask compare(Comparison op, long s) {
        return super.compareTemplate(Long64Mask.class, op, s);  
    }
    ...
    public Long64Vector slice(int origin, Vector<Long> v) {
        return (Long64Vector) super.sliceTemplate(origin, v);  
    }

    @Override
    @ForceInline
    public Long64Vector slice(int origin) {
        return (Long64Vector) super.sliceTemplate(origin);  
    }

    @Override
    @ForceInline
    public Long64Vector unslice(int origin, Vector<Long> w, int part) {
        return (Long64Vector) super.unsliceTemplate(origin, w, part);  
    }
    ...
    public Long64Vector unslice(int origin) {
        return (Long64Vector) super.unsliceTemplate(origin);  
    }
    ...
    static final class Long64Mask extends AbstractMask<Long> {
        ...
        Long64Vector toVector() {
            return (Long64Vector) super.toVectorTemplate();  
        }
    ...
    LongVector fromArray0(long[] a, int offset, VectorMask<Long> m, int offsetInRange) {
        return super.fromArray0Template(Long64Mask.class, a, offset, (Long64Mask) m, offsetInRange);  
    }
    ...
    LongVector fromMemorySegment0(MemorySegment ms, long offset, VectorMask<Long> m, int offsetInRange) {
        return super.fromMemorySegment0Template(Long64Mask.class, ms, offset, (Long64Mask) m, offsetInRange);  
    }
