...
public class TestMulAddS2I {
    ...
    public static int[] teste() {
        ...
        for (int i = 0; i < ITER-2; i+=2) {
            out[i+0] += ((sArr1[2*i+0] * sArr2[2*i+0]) + (sArr1[2*i+1] * sArr2[2*i+1]));
            out[i+1] += ((sArr2[2*i+2] * sArr1[2*i+2]) + (sArr1[2*i+3] * sArr2[2*i+3])); 
        }
        return out;
    }
    ...
    public static int[] testf() {
        ...
        for (int i = 0; i < ITER-2; i+=2) {
            out[i+0] += ((sArr1[2*i+0] * sArr2[2*i+0]) + (sArr1[2*i+1] * sArr2[2*i+1]));
            out[i+1] += ((sArr2[2*i+2] * sArr1[2*i+2]) + (sArr2[2*i+3] * sArr1[2*i+3])); 
        }
        return out;
    }
    ...
    public static int[] testg() {
        ...
        for (int i = 0; i < ITER-2; i+=2) {
            out[i+0] += ((sArr1[2*i+0] * sArr2[2*i+0]) + (sArr1[2*i+1] * sArr2[2*i+1]));
            out[i+1] += ((sArr1[2*i+3] * sArr2[2*i+3]) + (sArr1[2*i+2] * sArr2[2*i+2])); 
        }
        return out;
    }
    ...
    public static int[] testh() {
        ...
        for (int i = 0; i < ITER-2; i+=2) {
            out[i+0] += ((sArr1[2*i+0] * sArr2[2*i+0]) + (sArr1[2*i+1] * sArr2[2*i+1]));
            out[i+1] += ((sArr2[2*i+3] * sArr1[2*i+3]) + (sArr2[2*i+2] * sArr1[2*i+2])); 
        }
        return out;
    }
}
