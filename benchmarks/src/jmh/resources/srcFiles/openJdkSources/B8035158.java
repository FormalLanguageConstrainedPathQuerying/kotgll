...
public class B8035158 {
    ...
    private static Collection<TestCase> emptyNonProxiesHosts() {
        ...
        properties.put("http.proxyHost", "http:
        properties.put("http.nonProxyHosts", "");
        for (String s : loopbacks) {
            tests.add(new TestCase(properties, "http:
        }
        return tests;
    }
    ...
    private static Collection<TestCase> misc() {
        ...
        t.add(new TestCase("oracle.com", "http:
        t.add(new TestCase("google.com", "http:

        t.add(new TestCase("google.com|google.ie", "http:
                true));
        t.add(new TestCase("google.com|google.ie", "http:
                false));
        t.add(new TestCase("google.com|google.ie", "http:
        ...
        t.add(new TestCase("google.com|bing.com", "http:
        t.add(new TestCase("google.com|bing.com", "http:
        t.add(new TestCase("google.com|bing.com", "http:
                true));
        t.add(new TestCase("google.com|bing.co*", "http:
        t.add(new TestCase("google.com|bing.co*", "http:
        t.add(new TestCase("google.com|bing.co*", "http:
                true));
        t.add(new TestCase("google.com|*ing.com", "http:
        t.add(new TestCase("google.com|*ing.com", "http:
        t.add(new TestCase("google.com|*ing.com", "http:
                true));
        t.add(new TestCase("google.co*|bing.com", "http:
        t.add(new TestCase("google.co*|bing.com", "http:
        t.add(new TestCase("google.co*|bing.com", "http:
                true));
        t.add(new TestCase("google.co*|bing.co*", "http:
        t.add(new TestCase("google.co*|bing.co*", "http:
        t.add(new TestCase("google.co*|bing.co*", "http:
                true));
        t.add(new TestCase("google.co*|*ing.com", "http:
        t.add(new TestCase("google.co*|*ing.com", "http:
        t.add(new TestCase("google.co*|*ing.com", "http:
                true));
        t.add(new TestCase("*oogle.com|bing.com", "http:
        t.add(new TestCase("*oogle.com|bing.com", "http:
        t.add(new TestCase("*oogle.com|bing.com", "http:
                true));
        t.add(new TestCase("*oogle.com|bing.co*", "http:
        t.add(new TestCase("*oogle.com|bing.co*", "http:
        t.add(new TestCase("*oogle.com|bing.co*", "http:
                true));
        t.add(new TestCase("*oogle.com|*ing.com", "http:
        t.add(new TestCase("*oogle.com|*ing.com", "http:
        t.add(new TestCase("*oogle.com|*ing.com", "http:
                true));

        t.add(new TestCase("google.com|bing.com|yahoo.com", "http:
        t.add(new TestCase("google.com|bing.com|yahoo.com", "http:
        t.add(new TestCase("google.com|bing.com|yahoo.com", "http:
        t.add(new TestCase("google.com|bing.com|yahoo.com",
                "http:

        t.add(new TestCase("p-proxy.com", "http:
        t.add(new TestCase("google.co*|google.ie", "http:
                false));
        t.add(new TestCase("*google.*", "http:
                false));
        t.add(new TestCase("*", "http:
        t.add(new TestCase("localhost|*", "http:
        t.add(new TestCase("*|oracle.com", "http:
        t.add(new TestCase("*|oracle.com|*", "http:
        t.add(new TestCase("*|*", "http:
        ...
        t.add(new TestCase("localhost|host.example.com", "http:
                false));
