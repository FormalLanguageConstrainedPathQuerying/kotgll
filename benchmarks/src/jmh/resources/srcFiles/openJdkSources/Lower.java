 ...
 *************************************************************************/
    ...
    JCExpression abstractRval(JCExpression rval, Type type, TreeBuilder builder) {
        ...
        JCVariableDecl def = make.VarDef(var, rval); 
 ...
 *************************************************************************/
    ...
    private void visitEnumDef(JCClassDecl tree) {
        ...
        private Name syntheticName(JCClassDecl tree, String baseName) {
            ...
            while (tree.sym.members().findFirst(valuesName) != null) 
    ...
    record TypePairs(TypeSymbol from, TypeSymbol to) {
        ...
        public static HashMap<TypePairs, String> initialize(Symtab syms) {
            ...
            typePairToName.put(new TypePairs(syms.byteType,   syms.charType),   "isIntToCharExact");      
            typePairToName.put(new TypePairs(syms.shortType,  syms.byteType),   "isIntToByteExact");      
            typePairToName.put(new TypePairs(syms.shortType,  syms.charType),   "isIntToCharExact");      
            typePairToName.put(new TypePairs(syms.charType,   syms.byteType),   "isIntToByteExact");      
            typePairToName.put(new TypePairs(syms.charType,   syms.shortType),  "isIntToShortExact");     
