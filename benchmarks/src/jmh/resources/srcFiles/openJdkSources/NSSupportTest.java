...
public class NSSupportTest {
    ...
    public void testProcessName() {
        ...
        nssupport.declarePrefix("", "http:
        nssupport.declarePrefix("dc", "http:

        String[] parts = new String[3];
        nssupport.processName("dc:name1", parts, false);
        Assert.assertTrue(parts[0].equals("http:
    ...
    public void testPopContext() {
        ...
        nssupport.pushContext();
        nssupport.declarePrefix("dc", "http:
        Assert.assertEquals(nssupport.getPrefix("http:

        nssupport.popContext();
        Assert.assertNull(nssupport.getPrefix("http:
        nssupport.processName("dc:name1", parts, false);
        Assert.assertNull(parts[0]);
        Assert.assertNull(parts[1]);
        Assert.assertNull(parts[2]);
    ...
    public void testPrefixAndUri1() {
        ...
        nssupport.pushContext();
        nssupport.declarePrefix("dc1", "http:
        nssupport.declarePrefix("dc2", "http:
        nssupport.declarePrefix("dcnew", "http:
    ...
    public void testPrefixAndUri3() {
        ...
        Enumeration enu1 = nssupport.getPrefixes("http:
        while (enu1.hasMoreElements()) {
            String str = (String) enu1.nextElement();
            if (str.equals("dc")) {
                hasdc = true;
    ...
    public void testPrefixAndUri4() {
        ...
        AssertJUnit.assertTrue(nssupport.getURI("dc").equals("http:
        AssertJUnit.assertTrue(nssupport.getURI("dc1").equals("http:
        AssertJUnit.assertTrue(nssupport.getURI("dc2").equals("http:
        AssertJUnit.assertTrue(nssupport.getURI("dcnew").equals("http:
