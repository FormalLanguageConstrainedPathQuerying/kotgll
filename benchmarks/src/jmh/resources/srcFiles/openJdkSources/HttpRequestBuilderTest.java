...
public class HttpRequestBuilderTest {
    ...
    static final URI TEST_URI = URI.create("http:
    ...
    public static void main(String[] args) throws Exception {
        ...
        test0("newBuilder(URI.create(\"badScheme:
              () -> HttpRequest.newBuilder(URI.create("badScheme:
              IllegalArgumentException.class);

        test0("newBuilder(URI.create(\"http:
                () -> HttpRequest.newBuilder(URI.create("http:
                IllegalArgumentException.class);

        test0("newBuilder(URI.create(\"https:
                () -> HttpRequest.newBuilder(URI.create("https:
                IllegalArgumentException.class);
        ...
        builder = test1("uri", builder, builder::uri, URI.create("http:
                        IllegalArgumentException.class);

        builder = test1("uri", builder, builder::uri, URI.create("https:
                        IllegalArgumentException.class);
