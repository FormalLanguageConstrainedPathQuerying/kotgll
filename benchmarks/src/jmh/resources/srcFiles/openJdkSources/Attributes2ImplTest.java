...
public class Attributes2ImplTest {
    ...
    public void test01() {
        ...
        Assert.assertTrue(impl.isDeclared("http:
    ...
    public void test02() {
        ...
        Assert.assertTrue(impl.isSpecified("http:
