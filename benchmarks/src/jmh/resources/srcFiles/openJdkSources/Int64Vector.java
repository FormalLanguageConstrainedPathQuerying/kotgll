...
final class Int64Vector extends IntVector {
    ...
    public final Int64Vector broadcast(int e) {
        return (Int64Vector) super.broadcastTemplate(e);  
    }
    ...
    Int64Vector uOp(FUnOp f) {
        return (Int64Vector) super.uOpTemplate(f);  
    }
    ...
    Int64Vector uOp(VectorMask<Integer> m, FUnOp f) {
        return (Int64Vector)
            super.uOpTemplate((Int64Mask)m, f);  
    }
    ...
    Int64Vector bOp(Vector<Integer> v, FBinOp f) {
        return (Int64Vector) super.bOpTemplate((Int64Vector)v, f);  
    }
    ...
    public Int64Vector lanewise(Unary op) {
        return (Int64Vector) super.lanewiseTemplate(op);  
    }

    @Override
    @ForceInline
    public Int64Vector lanewise(Unary op, VectorMask<Integer> m) {
        return (Int64Vector) super.lanewiseTemplate(op, Int64Mask.class, (Int64Mask) m);  
    }

    @Override
    @ForceInline
    public Int64Vector lanewise(Binary op, Vector<Integer> v) {
        return (Int64Vector) super.lanewiseTemplate(op, v);  
    }

    @Override
    @ForceInline
    public Int64Vector lanewise(Binary op, Vector<Integer> v, VectorMask<Integer> m) {
        return (Int64Vector) super.lanewiseTemplate(op, Int64Mask.class, v, (Int64Mask) m);  
    }
    ...
    lanewiseShift(VectorOperators.Binary op, int e) {
        return (Int64Vector) super.lanewiseShiftTemplate(op, e);  
    }
    ...
    lanewiseShift(VectorOperators.Binary op, int e, VectorMask<Integer> m) {
        return (Int64Vector) super.lanewiseShiftTemplate(op, Int64Mask.class, e, (Int64Mask) m);  
    }
    ...
    lanewise(Ternary op, Vector<Integer> v1, Vector<Integer> v2) {
        return (Int64Vector) super.lanewiseTemplate(op, v1, v2);  
    }
    ...
    lanewise(Ternary op, Vector<Integer> v1, Vector<Integer> v2, VectorMask<Integer> m) {
        return (Int64Vector) super.lanewiseTemplate(op, Int64Mask.class, v1, v2, (Int64Mask) m);  
    }
    ...
    Int64Vector addIndex(int scale) {
        return (Int64Vector) super.addIndexTemplate(scale);  
    }
    ...
    public final int reduceLanes(VectorOperators.Associative op,
        ...
        return super.reduceLanesTemplate(op, Int64Mask.class, (Int64Mask) m);  
    }
    ...
    public final long reduceLanesToLong(VectorOperators.Associative op,
                                        VectorMask<Integer> m) {
        return (long) super.reduceLanesTemplate(op, Int64Mask.class, (Int64Mask) m);  
    }

    @ForceInline
    public VectorShuffle<Integer> toShuffle() {
        return super.toShuffleTemplate(Int64Shuffle.class); 
    }
    ...
    public final Int64Mask test(Test op) {
        return super.testTemplate(Int64Mask.class, op);  
    }

    @Override
    @ForceInline
    public final Int64Mask test(Test op, VectorMask<Integer> m) {
        return super.testTemplate(Int64Mask.class, op, (Int64Mask) m);  
    }
    ...
    public final Int64Mask compare(Comparison op, Vector<Integer> v) {
        return super.compareTemplate(Int64Mask.class, op, v);  
    }

    @Override
    @ForceInline
    public final Int64Mask compare(Comparison op, int s) {
        return super.compareTemplate(Int64Mask.class, op, s);  
    }
    ...
    public Int64Vector slice(int origin, Vector<Integer> v) {
        return (Int64Vector) super.sliceTemplate(origin, v);  
    }

    @Override
    @ForceInline
    public Int64Vector slice(int origin) {
        return (Int64Vector) super.sliceTemplate(origin);  
    }

    @Override
    @ForceInline
    public Int64Vector unslice(int origin, Vector<Integer> w, int part) {
        return (Int64Vector) super.unsliceTemplate(origin, w, part);  
    }
    ...
    public Int64Vector unslice(int origin) {
        return (Int64Vector) super.unsliceTemplate(origin);  
    }
    ...
    static final class Int64Mask extends AbstractMask<Integer> {
        ...
        Int64Vector toVector() {
            return (Int64Vector) super.toVectorTemplate();  
        }
    ...
    IntVector fromArray0(int[] a, int offset, VectorMask<Integer> m, int offsetInRange) {
        return super.fromArray0Template(Int64Mask.class, a, offset, (Int64Mask) m, offsetInRange);  
    }
    ...
    IntVector fromMemorySegment0(MemorySegment ms, long offset, VectorMask<Integer> m, int offsetInRange) {
        return super.fromMemorySegment0Template(Int64Mask.class, ms, offset, (Int64Mask) m, offsetInRange);  
    }
