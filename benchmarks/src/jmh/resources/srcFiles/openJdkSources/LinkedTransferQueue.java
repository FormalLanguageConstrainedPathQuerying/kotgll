...
public class LinkedTransferQueue<E> extends AbstractQueue<E>
    ...
    static final class DualNode implements ForkJoinPool.ManagedBlocker {
        ...
        final Object await(Object e, long ns, Object blocker, boolean spin) {
            ...
            boolean upc = isUniprocessor;  
            Thread w = Thread.currentThread();
            if (w.isVirtual())             
                spin = false;
            int spins = (spin & !upc) ? SPINS : 0; 
            while ((m = item) == e) {
                if (spins >= 0) {
                    if (--spins >= 0)
                        Thread.onSpinWait();
    ...
    final class Itr implements Iterator<E> {
        ...
        private E nextItem;          
        private DualNode lastRet;    
        private DualNode ancestor;   
