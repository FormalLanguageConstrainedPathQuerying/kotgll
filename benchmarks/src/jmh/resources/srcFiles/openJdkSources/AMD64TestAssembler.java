...
public class AMD64TestAssembler extends TestAssembler {
    ...
    public void emitPrologue() {
        emitFatNop();
        code.emitByte(0x50 | AMD64.rbp.encoding);  
        emitMove(true, AMD64.rbp, AMD64.rsp);      
    ...
    public Register emitLoadInt(Register ret, int c) {
        ...
        code.emitByte(0xB8 | (ret.encoding & 0x7)); 
        code.emitInt(c);
        return ret;
    }
    ...
    public Register emitLoadFloat(Register ret, float c) {
        ...
        code.emitByte(0x0F);
        code.emitByte(0x10);                               
        code.emitByte(0x05 | ((ret.encoding & 0x7) << 3)); 
        code.emitInt(0xDEADDEAD);
        return ret;
    }
    ...
    public Register emitLoadPointer(Register b, int offset) {
        Register ret = newRegister();
        emitModRMMemory(true, 0x8B, ret.encoding, b.encoding, offset); 
        return ret;
    }
    ...
    public StackSlot emitFloatToStack(StackSlot ret, Register a) {
        ...
        code.emitByte(0x0F);
        code.emitByte(0x11);                               
        code.emitByte(0x85 | ((a.encoding & 0x7) << 3));   
    ...
    public void emitIntRet(Register a) {
        emitMove(false, AMD64.rax, a);             
        emitMove(true, AMD64.rsp, AMD64.rbp);      
        code.emitByte(0x58 | AMD64.rbp.encoding);  
        code.emitByte(0xC3);                       
    }
