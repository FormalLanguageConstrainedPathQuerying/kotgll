...
final class Float128Vector extends FloatVector {
    ...
    public final Float128Vector broadcast(float e) {
        return (Float128Vector) super.broadcastTemplate(e);  
    }
    ...
    Float128Vector uOp(FUnOp f) {
        return (Float128Vector) super.uOpTemplate(f);  
    }
    ...
    Float128Vector uOp(VectorMask<Float> m, FUnOp f) {
        return (Float128Vector)
            super.uOpTemplate((Float128Mask)m, f);  
    }
    ...
    Float128Vector bOp(Vector<Float> v, FBinOp f) {
        return (Float128Vector) super.bOpTemplate((Float128Vector)v, f);  
    }
    ...
    public Float128Vector lanewise(Unary op) {
        return (Float128Vector) super.lanewiseTemplate(op);  
    }

    @Override
    @ForceInline
    public Float128Vector lanewise(Unary op, VectorMask<Float> m) {
        return (Float128Vector) super.lanewiseTemplate(op, Float128Mask.class, (Float128Mask) m);  
    }

    @Override
    @ForceInline
    public Float128Vector lanewise(Binary op, Vector<Float> v) {
        return (Float128Vector) super.lanewiseTemplate(op, v);  
    }

    @Override
    @ForceInline
    public Float128Vector lanewise(Binary op, Vector<Float> v, VectorMask<Float> m) {
        return (Float128Vector) super.lanewiseTemplate(op, Float128Mask.class, v, (Float128Mask) m);  
    }
    ...
    lanewise(Ternary op, Vector<Float> v1, Vector<Float> v2) {
        return (Float128Vector) super.lanewiseTemplate(op, v1, v2);  
    }
    ...
    lanewise(Ternary op, Vector<Float> v1, Vector<Float> v2, VectorMask<Float> m) {
        return (Float128Vector) super.lanewiseTemplate(op, Float128Mask.class, v1, v2, (Float128Mask) m);  
    }
    ...
    Float128Vector addIndex(int scale) {
        return (Float128Vector) super.addIndexTemplate(scale);  
    }
    ...
    public final float reduceLanes(VectorOperators.Associative op,
                                    VectorMask<Float> m) {
        return super.reduceLanesTemplate(op, Float128Mask.class, (Float128Mask) m);  
    }
    ...
    public final long reduceLanesToLong(VectorOperators.Associative op,
                                        VectorMask<Float> m) {
        return (long) super.reduceLanesTemplate(op, Float128Mask.class, (Float128Mask) m);  
    }

    @ForceInline
    public VectorShuffle<Float> toShuffle() {
        return super.toShuffleTemplate(Float128Shuffle.class); 
    }
    ...
    public final Float128Mask test(Test op) {
        return super.testTemplate(Float128Mask.class, op);  
    }

    @Override
    @ForceInline
    public final Float128Mask test(Test op, VectorMask<Float> m) {
        return super.testTemplate(Float128Mask.class, op, (Float128Mask) m);  
    }
    ...
    public final Float128Mask compare(Comparison op, Vector<Float> v) {
        return super.compareTemplate(Float128Mask.class, op, v);  
    }

    @Override
    @ForceInline
    public final Float128Mask compare(Comparison op, float s) {
        return super.compareTemplate(Float128Mask.class, op, s);  
    }
    ...
    public Float128Vector slice(int origin, Vector<Float> v) {
        return (Float128Vector) super.sliceTemplate(origin, v);  
    }

    @Override
    @ForceInline
    public Float128Vector slice(int origin) {
        return (Float128Vector) super.sliceTemplate(origin);  
    }

    @Override
    @ForceInline
    public Float128Vector unslice(int origin, Vector<Float> w, int part) {
        return (Float128Vector) super.unsliceTemplate(origin, w, part);  
    }
    ...
    public Float128Vector unslice(int origin) {
        return (Float128Vector) super.unsliceTemplate(origin);  
    }
    ...
    static final class Float128Mask extends AbstractMask<Float> {
        ...
        Float128Vector toVector() {
            return (Float128Vector) super.toVectorTemplate();  
        }
    ...
    FloatVector fromArray0(float[] a, int offset, VectorMask<Float> m, int offsetInRange) {
        return super.fromArray0Template(Float128Mask.class, a, offset, (Float128Mask) m, offsetInRange);  
    }
    ...
    FloatVector fromMemorySegment0(MemorySegment ms, long offset, VectorMask<Float> m, int offsetInRange) {
        return super.fromMemorySegment0Template(Float128Mask.class, ms, offset, (Float128Mask) m, offsetInRange);  
    }
