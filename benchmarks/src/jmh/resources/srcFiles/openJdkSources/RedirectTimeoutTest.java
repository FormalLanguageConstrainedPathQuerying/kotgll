...
public class RedirectTimeoutTest {
    ...
    private static final long SLEEP_TIME = 1500L; 
    ...
    public void setup() throws IOException {
        ...
        h1Uri = URI.create("http:
        h1RedirectUri = URI.create("http:
        h2Uri = URI.create("http:
        h2RedirectUri = URI.create("http:
        h2WarmupUri = URI.create("http:
