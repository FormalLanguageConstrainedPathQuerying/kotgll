...
public class AsFileDownloadTest {
    ...
    static final String[][] contentDispositionBADValues = new String[][] {
            { "100", ""                                    },  
            { "101", "filename=example.html"               },  
            { "102", "attachment; filename=space name"     },  
            { "103", "attachment; filename="               },  
            { "104", "attachment; filename=\""             },  
            { "105", "attachment; filename=\"\""           },  
            { "106", "attachment; filename=."              },  
            { "107", "attachment; filename=.."             },  
            { "108", "attachment; filename=\".."           },  
            { "109", "attachment; filename=\"..\""         },  
            { "110", "attachment; filename=\"bad"          },  
            { "111", "attachment; filename=\"bad;"         },  
            { "112", "attachment; filename=\"bad ;"        },  
            { "113", "attachment; filename*=utf-8''xx.txt "},  
    ...
    static String contentDispositionValueFromURI(URI uri) {
        ...
        String[][] values;
        if (queryIndex.startsWith("0"))  
            values = contentDispositionValues;
        else if (queryIndex.startsWith("1"))  
