...
public class ModuleAccessTest {
    ...
    public void testLookupInSamePackage(Lookup lookup, Class<?> targetClass) throws Exception {
        ...
        assertTrue(lookup2.lookupClass() == targetClass);   
        assertTrue(lookup2.previousLookupClass() == lookup.previousLookupClass());  
        assertTrue(lookup2.lookupModes() == (lookup.lookupModes() & ~(PROTECTED|PRIVATE|ORIGINAL)));  
    }
    ...
    public void testLookupInSameModule(Lookup lookup, Class<?> targetClass) throws Exception {
        ...
        assertTrue(lookup2.lookupClass() == targetClass);   
        assertTrue(lookup2.previousLookupClass() == lookup.previousLookupClass());  
        assertTrue(lookup2.lookupModes() == (lookup.lookupModes() & ~(PROTECTED|PRIVATE|PACKAGE|ORIGINAL))); 
    }
    ...
    public void testLookupInAnotherModule(Lookup lookup, Class<?> targetClass,
        ...
        assertTrue(lookup2.lookupModes() == (lookup.lookupModes() & ~(PROTECTED|PRIVATE|PACKAGE|MODULE|ORIGINAL)));  
    ...
    public void testLookupInThirdModule(Lookup lookup, Class<?> c1, Class<?> c2) throws Exception {
        ...
        assertTrue(lookup2.lookupClass() == c2);                    
        assertTrue(lookup2.previousLookupClass() == c1);            
        assertTrue(lookup2.lookupModes() == 0, lookup2.toString()); 
    }
    ...
    public void testPrivateLookupIn(Lookup lookup, Class<?> targetClass) throws Exception {
        ...
        assertTrue(privLookup1.lookupModes() == (PROTECTED|PRIVATE|PACKAGE|PUBLIC));  
        assertTrue(privLookup1.lookupClass() == targetClass);                    
        assertTrue(privLookup1.previousLookupClass() == lookup.lookupClass());   

        try {
            Lookup privLookup2 = MethodHandles.privateLookupIn(targetClass, privLookup1); 
