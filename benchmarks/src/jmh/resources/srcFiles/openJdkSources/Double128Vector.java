...
final class Double128Vector extends DoubleVector {
    ...
    public final Double128Vector broadcast(double e) {
        return (Double128Vector) super.broadcastTemplate(e);  
    }
    ...
    Double128Vector uOp(FUnOp f) {
        return (Double128Vector) super.uOpTemplate(f);  
    }
    ...
    Double128Vector uOp(VectorMask<Double> m, FUnOp f) {
        return (Double128Vector)
            super.uOpTemplate((Double128Mask)m, f);  
    }
    ...
    Double128Vector bOp(Vector<Double> v, FBinOp f) {
        return (Double128Vector) super.bOpTemplate((Double128Vector)v, f);  
    }
    ...
    public Double128Vector lanewise(Unary op) {
        return (Double128Vector) super.lanewiseTemplate(op);  
    }

    @Override
    @ForceInline
    public Double128Vector lanewise(Unary op, VectorMask<Double> m) {
        return (Double128Vector) super.lanewiseTemplate(op, Double128Mask.class, (Double128Mask) m);  
    }

    @Override
    @ForceInline
    public Double128Vector lanewise(Binary op, Vector<Double> v) {
        return (Double128Vector) super.lanewiseTemplate(op, v);  
    }

    @Override
    @ForceInline
    public Double128Vector lanewise(Binary op, Vector<Double> v, VectorMask<Double> m) {
        return (Double128Vector) super.lanewiseTemplate(op, Double128Mask.class, v, (Double128Mask) m);  
    }
    ...
    lanewise(Ternary op, Vector<Double> v1, Vector<Double> v2) {
        return (Double128Vector) super.lanewiseTemplate(op, v1, v2);  
    }
    ...
    lanewise(Ternary op, Vector<Double> v1, Vector<Double> v2, VectorMask<Double> m) {
        return (Double128Vector) super.lanewiseTemplate(op, Double128Mask.class, v1, v2, (Double128Mask) m);  
    }
    ...
    Double128Vector addIndex(int scale) {
        return (Double128Vector) super.addIndexTemplate(scale);  
    }
    ...
    public final double reduceLanes(VectorOperators.Associative op,
                                    VectorMask<Double> m) {
        return super.reduceLanesTemplate(op, Double128Mask.class, (Double128Mask) m);  
    }
    ...
    public final long reduceLanesToLong(VectorOperators.Associative op,
                                        VectorMask<Double> m) {
        return (long) super.reduceLanesTemplate(op, Double128Mask.class, (Double128Mask) m);  
    }
    ...
    public final Double128Mask test(Test op) {
        return super.testTemplate(Double128Mask.class, op);  
    }

    @Override
    @ForceInline
    public final Double128Mask test(Test op, VectorMask<Double> m) {
        return super.testTemplate(Double128Mask.class, op, (Double128Mask) m);  
    }
    ...
    public final Double128Mask compare(Comparison op, Vector<Double> v) {
        return super.compareTemplate(Double128Mask.class, op, v);  
    }

    @Override
    @ForceInline
    public final Double128Mask compare(Comparison op, double s) {
        return super.compareTemplate(Double128Mask.class, op, s);  
    }
    ...
    public Double128Vector slice(int origin, Vector<Double> v) {
        return (Double128Vector) super.sliceTemplate(origin, v);  
    }

    @Override
    @ForceInline
    public Double128Vector slice(int origin) {
        return (Double128Vector) super.sliceTemplate(origin);  
    }

    @Override
    @ForceInline
    public Double128Vector unslice(int origin, Vector<Double> w, int part) {
        return (Double128Vector) super.unsliceTemplate(origin, w, part);  
    }
    ...
    public Double128Vector unslice(int origin) {
        return (Double128Vector) super.unsliceTemplate(origin);  
    }
    ...
    DoubleVector fromArray0(double[] a, int offset, VectorMask<Double> m, int offsetInRange) {
        return super.fromArray0Template(Double128Mask.class, a, offset, (Double128Mask) m, offsetInRange);  
    }
    ...
    DoubleVector fromMemorySegment0(MemorySegment ms, long offset, VectorMask<Double> m, int offsetInRange) {
        return super.fromMemorySegment0Template(Double128Mask.class, ms, offset, (Double128Mask) m, offsetInRange);  
    }
