...
public class TestAlignVectorFuzzer {
    static final int ITERATIONS_MAX = 5; 
    ...
    static int hand_unrolling1_con() { 
        try {
    ...
    static int hand_unrolling2_con() { 
        try {
    ...
    static int hand_unrolling3_con() { 
        try {
    ...
    static int randomStride() {
        return switch (random.nextInt(6)) {
            case 0       -> random.nextInt(64) + 1; 
            case 1, 2, 3 -> 1;
            default      -> 1 << random.nextInt(7); 
        };
    }
    ...
    static int randomOffsetDiff() {
        return switch (random.nextInt(6)) {
            ...
            case 1, 2, 3 -> 0;
            case 4       -> +(1 << random.nextInt(8)); 
            default      -> -(1 << random.nextInt(8)); 
        };
    }

    static int randomHandUnrolling() {
        return switch (random.nextInt(2)) {
            case 0       -> random.nextInt(16) + 1; 
