...
relativeError));
    ...
    static void smokeTest2() {
        ...
        FloatVector a = io.add((float)1); 
        FloatVector b = a.neg();  
        float[] abValues = bothToArray(a,b); 
        VectorShuffle<Float> zip0 = VectorShuffle.makeZip(SPECIES, 0);
        VectorShuffle<Float> zip1 = VectorShuffle.makeZip(SPECIES, 1);
        FloatVector zab0 = a.rearrange(zip0,b); 
        FloatVector zab1 = a.rearrange(zip1,b); 
        float[] zabValues = bothToArray(zab0, zab1); 
