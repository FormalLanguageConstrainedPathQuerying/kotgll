...
public class TestHttpCookie {
    ...
    static void rfc2965() {
        ...
        test("Set-Cookie2:Customer=\"developer\";Domain=\"sun.com\";Max-Age=\"100\";Path=\"/www\";Port=\"80,8080\";CommentURL=\"http:
        .n("Customer").v("developer").d("sun.com").p("/www").port("80,8080").a(100).cu("http:
