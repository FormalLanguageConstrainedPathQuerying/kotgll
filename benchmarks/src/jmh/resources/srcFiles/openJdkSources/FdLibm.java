...
final class FdLibm {
    ...
    static final class Sin {
        ...
        private static final double
            S1  = -0x1.5555555555549p-3,  
            S2  =  0x1.111111110f8a6p-7,  
            S3  = -0x1.a01a019c161d5p-13, 
            S4  =  0x1.71de357b1fe7dp-19, 
            S5  = -0x1.ae5e68a2b9cebp-26, 
            S6  =  0x1.5d93a5acfd57cp-33; 

        static double __kernel_sin(double x, double y, int iy) {
            double z, r, v;
            int ix;
            ix = __HI(x) & EXP_SIGNIF_BITS;    
            if (ix < 0x3e40_0000) {            
                if ((int)x == 0)               
                    return x;
            }
    ...
    static final class Cos {
         ...
         */
        private static final double
            C1  =  0x1.555555555554cp-5,  
            C2  = -0x1.6c16c16c15177p-10, 
            C3  =  0x1.a01a019cb159p-16,  
            C4  = -0x1.27e4f809c52adp-22, 
            C5  =  0x1.1ee9ebdb4b1c4p-29, 
            C6  = -0x1.8fae9be8838d4p-37; 
    ...
    static final class Tan {
        ...
        private static final double
            ...
            pio4lo=  0x1.1a62633145c07p-55, 
            T[] = {
             0x1.5555555555563p-2,  
             0x1.111111110fe7ap-3,  
             0x1.ba1ba1bb341fep-5,  
             0x1.664f48406d637p-6,  
             0x1.226e3e96e8493p-7,  
             0x1.d6d22c9560328p-9,  
             0x1.7dbc8fee08315p-10, 
             0x1.344d8f2f26501p-11, 
             0x1.026f71a8d1068p-12, 
             0x1.47e88a03792a6p-14, 
             0x1.2b80f32f0a7e9p-14, 
            -0x1.375cbdb605373p-16, 
             0x1.b2a7074bf7ad4p-16, 
        };
    ...
    static final class RemPio2 {
        ...
        private static final double
            invpio2 =  0x1.45f306dc9c883p-1,   
            pio2_1  =  0x1.921fb544p0,         
    ...
    static final class Asin {
        ...
        private static final double
            pio2_hi = 0x1.921fb54442d18p0,   
            pio2_lo = 0x1.1a62633145c07p-54, 
            pio4_hi = 0x1.921fb54442d18p-1,  
            pS0 =  0x1.5555555555555p-3,     
            pS1 = -0x1.4d61203eb6f7dp-2,     
            pS2 =  0x1.9c1550e884455p-3,     
            pS3 = -0x1.48228b5688f3bp-5,     
            pS4 =  0x1.9efe07501b288p-11,    
            pS5 =  0x1.23de10dfdf709p-15,    
            qS1 = -0x1.33a271c8a2d4bp1,      
            qS2 =  0x1.02ae59c598ac8p1,      
            qS3 = -0x1.6066c1b8d0159p-1,     
            qS4 =  0x1.3b8c5b12e9282p-4;     
    ...
    static final class Atan2 {
        ...
        private static final double
            tiny    = 1.0e-300,
            pi_o_4  = 0x1.921fb54442d18p-1,  
            pi_o_2  = 0x1.921fb54442d18p0,   
            pi_lo   = 0x1.1a62633145c07p-53; 
        ...
        static double compute(double y, double x) {
            ...
            if ((iy | ly) == 0) {
                ...
                case 0:
                case 1: return y;               
                case 2: return  Math.PI + tiny; 
                case 3: return -Math.PI - tiny; 
                }
            }
            if ((ix | lx) == 0) {
            ...
            case 0:  return  z;                     
            case 1:  return -z;                     
            case 2:  return  Math.PI - (z - pi_lo); 
            default: return (z - pi_lo) - Math.PI;  
            }
        }
    }
    ...
    static final class Cbrt {
        ...
        private static final double D = -0x1.691de2532c834p-1; 
        private static final double E =  0x1.6a0ea0ea0ea0fp0;  
    ...
    static final class Exp {
        ...
        private static final double huge    = 1.0e+300;
        private static final double twom1000=     0x1.0p-1000;             
        private static final double o_threshold=  0x1.62e42fefa39efp9;     
        private static final double u_threshold= -0x1.74910d52d3051p9;     
        private static final double[] ln2HI   ={  0x1.62e42feep-1,         
                                                 -0x1.62e42feep-1};        
        private static final double[] ln2LO   ={  0x1.a39ef35793c76p-33,   
                                                 -0x1.a39ef35793c76p-33};  
        private static final double invln2 =      0x1.71547652b82fep0;     

        private static final double P1   =  0x1.555555555553ep-3;  
        private static final double P2   = -0x1.6c16c16bebd93p-9;  
        private static final double P3   =  0x1.1566aaf25de2cp-14; 
    ...
    static final class Log {
        ...
        private static final double
            ln2_hi = 0x1.62e42feep-1,       
            ln2_lo = 0x1.a39ef35793c76p-33, 

            Lg1    = 0x1.5555555555593p-1,  
            Lg2    = 0x1.999999997fa04p-2,  
            Lg3    = 0x1.2492494229359p-2,  
            Lg4    = 0x1.c71c51d8e78afp-3,  
            Lg5    = 0x1.7466496cb03dep-3,  
            Lg6    = 0x1.39a09d078c69fp-3,  
            Lg7    = 0x1.2f112df3e5244p-3;  
    ...
    static final class Log10 {
        private static final double ivln10    = 0x1.bcb7b1526e50ep-2;  

        private static final double log10_2hi = 0x1.34413509f6p-2;     
        private static final double log10_2lo = 0x1.9fef311f12b36p-42; 
    ...
    static final class Log1p {
        ...
        private static final double Lp1    = 0x1.5555555555593p-1;  
        private static final double Lp2    = 0x1.999999997fa04p-2;  
        private static final double Lp3    = 0x1.2492494229359p-2;  
        private static final double Lp4    = 0x1.c71c51d8e78afp-3;  
        private static final double Lp5    = 0x1.7466496cb03dep-3;  
        private static final double Lp6    = 0x1.39a09d078c69fp-3;  
        private static final double Lp7    = 0x1.2f112df3e5244p-3;  
    ...
    static final class Expm1 {
        ...
        private static final double ln2_lo      =  0x1.a39ef35793c76p-33; 
        private static final double invln2      =  0x1.71547652b82fep0;   
        private static final double Q1          = -0x1.11111111110f4p-5;  
        private static final double Q2          =  0x1.a01a019fe5585p-10; 
        private static final double Q3          = -0x1.4ce199eaadbb7p-14; 
        private static final double Q4          =  0x1.0cfca86e65239p-18; 
        private static final double Q5          = -0x1.afdb76e09c32dp-23; 
        ...
        static double compute(double x) {
            ...
            if (k == 0) {
                ...
                t = 1.0;
                if (k < 20) {
                    t = __HI(t, 0x3ff0_0000 - (0x2_00000 >> k));  
                    y = t - ( e - x);
                    y = __HI(y, __HI(y) + (k << 20));     
                } else {
                    t = __HI(t, ((0x3ff - k) << 20));     
    ...
    static final class IEEEremainder {
        ...
        private static double __ieee754_fmod(double x, double y) {
            ...
            if ((hy | ly) == 0 || (hx >= EXP_BITS)||       
               ((hy | ((ly | -ly) >>> 31)) > EXP_BITS))    
                return (x*y)/(x*y);
            if (hx <= hy) {
