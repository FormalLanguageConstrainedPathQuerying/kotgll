 ...
 * <DD><pre>{@code
 *     0: 4e 6f 77 20 69 73 20 74 68 65 20 74 69 6d 65 20  
 ...
 * <DD><pre>{@code
 *     (byte) 78, (byte)111, (byte)119, (byte) 32, (byte)105, (byte)115, (byte) 32, (byte)116,  
 *     (byte)104, (byte)101, (byte) 32, (byte)116, (byte)105, (byte)109, (byte)101, (byte) 32,  
 *     (byte)102, (byte)111, (byte)114, (byte) 32, (byte) 74, (byte) 97, (byte)118, (byte) 97,  
 *     (byte) 46, (byte) 10,                                                                    
 * </DD>
 * </DL>
 * <p>
...
public final class HexPrinter {
     ...
     *
     * Result:
     *     0: 00 00 00 00 3f 80 00 00  
     *     8: 40 00 00 00 40 40 00 00  
     * }</pre>
     *
     * <p>
        ...
        private void process() {
            ...
            try {
                ...
                while (count > 0 || info.length() > 0) {
                    int offset = binColOffset + baseOffset; 
