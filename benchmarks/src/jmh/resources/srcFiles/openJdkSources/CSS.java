...
/*
    ...
    static class LengthUnit implements Serializable {
        ...
        static {
            ...
            w3cLengthMapping.put("pt", 96f / 72f);         
            w3cLengthMapping.put("px", 1f);                
            w3cLengthMapping.put("mm", 96f / 2.54f / 10f); 
            w3cLengthMapping.put("cm", 96f / 2.54f);       
            w3cLengthMapping.put("pc", 96f / 6f);          
            w3cLengthMapping.put("in", 96f);               
        }
