                ...
                cb.withMethod("main" + ((xi == 0) ? "" : "" + xi), MTD_void_StringArray,
                              ...
                              mb -> mb.withCode(c0 -> {
                                  ...
                                  c0.constantInstruction(ICONST_1, 1)         
                                    .storeInstruction(IntType, vFac)        
                                    .constantInstruction(ICONST_1, 1)         
                                    .storeInstruction(IntType, vI)          
                                    .labelBinding(loopTop)
                                    .loadInstruction(IntType, vI)           
