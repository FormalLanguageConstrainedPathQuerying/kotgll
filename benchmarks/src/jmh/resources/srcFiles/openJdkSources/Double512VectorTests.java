...
relativeError));
    ...
    static void smokeTest2() {
        ...
        DoubleVector a = io.add((double)1); 
        DoubleVector b = a.neg();  
        double[] abValues = bothToArray(a,b); 
        VectorShuffle<Double> zip0 = VectorShuffle.makeZip(SPECIES, 0);
        VectorShuffle<Double> zip1 = VectorShuffle.makeZip(SPECIES, 1);
        DoubleVector zab0 = a.rearrange(zip0,b); 
        DoubleVector zab1 = a.rearrange(zip1,b); 
        double[] zabValues = bothToArray(zab0, zab1); 
