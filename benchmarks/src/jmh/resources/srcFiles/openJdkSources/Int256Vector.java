...
final class Int256Vector extends IntVector {
    ...
    public final Int256Vector broadcast(int e) {
        return (Int256Vector) super.broadcastTemplate(e);  
    }
    ...
    Int256Vector uOp(FUnOp f) {
        return (Int256Vector) super.uOpTemplate(f);  
    }
    ...
    Int256Vector uOp(VectorMask<Integer> m, FUnOp f) {
        return (Int256Vector)
            super.uOpTemplate((Int256Mask)m, f);  
    }
    ...
    Int256Vector bOp(Vector<Integer> v, FBinOp f) {
        return (Int256Vector) super.bOpTemplate((Int256Vector)v, f);  
    }
    ...
    public Int256Vector lanewise(Unary op) {
        return (Int256Vector) super.lanewiseTemplate(op);  
    }

    @Override
    @ForceInline
    public Int256Vector lanewise(Unary op, VectorMask<Integer> m) {
        return (Int256Vector) super.lanewiseTemplate(op, Int256Mask.class, (Int256Mask) m);  
    }
    ...
    public Int256Vector lanewise(Binary op, Vector<Integer> v, VectorMask<Integer> m) {
        return (Int256Vector) super.lanewiseTemplate(op, Int256Mask.class, v, (Int256Mask) m);  
    }
    ...
    lanewiseShift(VectorOperators.Binary op, int e) {
        return (Int256Vector) super.lanewiseShiftTemplate(op, e);  
    }
    ...
    lanewiseShift(VectorOperators.Binary op, int e, VectorMask<Integer> m) {
        return (Int256Vector) super.lanewiseShiftTemplate(op, Int256Mask.class, e, (Int256Mask) m);  
    }
    ...
    lanewise(Ternary op, Vector<Integer> v1, Vector<Integer> v2) {
        return (Int256Vector) super.lanewiseTemplate(op, v1, v2);  
    }
    ...
    lanewise(Ternary op, Vector<Integer> v1, Vector<Integer> v2, VectorMask<Integer> m) {
        return (Int256Vector) super.lanewiseTemplate(op, Int256Mask.class, v1, v2, (Int256Mask) m);  
    }
    ...
    Int256Vector addIndex(int scale) {
        return (Int256Vector) super.addIndexTemplate(scale);  
    }
    ...
    public final int reduceLanes(VectorOperators.Associative op,
        ...
        return super.reduceLanesTemplate(op, Int256Mask.class, (Int256Mask) m);  
    }
    ...
    public final long reduceLanesToLong(VectorOperators.Associative op,
                                        VectorMask<Integer> m) {
        return (long) super.reduceLanesTemplate(op, Int256Mask.class, (Int256Mask) m);  
    }

    @ForceInline
    public VectorShuffle<Integer> toShuffle() {
        return super.toShuffleTemplate(Int256Shuffle.class); 
    }
    ...
    public final Int256Mask test(Test op) {
        return super.testTemplate(Int256Mask.class, op);  
    }

    @Override
    @ForceInline
    public final Int256Mask test(Test op, VectorMask<Integer> m) {
        return super.testTemplate(Int256Mask.class, op, (Int256Mask) m);  
    }
    ...
    public final Int256Mask compare(Comparison op, Vector<Integer> v) {
        return super.compareTemplate(Int256Mask.class, op, v);  
    }

    @Override
    @ForceInline
    public final Int256Mask compare(Comparison op, int s) {
        return super.compareTemplate(Int256Mask.class, op, s);  
    }
    ...
    public Int256Vector slice(int origin, Vector<Integer> v) {
        return (Int256Vector) super.sliceTemplate(origin, v);  
    }

    @Override
    @ForceInline
    public Int256Vector slice(int origin) {
        return (Int256Vector) super.sliceTemplate(origin);  
    }

    @Override
    @ForceInline
    public Int256Vector unslice(int origin, Vector<Integer> w, int part) {
        return (Int256Vector) super.unsliceTemplate(origin, w, part);  
    }
    ...
    public Int256Vector unslice(int origin) {
        return (Int256Vector) super.unsliceTemplate(origin);  
    }
    ...
    static final class Int256Mask extends AbstractMask<Integer> {
        ...
        Int256Vector toVector() {
            return (Int256Vector) super.toVectorTemplate();  
        }
    ...
    IntVector fromArray0(int[] a, int offset, VectorMask<Integer> m, int offsetInRange) {
        return super.fromArray0Template(Int256Mask.class, a, offset, (Int256Mask) m, offsetInRange);  
    }
    ...
    IntVector fromMemorySegment0(MemorySegment ms, long offset, VectorMask<Integer> m, int offsetInRange) {
        return super.fromMemorySegment0Template(Int256Mask.class, ms, offset, (Int256Mask) m, offsetInRange);  
    }
