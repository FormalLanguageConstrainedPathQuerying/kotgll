...
public interface DOMImplementation {
     ...
     * version, as specified in <a href="http:
     ...
     *   an XML name according to [<a href='http:
     *   <br>NAMESPACE_ERR: Raised if the <code>qualifiedName</code> is
     *   malformed.
     *   <br>NOT_SUPPORTED_ERR: May be raised if the implementation does not
     *   support the feature "XML" and the language exposed through the
     *   Document does not support XML Namespaces (such as [<a href='http:
     * @since 1.4, DOM Level 2
     */
     ...
     * the "Core", such as "HTML" [<a href='http:
     ...
     * such as <code>createHTMLDocument</code> [<a href='http:
     ...
     *   the <code>namespaceURI</code> is different from "<a href='http:
     *   http:
