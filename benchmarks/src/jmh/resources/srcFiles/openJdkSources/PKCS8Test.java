...
public class PKCS8Test {
    ...
    public void test() throws IOException {
        ...
        enlarge(0, "8000");    
        enlarge(1, "810100");  
        enlarge(1, "8000", "810100");  

        Assert.assertThrows(() -> enlarge(2));  
        Assert.assertThrows(() -> enlarge(0, "8000", "8000")); 
        Assert.assertThrows(() -> enlarge(0, "810100")); 
        Assert.assertThrows(() -> enlarge(1, "810100", "8000")); 
        Assert.assertThrows(() -> enlarge(1, "820100")); 
    }
    ...
    static void enlarge(int newVersion, String... fields) throws IOException {
        ...
        original[1] = (byte)(length - 2);   
        original[4] = (byte)newVersion;     
