...
public class SamlSpMetadataBuilderTests extends SamlTestCase {
    ...
    public void testBuildMinimalistMetadata() throws Exception {
        final EntityDescriptor descriptor = new SamlSpMetadataBuilder(Locale.getDefault(), "https:
    ...
    public void testBuildFullMetadata() throws Exception {
        final EntityDescriptor descriptor = new SamlSpMetadataBuilder(Locale.US, "https:
            ...
            .organization("Hydra", "Hydra", "https:
        ...
        final String expectedXml = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
            ...
            + "    <md:OrganizationURL xml:lang=\"en-US\">https:
            + "  </md:Organization>"
    ...
    public void testAssertionConsumerServiceIsRequired() {
        final SamlSpMetadataBuilder builder = new SamlSpMetadataBuilder(Locale.US, "https:
