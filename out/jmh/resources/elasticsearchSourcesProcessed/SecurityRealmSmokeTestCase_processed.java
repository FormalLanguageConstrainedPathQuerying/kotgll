...
public abstract class SecurityRealmSmokeTestCase extends ESRestTestCase {
    ...
    public static ElasticsearchCluster cluster = ElasticsearchCluster.local()
        ...
        .setting("xpack.security.authc.realms.ldap.ldap2.url", "ldap:
        ...
        .setting("xpack.security.authc.realms.saml.saml5.idp.entity_id", "http:
        .setting("xpack.security.authc.realms.saml.saml5.sp.entity_id", "http:
        .setting("xpack.security.authc.realms.saml.saml5.sp.acs", "http:
        ...
        .setting("xpack.security.authc.realms.oidc.openid7.rp.client_id", "http:
        .setting("xpack.security.authc.realms.oidc.openid7.rp.response_type", "id_token")
        .setting("xpack.security.authc.realms.oidc.openid7.rp.redirect_uri", "https:
        .setting("xpack.security.authc.realms.oidc.openid7.op.issuer", "https:
        .setting("xpack.security.authc.realms.oidc.openid7.op.authorization_endpoint", "https:
