...
public class SuggestSearchIT extends ESIntegTestCase {
    ...
    public void testSuggestAcrossMultipleIndices() throws IOException {
        ...
        TermSuggestionBuilder termSuggest = termSuggestion("text").suggestMode(SuggestMode.ALWAYS) 
            .text("abcd");
        ...
        refresh();
        termSuggest = termSuggestion("text").suggestMode(SuggestMode.ALWAYS) 
            .text("ab cd")
            .minWordLength(1);
    ...
    public void testSizeOneShard() throws Exception {
        ...
        TermSuggestionBuilder termSuggestion = termSuggestion("text").suggestMode(SuggestMode.ALWAYS) 
            .text("abcd")
            .size(10);
