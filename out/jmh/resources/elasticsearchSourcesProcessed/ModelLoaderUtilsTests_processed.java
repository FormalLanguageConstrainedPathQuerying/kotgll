...
public class ModelLoaderUtilsTests extends ESTestCase {
    ...
    public void testResolvePackageLocationTrailingSlash() throws URISyntaxException {
        assertEquals(new URI("file:/home/ml/package.ext"), ModelLoaderUtils.resolvePackageLocation("file:
        assertEquals(new URI("file:/home/ml/package.ext"), ModelLoaderUtils.resolvePackageLocation("file:
        assertEquals(
            new URI("http:
            ModelLoaderUtils.resolvePackageLocation("http:
        );
        assertEquals(
            new URI("http:
            ModelLoaderUtils.resolvePackageLocation("http:
    ...
    public void testResolvePackageLocationBreakout() {
        Exception e = expectThrows(
            IllegalArgumentException.class,
            () -> ModelLoaderUtils.resolvePackageLocation("file:
        );
