...
public class JwtRestIT extends ESRestTestCase {
    ...
    private static Map<String, String> realmSettings(LocalClusterSpec.LocalNodeSpec localNodeSpec) {
        ...
        settings.put("xpack.security.authc.realms.jwt.jwt1.allowed_issuer", "https:
        settings.put("xpack.security.authc.realms.jwt.jwt1.allowed_audiences", "https:
