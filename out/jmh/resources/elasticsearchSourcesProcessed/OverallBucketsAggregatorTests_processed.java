    ...
    public void testProcess_GivenAggSpanIsTwiceTheBucketSpan() {
        ...
        rawBuckets1.add(
            new OverallBucket(
                ...
                3600L,
                10.0,
                Arrays.asList(new OverallBucket.JobInfo("job_1", 10.0), new OverallBucket.JobInfo("job_2", 6.0)),
                false
            )
        );
        rawBuckets1.add(
            new OverallBucket(
                new Date(startTime + TimeValue.timeValueHours(1).millis()),
                3600L,
                20.0,
        ...
        rawBuckets1.add(
            new OverallBucket(
                new Date(startTime + TimeValue.timeValueHours(2).millis()),
                3600L,
                30.0,
        ...
        rawBuckets1.add(
            new OverallBucket(
                new Date(startTime + TimeValue.timeValueHours(3).millis()),
                3600L,
                40.0,
        ...
        rawBuckets1.add(
            new OverallBucket(
                new Date(startTime + TimeValue.timeValueHours(4).millis()),
                3600L,
                50.0,
                Collections.singletonList(new JobInfo("job_1", 50.0)),
                false
            )
        );
        rawBuckets1.add(
            new OverallBucket(
                new Date(startTime + TimeValue.timeValueHours(5).millis()),
                3600L,
                60.0,
                Collections.singletonList(new JobInfo("job_1", 60.0)),
                true
            )
        );
        rawBuckets1.add(
            new OverallBucket(
                new Date(startTime + TimeValue.timeValueHours(6).millis()),
                3600L,
                70.0,
        ...
        assertThat(aggregated.get(0).getJobs(), contains(new JobInfo("job_1", 20.0), new JobInfo("job_2", 6.0)));
        ...
        assertThat(aggregated.get(1).getJobs(), contains(new JobInfo("job_1", 30.0), new JobInfo("job_2", 40.0)));
        ...
        assertThat(aggregated.get(3).getJobs(), contains(new JobInfo("job_1", 70.0), new JobInfo("job_2", 0.0)));
