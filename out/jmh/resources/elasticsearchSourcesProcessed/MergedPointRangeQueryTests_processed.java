...
public class MergedPointRangeQueryTests extends ESTestCase {
    ...
    public void testOverlap() throws IOException {
        ...
        assertFalse(matches1d(overlapping, -50));       
        assertTrue(matches1d(overlapping, 50));         
        assertTrue(matches1d(overlapping, -50, 10));    
        assertTrue(matches1d(overlapping, -200, 50));   
        assertFalse(matches1d(overlapping, -50, 200));  
    }
    ...
    public void testNonOverlap() throws IOException {
        ...
        assertFalse(matches1d(disjoint, randomLong()));   
        assertFalse(matches1d(disjoint, -50, -20));       
        assertFalse(matches1d(disjoint, 20, 50));         
        assertTrue(matches1d(disjoint, -50, 50));         
        assertFalse(matches1d(disjoint, -50, 200));       
        assertFalse(matches1d(disjoint, -200, 50));       
    }
