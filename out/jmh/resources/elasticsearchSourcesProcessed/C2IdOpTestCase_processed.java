...
public abstract class C2IdOpTestCase extends ESRestTestCase {
    ...
    public static ElasticsearchCluster cluster = ElasticsearchCluster.local()
        ...
        .setting("xpack.security.authc.realms.oidc.c2id.rp.redirect_uri", "https:
        .setting("xpack.security.authc.realms.oidc.c2id.rp.client_id", "https:
        ...
        .setting("xpack.security.authc.realms.oidc.c2id-implicit.rp.redirect_uri", "https:
        ...
        .setting("xpack.security.authc.realms.oidc.c2id-proxy.rp.redirect_uri", "https:
        .setting("xpack.security.authc.realms.oidc.c2id-proxy.rp.client_id", "https:
        ...
        .setting("xpack.security.authc.realms.oidc.c2id-post.rp.redirect_uri", "https:
        ...
        .setting("xpack.security.authc.realms.oidc.c2id-jwt.rp.redirect_uri", "https:
