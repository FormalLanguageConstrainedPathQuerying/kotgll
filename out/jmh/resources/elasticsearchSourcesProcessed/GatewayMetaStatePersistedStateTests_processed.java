...
public class GatewayMetaStatePersistedStateTests extends ESTestCase {
    ...
    @TestIssueLogging(value = "org.elasticsearch.gateway:TRACE", issueUrl = "https:
    ...
    public void testStatePersistenceWithFatalError() throws IOException {
        ...
        PathUtilsForTesting.installMock(new FilterFileSystemProvider("throwerror:
            @Override
