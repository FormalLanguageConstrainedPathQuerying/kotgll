...
public abstract class RestSqlTestCase extends BaseRestSqlTestCase implements ErrorsTestCase {
    ...
    @AwaitsFix(bugUrl = "Unclear status, https:
    ...
    public void testBasicAsyncWait() throws IOException {
        RequestObjectBuilder builder = query("SELECT 1").waitForCompletionTimeout("1d") 
    ...
    /**
     * Special case of `testFetchAllPagesSearchHitCursorTxt` covering https:
     */
