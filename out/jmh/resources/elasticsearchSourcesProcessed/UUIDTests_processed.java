...
public class UUIDTests extends ESTestCase {
    ...
    public void testCompression() throws Exception {
        ...
        assertThat(testCompression(100000, 10000, 3, logger), Matchers.lessThan(14d)); 
        assertThat(testCompression(100000, 1000, 3, logger), Matchers.lessThan(15d)); 
        assertThat(testCompression(100000, 100, 3, logger), Matchers.lessThan(21d)); 
    }
