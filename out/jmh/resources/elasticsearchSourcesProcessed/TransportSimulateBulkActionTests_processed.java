...
public class TransportSimulateBulkActionTests extends ESTestCase {
    ...
    public void testIndexData() {
        ...
        Map<String, Boolean> indicesToAutoCreate = Map.of(); 
        Set<String> dataStreamsToRollover = Set.of(); 
        Map<String, IndexNotFoundException> indicesThatCannotBeCreated = Map.of(); 
        long startTime = 0;
