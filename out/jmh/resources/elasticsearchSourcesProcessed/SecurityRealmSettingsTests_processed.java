    ...
    protected Settings nodeSettings(int nodeOrdinal, Settings otherSettings) {
        ...
        try {
            ...
            Settings.Builder builder = Settings.builder()
                ...
                .put("xpack.security.authc.realms.ldap.ldap1.url", "ldap:
                ...
                .put("xpack.security.authc.realms.active_directory.ad1.url", "ldap:
                ...
                .put("xpack.security.authc.realms.saml.saml1.sp.acs", "http:
                ...
                .put("xpack.security.authc.realms.oidc.oidc1.op.issuer", "https:
                .put("xpack.security.authc.realms.oidc.oidc1.op.jwkset_path", jwkSet.toAbsolutePath())
                .put("xpack.security.authc.realms.oidc.oidc1.op.authorization_endpoint", "https:
                .put("xpack.security.authc.realms.oidc.oidc1.op.token_endpoint", "https:
                .put("xpack.security.authc.realms.oidc.oidc1.rp.redirect_uri", "https:
