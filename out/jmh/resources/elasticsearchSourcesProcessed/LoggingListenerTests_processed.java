...
public class LoggingListenerTests extends ESTestCase {
     ...
     */
    @TestIssueLogging(value = "abc:WARN,foo:WARN,foo.bar:ERROR", issueUrl = "https:
    ...
    @TestIssueLogging(value = "foo.bar:ERROR", issueUrl = "https:
    ...
    public static class TestIssueClass {
        ...
        @SuppressWarnings("unused")
        @TestIssueLogging(value = "xyz:TRACE,foo:WARN,foo.bar:ERROR", issueUrl = "https:
        public void annotatedTestMethod() {

        }

        @SuppressWarnings("unused")
        @TestIssueLogging(value = "abc:TRACE,xyz:DEBUG", issueUrl = "https:
        public void annotatedTestMethod2() {
    ...
    public static class TestMixedClass {
        ...
        @TestIssueLogging(value = "xyz:DEBUG", issueUrl = "https:
        public void annotatedTestMethod2() {
     ...
     */
    @TestIssueLogging(value = "abc", issueUrl = "https:
    ...
    public static class InvalidTestIssueLoggingMethod {
        ...
        @SuppressWarnings("unused")
        @TestIssueLogging(value = "abc:INFO:WARN", issueUrl = "https:
        public void invalidMethod() {
    ...
    @TestIssueLogging(value = "abc:DEBUG", issueUrl = "https:
