...
public class TransformDeprecations {
    ...
    public static final String UPGRADE_TRANSFORM_URL = "https:

    public static final String QUERY_BREAKING_CHANGES_URL = "https:

    public static final String AGGS_BREAKING_CHANGES_URL = "https:
    ...
    public static final String MAX_PAGE_SEARCH_SIZE_BREAKING_CHANGES_URL = "https:
