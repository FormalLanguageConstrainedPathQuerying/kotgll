...
public class BasicExpressionTests extends ScriptTestCase {
    ...
    public void testNullSafeDeref() {
        ...
        assertNull(exec("Map a = null;        return a?.other"));       
        assertEquals(1, exec("Map a = ['other':1]; return a?.other"));       
        assertNull(exec("def a = null;        return a?.other"));       
        assertEquals(1, exec("def a = ['other':1]; return a?.other"));       
