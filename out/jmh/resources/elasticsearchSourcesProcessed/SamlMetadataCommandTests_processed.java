...
public class SamlMetadataCommandTests extends SamlTestCase {
    ...
    public void testDefaultOptions() throws Exception {
        ...
        final Settings.Builder settingsBuilder = Settings.builder()
            ...
            .put(RealmSettings.PREFIX + "saml.my_saml.idp.entity_id", "https:
            .put(RealmSettings.PREFIX + "saml.my_saml.sp.entity_id", "https:
            .put(RealmSettings.PREFIX + "saml.my_saml.sp.acs", "https:
            .put(RealmSettings.PREFIX + "saml.my_saml.sp.logout", "https:
        ...
        assertThat(descriptor.getEntityID(), equalTo("https:
        ...
        assertThat(spDescriptor.getAssertionConsumerServices().get(0).getLocation(), equalTo("https:
        ...
        assertThat(spDescriptor.getSingleLogoutServices().get(0).getLocation(), equalTo("https:
    ...
    public void testFailIfMultipleRealmsExist() throws Exception {
        ...
        final Settings settings = Settings.builder()
            ...
            .put(RealmSettings.PREFIX + "saml.saml_a.sp.entity_id", "https:
            .put(RealmSettings.PREFIX + "saml.saml_a.sp.acs", "https:
            .put(RealmSettings.PREFIX + "saml.saml_b.type", "saml")
            .put(RealmSettings.PREFIX + "saml.saml_b.sp.entity_id", "https:
            .put(RealmSettings.PREFIX + "saml.saml_b.sp.acs", "https:
            .build();
        final Environment env = TestEnvironment.newEnvironment(settings);
    ...
    public void testHandleAttributes() throws Exception {
        ...
        final Settings settings = Settings.builder()
            ...
            .put(RealmSettings.PREFIX + "saml.saml1.sp.entity_id", "https:
            .put(RealmSettings.PREFIX + "saml.saml1.sp.acs", "https:
