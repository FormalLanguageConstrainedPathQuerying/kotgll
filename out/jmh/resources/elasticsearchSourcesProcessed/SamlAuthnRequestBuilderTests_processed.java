...
public class SamlAuthnRequestBuilderTests extends SamlTestCase {
    ...
    private static final String SP_ENTITY_ID = "https:
    private static final String IDP_ENTITY_ID = "https:

    private static final String ACS_URL = "https:
    private static final String IDP_URL = "https:
    ...
    public void testBuildRequestWithRequestedAuthnContexts() throws Exception {
        List<String> reqAuthnCtxClassRef = Arrays.asList(KERBEROS_AUTHN_CTX, SMARTCARD_AUTHN_CTX, "http:
