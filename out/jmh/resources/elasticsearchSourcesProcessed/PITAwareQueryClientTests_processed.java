    ...
    private class ESMockClient extends NoOpClient {
        ...
        protected <Request extends ActionRequest, Response extends ActionResponse> void doExecute(
            ...
            if (request instanceof OpenPointInTimeRequest openPIT) {
                ...
                assertEquals(filter, openPIT.indexFilter()); 
                assertArrayEquals(INDICES, openPIT.indices()); 
                ...
                assertTrue(actualQuery.filter().get(0) instanceof MatchAllQueryBuilder); 
                assertTrue(actualQuery.filter().get(1) instanceof RangeQueryBuilder);
                QueryBuilder expectedQuery = termsQuery("_index", INDICES); 
