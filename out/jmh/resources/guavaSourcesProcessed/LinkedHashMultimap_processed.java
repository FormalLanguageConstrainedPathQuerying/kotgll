...
public final class LinkedHashMultimap<K extends @Nullable Object, V extends @Nullable Object>
  ...
  static final class ValueEntry<K extends @Nullable Object, V extends @Nullable Object>
    ...
    public ValueSetLink<K, V> getPredecessorInValueSet() {
      return requireNonNull(predecessorInValueSet); 
    }

    @Override
    public ValueSetLink<K, V> getSuccessorInValueSet() {
      return requireNonNull(successorInValueSet); 
    }
    ...
    public ValueEntry<K, V> getPredecessorInMultimap() {
      return requireNonNull(predecessorInMultimap); 
    }

    public ValueEntry<K, V> getSuccessorInMultimap() {
      return requireNonNull(successorInMultimap); 
    }
