 ...
 * <p>
 * <img width="640" height="370" src="https:
 * <p>
...
public abstract class Maybe<@NonNull T> implements MaybeSource<T> {
     ...
     * <p>
     * <img width="640" height="518" src="https:
     * <dl>
     * <dt><b>Scheduler:</b></dt>
     ...
     * the rest).
     * <p>
     * <img width="640" height="519" src="https:
     * <dl>
     * <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="526" src="https:
     * <dl>
     ...
     * <p>
     * <img width="640" height="423" src="https:
     * <dl>
     *  <dt><b>Backpressure:</b></dt>
     *  <dd>The returned {@code Flowable} honors the backpressure of the downstream consumer.</dd>
     * <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="416" src="https:
     * <dl>
     *  <dt><b>Backpressure:</b></dt>
     ...
     * <p>
     * <img width="640" height="425" src="https:
     * <dl>
     *  <dt><b>Backpressure:</b></dt>
     ...
     * <p>
     * <img width="640" height="490" src="https:
     * <dl>
     *  <dt><b>Backpressure:</b></dt>
     *  <dd>The operator honors backpressure from downstream.</dd>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * in order, each one after the previous one completes.
     * <p>
     * <img width="640" height="428" src="https:
     * <dl>
     *  <dt><b>Backpressure:</b></dt>
     *  <dd>The operator honors backpressure from downstream.</dd>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * as a {@link Flowable} sequence.
     * <p>
     * <img width="640" height="451" src="https:
     * <dl>
     *  <dt><b>Backpressure:</b></dt>
     *  <dd>The operator honors backpressure from downstream.</dd>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * as a {@link Flowable} sequence.
     * <p>
     * <img width="640" height="360" src="https:
     * <dl>
     *  <dt><b>Backpressure:</b></dt>
     ...
     * as a {@link Flowable} sequence.
     * <p>
     * <img width="640" height="299" src="https:
     * <dl>
     *  <dt><b>Backpressure:</b></dt>
     *  <dd>{@code concatDelayError} fully supports backpressure.</dd>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="439" src="https:
     * <p>
     * Eager concatenation means that once an observer subscribes, this operator subscribes to all of the
     * source {@code MaybeSource}s. The operator buffers the values emitted by these {@code MaybeSource}s and then drains them
     * in order, each one after the previous one completes.
     ...
     * <p>
     * <img width="640" height="511" src="https:
     * <dl>
     *  <dt><b>Backpressure:</b></dt>
     ...
     * <p>
     * <img width="640" height="379" src="https:
     * <p>
     * Eager concatenation means that once an observer subscribes, this operator subscribes to all of the
     * source {@code MaybeSource}s. The operator buffers the values emitted by these {@code MaybeSource}s and then drains them
     * in order, each one after the previous one completes.
     ...
     * <p>
     * <img width="640" height="495" src="https:
     * <p>
     * Eager concatenation means that once a subscriber subscribes, this operator subscribes to all of the
     * emitted source {@code MaybeSource}s as they are observed. The operator buffers the values emitted by these
     * {@code MaybeSource}s and then drains them in order, each one after the previous one completes.
     ...
     * <p>
     * <img width="640" height="421" src="https:
     * <p>
     * Eager concatenation means that once a subscriber subscribes, this operator subscribes to all of the
     * emitted source {@code MaybeSource}s as they are observed. The operator buffers the values emitted by these
     * {@code MaybeSource}s and then drains them in order, each one after the previous one completes.
     ...
     * <p>
     * <img width="640" height="499" src="https:
     * <p>
     * Example:
     * <pre><code>
     ...
     * be subscribed to.
     * <p>
     * <img width="640" height="498" src="https:
     * <dl>
     * <dt><b>Scheduler:</b></dt>
     ...
     * immediately.
     * <p>
     * <img width="640" height="190" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="447" src="https:
     * <dl>
     * <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="440" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     *  <dd>{@code error} does not operate by default on a particular {@link Scheduler}.</dd>
     * </dl>
     ...
     * <p>
     * <img width="640" height="287" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="280" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="344" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * via {@code onComplete}.
     * <p>
     * <img width="640" height="183" src="https:
     * <p>
     ...
     * <p>
     * <img width="640" height="204" src="https:
     * <p>
     ...
     * <p>
     * <img width="640" height="176" src="https:
     * <p>
     ...
     * <p>
     * <img width="640" height="276" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * or completes if the source is empty.
     * <p>
     * <img width="640" height="309" src="https:
     * <dl>
     *  <dt><b>Backpressure:</b></dt>
     ...
     * <p>
     * <img width="640" height="311" src="https:
     * <p>
     * Note that the {@code null} handling of this operator differs from the similar source operators in the other
     * {@link io.reactivex.rxjava3.core base reactive classes}. Those operators signal a {@link NullPointerException} if the value returned by their
     ...
     * <p>
     * <img width="640" height="485" src="https:
     * <p>
     ...
     * <p>
     * <img width="640" height="301" src="https:
     * <dl>
     *  <dt><b>Backpressure:</b></dt>
     *  <dd>The operator honors backpressure from downstream.</dd>
     * <dt><b>Scheduler:</b></dt>
     ...
     * running all {@code MaybeSource}s at once.
     * <p>
     * <img width="640" height="325" src="https:
     * <dl>
     *  <dt><b>Backpressure:</b></dt>
     *  <dd>The operator honors backpressure from downstream.</dd>
     * <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="260" src="https:
     * <dl>
     *  <dt><b>Backpressure:</b></dt>
     *  <dd>The operator honors backpressure from downstream.</dd>
     * <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="394" src="https:
     * <dl>
     * <dt><b>Scheduler:</b></dt>
     * <dd>{@code merge} does not operate by default on a particular {@link Scheduler}.</dd>
     * <dt><b>Error handling:</b></dt>
     ...
     * <p>
     * <img width="640" height="279" src="https:
     * <p>
     ...
     * <p>
     * <img width="640" height="289" src="https:
     * <p>
     * You can combine items emitted by multiple {@code MaybeSource}s so that they appear as a single {@code Flowable}, by using
     * the {@code merge} method.
     * <dl>
     ...
     * running all {@code MaybeSource}s at once.
     * <p>
     * <img width="640" height="272" src="https:
     * <dl>
     *  <dt><b>Backpressure:</b></dt>
     *  <dd>The operator honors backpressure from downstream.</dd>
     * <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="422" src="https:
     * <p>
     ...
     * notification from one of them.
     * <p>
     * <img width="640" height="467" src="https:
     * <p>
     * This behaves like {@link #merge(Publisher)} except that if any of the merged {@code MaybeSource}s notify of an
     ...
     * <p>
     * <img width="640" height="456" src="https:
     * <p>
     * This behaves like {@link #merge(Publisher)} except that if any of the merged {@code MaybeSource}s notify of an
     * error via {@link Subscriber#onError onError}, {@code mergeDelayError} will refrain from propagating that
     ...
     * <p>
     * <img width="640" height="429" src="https:
     * <p>
     ...
     * notification from one of them.
     * <p>
     * <img width="640" height="414" src="https:
     * <p>
     ...
     * notification from one of them.
     * <p>
     * <img width="640" height="461" src="https:
     * <p>
     ...
     * <p>
     * <img width="640" height="185" src="https:
     * <p>
     ...
     * <p>
     * <img width="640" height="187" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * equality function.
     * <p>
     * <img width="640" height="247" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     *  <dd>{@code sequenceEqual} does not operate by default on a particular {@link Scheduler}.</dd>
     * </dl>
     ...
     * <p>
     * <img width="640" height="521" src="https:
     * <dl>
     *  <dt><b>Backpressure:</b></dt>
     ...
     * <p>
     * <img width="640" height="391" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="392" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="262" src="https:
     * <dl>
     * <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="378" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="323" src="https:
     * <p>
     ...
     * instance.
     * <p>
     * <img width="640" height="232" src="https:
     * <dl>
     * <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="341" src="https:
     * <p>
     ...
     * <p>
     * <img width="640" height="434" src="https:
     * <p>
     * This operator terminates eagerly if any of the source {@code MaybeSource}s signal an {@code onError} or {@code onComplete}. This
     * also means it is possible some sources may not get subscribed to at all.
     * <dl>
     ...
     *
     * <p>
     * <img width="640" height="340" src="https:
     ...
     * <p>
     * <img width="640" height="310" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="285" src="https:
     * <dl>
     * <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="297" src="https:
     * <dl>
     * <dt><b>Scheduler:</b></dt>
     * <dd>{@code blockingGet} does not operate by default on a particular {@link Scheduler}.</dd>
     * <dt><b>Error handling:</b></dt>
     ...
     * <p>
     * <img width="640" height="238" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="245" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     *  <dd>{@code blockingSubscribe} does not operate by default on a particular {@link Scheduler}.</dd>
     *  <dt><b>Error handling:</b></dt>
     ...
     * when it terminates.
     * <p>
     * <img width="640" height="256" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     *  <dd>{@code blockingSubscribe} does not operate by default on a particular {@link Scheduler}.</dd>
     *  <dt><b>Error handling:</b></dt>
     ...
     * when it terminates.
     * <p>
     * <img width="640" height="251" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     *  <dd>{@code blockingSubscribe} does not operate by default on a particular {@link Scheduler}.</dd>
     *  <dt><b>Error handling:</b></dt>
     ...
     * <p>
     * <img width="640" height="398" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     *  <dd>{@code blockingSubscribe} does not operate by default on a particular {@link Scheduler}.</dd>
     *  <dt><b>Error handling:</b></dt>
     ...
     * <p>
     * <img width="640" height="244" src="https:
     * <p>
     ...
     * <p>
     * <img width="640" height="318" src="https:
     * <dl>
     * <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="615" src="https:
     * <p>
     ...
     * <p>
     * <img width="640" height="216" src="https:
     * <p>
     ...
     * <p>
     * <img width="640" height="304" src="https:
     * <p>
     ...
     * <p>
     * <img width="640" height="315" src="https:
     * <p>
     ...
     * <p>
     * <img width="640" height="172" src="https:
     * <dl>
     *  <dt><b>Backpressure:</b></dt>
     *  <dd>The operator honors backpressure from downstream.</dd>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="390" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="268" src="https:
     * <p>
     ...
     * <p>
     * <img width="640" height="352" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     *  <dd>you specify which {@code Scheduler} this operator will use.</dd>
     * </dl>
     ...
     * <p>
     * <img width="640" height="175" src="https:
     * <dl>
     *  <dt><b>Backpressure:</b></dt>
     ...
     * <p>
     * <img width="640" height="214" src="https:
     * <dl>
     *  <dt><b>Backpressure:</b></dt>
     ...
     * <p>
     * <img width="640" height="471" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="420" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     *  <dd>You specify which {@code Scheduler} this operator will use.</dd>
     * </dl>
     ...
     * <p>
     * <img width="640" height="527" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="249" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="277" src="https:
     * <dl>
     * <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="358" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * {@link MaybeObserver} that subscribes to the current {@code Maybe}.
     * <p>
     * <img width="640" height="506" src="https:
     * <dl>
     * <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="291" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * where that function returns a {@link MaybeSource}.
     * <p>
     * <img width="640" height="357" src="https:
     * <dl>
     * <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="354" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     *  <dd>{@code flatMap} does not operate by default on a particular {@link Scheduler}.</dd>
     * </dl>
     ...
     * <p>
     * <img width="640" height="373" src="https:
     * <dl>
     *  <dt><b>Backpressure:</b></dt>
     *  <dd>The operator honors backpressure from downstream.</dd>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="302" src="https:
     * <dl>
     * <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="312" src="https:
     * <dl>
     *  <dt><b>Backpressure:</b></dt>
     ...
     * current {@code Maybe}, where that function returns a {@code Completable}.
     * <p>
     * <img width="640" height="303" src="https:
     * <dl>
     * <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="300" src="https:
     ...
     * <p>
     * <img width="640" height="444" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="515" src="https:
     * <dl>
     * <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="218" src="https:
     * <p>
     ...
     * <p>
     * <img width="640" height="731" src="https:
     * <p>
     ...
     * through.
     * <p>
     * <img width="640" height="346" src="https:
     * <dl>
     *  <dt><b>Backpressure:</b></dt>
     ...
     * <p>
     * <img width="640" height="292" src="https:
     * <p>
     ...
     * <p>
     * <img width="640" height="361" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="372" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="220" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     *  <dd>{@code onErrorComplete} does not operate by default on a particular {@link Scheduler}.</dd>
     * </dl>
     ...
     * <p>
     * <img width="640" height="298" src="https:
     * <p>
     ...
     * <p>
     * <img width="640" height="377" src="https:
     * <p>
     * You can use this to prevent errors from propagating or to supply fallback data should errors be
     * encountered.
     * <dl>
     ...
     * <p>
     * <img width="640" height="263" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * {@code count} times.
     * <p>
     * <img width="640" height="294" src="https:
     * <dl>
     *  <dt><b>Backpressure:</b></dt>
     ...
     * <p>
     * <img width="640" height="329" src="https:
     * <dl>
     *  <dt><b>Backpressure:</b></dt>
     *  <dd>This operator honors downstream backpressure.</dd>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="562" src="https:
     * <dl>
     *  <dt><b>Backpressure:</b></dt>
     ...
     * <p>
     * <img width="640" height="393" src="https:
     * <p>
     ...
     * <p>
     * <img width="640" height="230" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     *  <dd>{@code retry} does not operate by default on a particular {@link Scheduler}.</dd>
     * </dl>
     ...
     * <p>
     * <img width="640" height="259" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     *  <dd>{@code retry} does not operate by default on a particular {@link Scheduler}.</dd>
     * </dl>
     ...
     * <p>
     * <img width="640" height="240" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     *  <dd>{@code retry} does not operate by default on a particular {@link Scheduler}.</dd>
     * </dl>
     ...
     * resubscribe to the current {@code Maybe}.
     * <p>
     * <img width="640" height="405" src="https:
     * <p>
     * Example:
     *
     ...
     * <p>
     * <img width="640" height="237" src="https:
     * <dl>
     *  <dt><b>Backpressure:</b></dt>
     *  <dd>The returned {@code Flowable} honors the backpressure of the downstream consumer.</dd>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="178" src="https:
     * <dl>
     *  <dt><b>Backpressure:</b></dt>
     *  <dd>The returned {@code Flowable} honors the backpressure of the downstream consumer.</dd>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="179" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     *  <dd>{@code startWith} does not operate by default on a particular {@link Scheduler}.</dd>
     * </dl>
    ...
    public final void subscribe(@NonNull MaybeObserver<? super T> observer) {
        ...
        Objects.requireNonNull(observer, "The RxJavaPlugins.onSubscribe hook returned a null MaybeObserver. Please check the handler provided to RxJavaPlugins.setOnMaybeSubscribe for invalid null returns. Further reading: https:
     ...
     * <p>
     * <img width="640" height="753" src="https:
     * <dl>
     * <dt><b>Scheduler:</b></dt>
     * <dd>you specify which {@code Scheduler} this operator will use.</dd>
     * </dl>
     ...
     * <p>
     * <img width="640" height="222" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * emits an item.
     * <p>
     * <img width="640" height="219" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * emits an item.
     * <p>
     * <img width="640" height="199" src="https:
     * <dl>
     *  <dt><b>Backpressure:</b></dt>
     ...
     * success value.
     * <p>
     * <img width="640" height="355" src="https:
     * <p>
     * If the current {@code Maybe} is empty or fails, the resulting {@code Maybe} will
     * pass along the signals to the downstream. To measure the time to termination,
     ...
     * <p>
     * <img width="640" height="261" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="226" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     *  <dd>This version of {@code timeout} operates by default on the {@code computation} {@link Scheduler}.</dd>
     * </dl>
     ...
     * <p>
     * <img width="640" height="227" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     *  <dd>You specify which {@code Scheduler} this operator will use.</dd>
     * </dl>
     ...
     * <p>
     * <img width="640" height="235" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * as a continuation.
     * <p>
     * <img width="640" height="194" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     *  <dd>{@code timeout} does not operate by default on a particular {@link Scheduler}.</dd>
     * </dl>
     ...
     * {@link TimeoutException} is signaled instead.
     * <p>
     * <img width="640" height="212" src="https:
     * <dl>
     *  <dt><b>Backpressure:</b></dt>
     ...
     * as a continuation.
     * <p>
     * <img width="640" height="169" src="https:
     * <dl>
     *  <dt><b>Backpressure:</b></dt>
     *  <dd>The {@code timeoutIndicator} {@code Publisher} is consumed in an unbounded manner and
     *  is cancelled after its first item.</dd>
     ...
     * <p>
     * <img width="640" height="693" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="335" src="https:
     * <p>
     ...
     * <p>
     * <img width="640" height="349" src="https:
     * <p>
     ...
     * <p>
     * <img width="640" height="246" src="https:
     * <p>
     ...
     * <img width="640" height="241" src="https:
     * <p>
     * The operator closes the {@code Stream} upon cancellation and when it terminates. The exceptions raised when
     * closing a {@code Stream} are routed to the global error handler ({@link RxJavaPlugins#onError(Throwable)}.
