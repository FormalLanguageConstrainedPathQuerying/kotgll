 ...
 * <p>
 * <img width="640" height="317" src="https:
 * <p>
...
public abstract class Observable<@NonNull T> implements ObservableSource<T> {
     ...
     * <p>
     * <img width="640" height="505" src="https:
     * <p>
     ...
     * <p>
     * <img width="640" height="290" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="411" src="https:
     * <p>
     ...
     * and delaying any errors until all sources terminate.
     * <p>
     * <img width="640" height="460" src="https:
     * <p>
     * Eager concatenation means that once a subscriber subscribes, this operator subscribes to all of the
     * {@code ObservableSource}s. The operator buffers the values emitted by these {@code ObservableSource}s
     * and then drains them in order, each one after the previous one completes.
     ...
     * <p>
     * <img width="640" height="200" src="https:
     * <p>
     ...
     * <p>
     * <img width="640" height="221" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="278" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="284" src="https:
     * <p>
     ...
     * <p>
     * <img width="640" height="286" src="https:
     * <p>
     ...
     * <p>
     * <img width="640" height="195" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     *  <dd>{@code interval} operates by default on the {@code computation} {@link Scheduler}.</dd>
     * </dl>
     ...
     * <p>
     * <img width="640" height="186" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     *  <dd>{@code just} does not operate by default on a particular {@link Scheduler}.</dd>
     * </dl>
     ...
     * <p>
     * <img width="640" height="400" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="265" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * notification.
     * <p>
     * <img width="640" height="448" src="https:
     * <p>
     ...
     * <p>
     * <img width="640" height="320" src="https:
     * <p>
     ...
     * <p>
     * <img width="640" height="413" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * upstream terminates.
     * <p>
     * <img width="640" height="330" src="https:
     * <p>
     ...
     * returns that item.
     * <p>
     * <img width="640" height="427" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * Subscribes to the source and calls the given callbacks <strong>on the current thread</strong>.
     * <p>
     * <img width="640" height="397" src="https:
     * <p>
     * Note that calling this method will block the caller thread until the upstream terminates
     * normally or with an error. Therefore, calling this method from special threads such as the
     * Android Main Thread or the Swing Event Dispatch Thread is not recommended.
     ...
     * <p>
     * <img width="640" height="470" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     *  <dd>This version of {@code buffer} does not operate by default on a particular {@link Scheduler}.</dd>
     * </dl>
     ...
     * <p>
     * <img width="640" height="395" src="https:
     * <p>
     ...
     * <p>
     * <img width="640" height="410" src="https:
     * <p>
     ...
     * <p>
     * <img width="640" height="275" src="https:
     *
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="450" src="https:
     * <p>
     ...
     * {@code onError}.
     * <p>
     * <img width="640" height="327" src="https:
     * <p>
     ...
     * <p>
     * <img width="640" height="435" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="424" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="273" src="https:
     * <p>
     * If the {@code Observable} emits an error, it is wrapped into an
     * {@link OnErrorNotImplementedException}
     * and routed to the {@link RxJavaPlugins#onError(Throwable)} handler.
     ...
     * signals a {@link NoSuchElementException} if the current {@code Observable} is empty.
     * <p>
     * <img width="640" height="236" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="308" src="https:
     * <p>
     ...
     * <p>
     * <img width="640" height="510" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="647" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     *  <dd>{@code publish} does not operate by default on a particular {@link Scheduler}.</dd>
     * </dl>
     ...
     * {@code count} times.
     * <p>
     * <img width="640" height="336" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     *  <dd>{@code repeat} does not operate by default on a particular {@link Scheduler}.</dd>
     * </dl>
     ...
     * <p>
     * <img width="640" height="430" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="445" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * replaying all items that were emitted within a specified time window.
     * <p>
     * <img width="640" height="367" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     *  <dd>You specify which {@link Scheduler} this operator will use.</dd>
     * </dl>
     ...
     * <p>
     * <img width="640" height="217" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="206" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * an item.
     * <p>
     * <img width="640" height="375" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="248" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     *  <dd>{@code startWith} does not operate by default on a particular {@link Scheduler}.</dd>
     * </dl>
     ...
     * <p>
     * <img width="640" height="168" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     *  <dd>{@code startWith} does not operate by default on a particular {@link Scheduler}.</dd>
     * </dl>
     ...
     * <p>
     * <img width="640" height="522" src="https:
     * <p>
     ...
     * of them terminate.
     * <p>
     * <img width="640" height="453" src="https:
     * <p>
     * Since a {@code CompletableSource} doesn't produce any items, the resulting reactive type of
     * this operator is a {@link Completable} that can only indicate successful completion or
     * a failure in any of the inner {@code CompletableSource}s or the failure of the current
     ...
     * <p>
     * <img width="640" height="531" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="532" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="213" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="326" src="https:
     * <p>
     ...
     * <p>
     * <img width="640" height="365" src="https:
     * <p>
     * Normally, an {@link ObservableSource} that returns multiple items will do so by invoking its {@link Observer}'s
     * {@link Observer#onNext onNext} method for each such item. You can change this behavior by having the
     ...
     * <p>
     * <img width="640" height="274" src="https:
     * </li>
     * <li>{@link BackpressureStrategy#DROP}
     * <p>
     * <img width="640" height="389" src="https:
     * </li>
     ...
     * <p>
     * <img width="640" height="475" src="https:
     * <p>
     * Note that ignoring windows or subscribing later (i.e., on another thread) will result in
     * so-called window abandonment where a window may not contain any elements. In this case, subsequent
     * elements will be dropped until the condition for the next window boundary is satisfied. The behavior is
     ...
     * <p>
     * <img width="640" height="550" src="https:
     * <p>
     * Note that ignoring windows or subscribing later (i.e., on another thread) will result in
     * so-called window abandonment where a window may not contain any elements. In this case, subsequent
     * elements will be dropped until the condition for the next window boundary is satisfied. The behavior is
     ...
     * <p>
     * <img width="640" height="407" src="https:
     * <p>
     ...
     * <p>
     * <img width="640" height="306" src="https:
     *
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
