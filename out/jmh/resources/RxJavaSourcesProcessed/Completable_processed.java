 ...
 * <p>
 * <img width="640" height="577" src="https:
 * <p>
...
public abstract class Completable implements CompletableSource {
     ...
     * Returns a {@code Completable} which completes only when all sources complete, one after another.
     * <p>
     * <img width="640" height="324" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * Returns a {@code Completable} which completes only when all sources complete, one after another.
     * <p>
     * <img width="640" height="396" src="https:
     * <dl>
     *  <dt><b>Backpressure:</b></dt>
     *  <dd>The returned {@code Completable} honors the backpressure of the downstream consumer
     *  and expects the other {@link Publisher} to honor it as well.</dd>
     ...
     * Returns a {@code Completable} which completes only when all sources complete, one after another.
     * <p>
     * <img width="640" height="359" src="https:
     * <dl>
     *  <dt><b>Backpressure:</b></dt>
     *  <dd>The returned {@code Completable} honors the backpressure of the downstream consumer
     *  and expects the other {@link Publisher} to honor it as well.</dd>
     ...
     * <p>
     * <img width="640" height="628" src="https:
     * <p>
     ...
     * completes only when all source {@link CompletableSource}s complete or one of them emits an error.
     * <p>
     * <img width="640" height="269" src="https:
     * <dl>
     *  <dt><b>Backpressure:</b></dt>
     ...
     * them terminate in a way or another.
     * <p>
     * <img width="640" height="476" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="512" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="415" src="https:
     * <dl>
     *  <dt><b>Backpressure:</b></dt>
     *  <dd>The {@code sources} {@code Publisher} is consumed in an unbounded manner (requesting {@link Long#MAX_VALUE}).</dd>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * {@code SingleSource}.
     * <p>
     * <img width="640" height="437" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     *  <dd>{@code andThen} does not operate by default on a particular {@link Scheduler}.</dd>
     * </dl>
     ...
     * {@code MaybeSource}.
     * <p>
     * <img width="640" height="281" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     *  <dd>{@code andThen} does not operate by default on a particular {@link Scheduler}.</dd>
     * </dl>
     ...
     * <p>
     * <img width="640" height="433" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="468" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     *  <dd>{@code blockingSubscribe} does not operate by default on a particular {@link Scheduler}.</dd>
     *  <dt><b>Error handling:</b></dt>
     ...
     * <p>
     * <img width="640" height="625" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * running on the specified {@link Scheduler}.
     * <p>
     * <img width="640" height="253" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     *  <dd>{@code delay} operates on the {@code Scheduler} you specify.</dd>
     * </dl>
     ...
     * <p>
     * <img width="640" height="589" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * the downstream.
     * <p>
     * <img width="640" height="331" src="https:
     * <p>
     ...
     * <p>
     * <img width="640" height="523" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="585" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="409" src="https:
     * <p>
     ...
     * <p>
     * <img width="640" height="567" src="https:
     * <p>
     * You can use this to prevent errors from propagating or to supply fallback data should errors be
     * encountered.
     * <dl>
     ...
     * <p>
     * <img width="640" height="381" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="586" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="368" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="388" src="https:
     * <dl>
     *  <dt><b>Backpressure:</b></dt>
     ...
     * <p>
     * <img width="640" height="266" src="https:
     * <dl>
     *  <dt><b>Backpressure:</b></dt>
     *  <dd>The returned {@code Flowable} honors the backpressure of the downstream consumer.</dd>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="250" src="https:
     * <dl>
     *  <dt><b>Backpressure:</b></dt>
     *  <dd>The returned {@code Flowable} honors the backpressure of the downstream consumer
     *  and expects the other {@code Publisher} to honor it as well.</dd>
     ...
     * <p>
     * <img width="640" height="432" src="https:
     * <p>
    ...
    public final void subscribe(@NonNull CompletableObserver observer) {
        ...
        try {
            ...
            Objects.requireNonNull(observer, "The RxJavaPlugins.onSubscribe hook returned a null CompletableObserver. Please check the handler provided to RxJavaPlugins.setOnCompletableSubscribe for invalid null returns. Further reading: https:
     ...
     * <p>
     * <img width="640" height="686" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="751" src="https:
     * <p>
     ...
     * <p>
     * <img width="640" height="293" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="583" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="716" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
