...
public abstract class Single<@NonNull T> implements SingleSource<T> {
     ...
     * the rest).
     * <p>
     * <img width="640" height="516" src="https:
     * <dl>
     * <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="319" src="https:
     * <dl>
     ...
     * <p>
     * <img width="640" height="366" src="https:
     * <dl>
     *  <dt><b>Backpressure:</b></dt>
     ...
     * <p>
     * <img width="640" height="362" src="https:
     * <dl>
     *  <dt><b>Backpressure:</b></dt>
     *  <dd>The returned {@code Flowable} honors the backpressure of the downstream consumer.</dd>
     * <dt><b>Scheduler:</b></dt>
     ...
     * an array.
     * <p>
     * <img width="640" height="408" src="https:
     * <dl>
     *  <dt><b>Backpressure:</b></dt>
     *  <dd>The returned {@link Flowable} honors the backpressure of the downstream consumer.</dd>
     * <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="257" src="https:
     * <p>
     ...
     * Concatenates a sequence of {@link SingleSource} eagerly into a single stream of values.
     * <p>
     * <img width="640" height="426" src="https:
     * <p>
     * Eager concatenation means that once a subscriber subscribes, this operator subscribes to all of the
     * source {@code SingleSource}s. The operator buffers the value emitted by these {@code SingleSource}s and then drains them
     * in order, each one after the previous one succeeds.
     ...
     * as a {@link Flowable} sequence.
     * <p>
     * <img width="640" height="345" src="https:
     * <dl>
     *  <dt><b>Backpressure:</b></dt>
     ...
     * <p>
     * <img width="640" height="307" src="https:
     * <p>
     * Eager concatenation means that once a subscriber subscribes, this operator subscribes to all of the
     ...
     * <p>
     * <img width="640" height="431" src="https:
     * <p>
     * Eager concatenation means that once a subscriber subscribes, this operator subscribes to all of the
     * source {@code SingleSource}s. The operator buffers the values emitted by these {@code SingleSource}s and then drains them
     * in order, each one after the previous one succeeds.
     ...
     * <p>
     * <img width="640" height="454" src="https:
     * <p>
     * Example:
     * <pre><code>
     ...
     * <p>
     * <img width="640" height="283" src="https:
     * <dl>
     * <dt><b>Scheduler:</b></dt>
     ...
     * forwards the {@code onError} signal.
     * <p>
     * <img width="640" height="353" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     *  <dd>{@code fromMaybe} does not operate by default on a particular {@link Scheduler}.</dd>
     * </dl>
     ...
     * <p>
     * <img width="640" height="322" src="https:
     * <p>
     ...
     * <p>
     * <img width="640" height="343" src="https:
     * <p>
     ...
     * <p>
     * <img width="640" height="412" src="https:
     * <dl>
     * <dt><b>Scheduler:</b></dt>
     * <dd>{@code merge} does not operate by default on a particular {@link Scheduler}.</dd>
     ...
     * <p>
     * <img width="640" height="469" src="https:
     * <dl>
     *  <dt><b>Backpressure:</b></dt>
     *  <dd>The returned {@code Flowable} honors the backpressure of the downstream consumer.</dd>
     * <dt><b>Scheduler:</b></dt>
     ...
     * running all {@code SingleSource}s at once and delaying any error(s) until all sources succeed or fail.
     * <p>
     * <img width="640" height="356" src="https:
     * <dl>
     *  <dt><b>Backpressure:</b></dt>
     *  <dd>The returned {@code Flowable} honors the backpressure of the downstream consumer.</dd>
     * <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="554" src="https:
     * <p>
     ...
     * any error(s) until all sources succeed or fail.
     * <p>
     * <img width="640" height="496" src="https:
     * <p>
     * You can combine items emitted by multiple {@code SingleSource}s so that they appear as one {@code Flowable}, by
     ...
     * any error(s) until all sources succeed or fail.
     * <p>
     * <img width="640" height="509" src="https:
     * <p>
     * You can combine items emitted by multiple {@code SingleSource}s so that they appear as one {@code Flowable}, by
     * the {@code mergeDelayError} method.
     * <dl>
     ...
     * <p>
     * <img width="640" height="465" src="https:
     * <dl>
     * <dt><b>Scheduler:</b></dt>
    ...
    @NonNull
    @SchedulerSupport(SchedulerSupport.NONE)
    public static <@NonNull T> Single<Boolean> sequenceEqual(@NonNull SingleSource<? extends T> source1, @NonNull SingleSource<? extends T> source2) { 
        Objects.requireNonNull(source1, "source1 is null");
        Objects.requireNonNull(source2, "source2 is null");
     ...
     * <p>
     * <img width="640" height="380" src="https:
     * <dl>
     * <dt><b>Scheduler:</b></dt>
     ...
     * instance.
     * <p>
     * <img width="640" height="350" src="https:
     * <dl>
     * <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="463" src="https:
     * <dl>
     * <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="458" src="https:
     * <dl>
     * <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="612" src="https:
     * <p>
     ...
     * <p>
     * <img width="640" height="363" src="https:
     * <p>
     ...
     * <p>
     * <img width="640" height="313" src="https:
     * <p>
     ...
     * <p>
     * <img width="640" height="254" src="https:
     * <p>
     ...
     * <p>
     * <img width="640" height="457" src="https:
     * <dl>
     * <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="472" src="https:
     * <dl>
     * <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="347" src="https:
     * </p>
     * <dl>
     * <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="305" src="https:
     * <p>
     ...
     * <p>
     * <img width="640" height="264" src="https:
     * <dl>
     * <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="332" src="https:
     * </p>
     * <dl>
     * <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="449" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     *  <dd>{@code flatMap} does not operate by default on a particular {@link Scheduler}.</dd>
     * </dl>
     ...
     * where that function returns a {@link MaybeSource}.
     * <p>
     * <img width="640" height="191" src="https:
     * <dl>
     * <dt><b>Scheduler:</b></dt>
     ...
     * current {@code Single}, where that function returns a {@link CompletableSource}.
     * <p>
     * <img width="640" height="267" src="https:
     * <dl>
     * <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="351" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     *  <dd>{@code blockingSubscribe} does not operate by default on a particular {@link Scheduler}.</dd>
     *  <dt><b>Error handling:</b></dt>
     ...
     * when it terminates.
     * <p>
     * <img width="640" height="348" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     *  <dd>{@code blockingSubscribe} does not operate by default on a particular {@link Scheduler}.</dd>
     *  <dt><b>Error handling:</b></dt>
     ...
     * <p>
     * <img width="640" height="479" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     *  <dd>{@code blockingSubscribe} does not operate by default on a particular {@link Scheduler}.</dd>
     *  <dt><b>Error handling:</b></dt>
     ...
     * provided.
     * <p>
     * <img width="640" height="401" src="https:
     * <p>
     * <img width="640" height="401" src="https:
     * <dl>
     * <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="399" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="270" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     *  <dd>{@code onErrorComplete} does not operate by default on a particular {@link Scheduler}.</dd>
     * </dl>
     ...
     * <p>
     * <img width="640" height="1480" src="https:
     * <dl>
     *  <dt><b>Backpressure:</b></dt>
     *  <dd>The returned {@code Flowable} honors the backpressure of the downstream consumer.
     ...
     * <p>
     * <img width="640" height="364" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
    ...
    public final void subscribe(@NonNull SingleObserver<? super T> observer) {
        ...
        Objects.requireNonNull(observer, "The RxJavaPlugins.onSubscribe hook returned a null SingleObserver. Please check the handler provided to RxJavaPlugins.setOnSingleSubscribe for invalid null returns. Further reading: https:
     ...
     * <p>
     * <img width="640" height="338" src="https:
     * <p>Usage example:
     * <pre><code>
     ...
     * success value.
     * <p>
     * <img width="640" height="466" src="https:
     * <p>
     ...
     * <p>
     * <img width="640" height="333" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * {@link SingleObserver#onSuccess(Object)}.
     * <p>
     * <img width="640" height="215" src="https:
     * <dl>
     *  <dt><b>Backpressure:</b></dt>
     *  <dd>The {@code other} publisher is consumed in an unbounded fashion but will be
     *  cancelled after the first item it produced.</dd>
     ...
     * {@link SingleObserver#onSuccess(Object)}.
     * <p>
     * <img width="640" height="314" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     *  <dd>{@code takeUntil} does not operate by default on a particular {@link Scheduler}.</dd>
     * </dl>
     ...
     * <p>
     * <img width="640" height="334" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * disposed and the other {@link SingleSource} subscribed to.
     * <p>
     * <img width="640" height="282" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="553" src="https:
     * <p>
     ...
     * <p>
     * <img width="640" height="436" src="https:
     * <dl>
     * <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="462" src="https:
     * <dl>
     *  <dt><b>Backpressure:</b></dt>
     *  <dd>The returned {@code Flowable} honors the backpressure of the downstream consumer.</dd>
     * <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="442" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * <p>
     * <img width="640" height="482" src="https:
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     *  <dd>{@code test} does not operate by default on a particular {@link Scheduler}.</dd>
     * </dl>
     ...
     * <p>
     * <img width="640" height="321" src="https:
     * <p>
