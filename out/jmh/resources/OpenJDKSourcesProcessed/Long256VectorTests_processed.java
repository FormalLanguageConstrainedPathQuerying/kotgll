...
public class Long256VectorTests extends AbstractVectorTest {
    ...
    static void smokeTest2() {
        ...
        LongVector a = io.add((long)1); 
        LongVector b = a.neg();  
        long[] abValues = bothToArray(a,b); 
        VectorShuffle<Long> zip0 = VectorShuffle.makeZip(SPECIES, 0);
        VectorShuffle<Long> zip1 = VectorShuffle.makeZip(SPECIES, 1);
        LongVector zab0 = a.rearrange(zip0,b); 
        LongVector zab1 = a.rearrange(zip1,b); 
        long[] zabValues = bothToArray(zab0, zab1); 
