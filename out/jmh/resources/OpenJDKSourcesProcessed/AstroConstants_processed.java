...
public class AstroConstants {
    ...
    public static final double RA_MAX = 24.0; 
    public static final double DEC_MIN = -90.000; 
    public static final double DEC_MAX = 90.000; 
    ...
    public static final String JAXP_SCHEMA_LANGUAGE = "http:
    public static final String JAXP_SCHEMA_SOURCE = "http:
}
