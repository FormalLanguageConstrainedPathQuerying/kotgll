 ...
 *
 * System.out.println(fmt.format(Double.NEGATIVE_INFINITY)); 
 * System.out.println(fmt.format(-1.0)); 
 * System.out.println(fmt.format(0)); 
 * System.out.println(fmt.format(0.9)); 
 * System.out.println(fmt.format(1)); 
 * System.out.println(fmt.format(1.5)); 
 * System.out.println(fmt.format(2)); 
 * System.out.println(fmt.format(2.1)); 
 * System.out.println(fmt.format(Double.NaN)); 
 * System.out.println(fmt.format(Double.POSITIVE_INFINITY)); 
 * }
 *
