...
final class Float512Vector extends FloatVector {
    ...
    public final Float512Vector broadcast(float e) {
        return (Float512Vector) super.broadcastTemplate(e);  
    }
    ...
    Float512Vector uOp(FUnOp f) {
        return (Float512Vector) super.uOpTemplate(f);  
    }
    ...
    Float512Vector uOp(VectorMask<Float> m, FUnOp f) {
        return (Float512Vector)
            super.uOpTemplate((Float512Mask)m, f);  
    }
    ...
    Float512Vector bOp(Vector<Float> v, FBinOp f) {
        return (Float512Vector) super.bOpTemplate((Float512Vector)v, f);  
    }
    ...
    public Float512Vector lanewise(Unary op) {
        return (Float512Vector) super.lanewiseTemplate(op);  
    }

    @Override
    @ForceInline
    public Float512Vector lanewise(Unary op, VectorMask<Float> m) {
        return (Float512Vector) super.lanewiseTemplate(op, Float512Mask.class, (Float512Mask) m);  
    }

    @Override
    @ForceInline
    public Float512Vector lanewise(Binary op, Vector<Float> v) {
        return (Float512Vector) super.lanewiseTemplate(op, v);  
    }

    @Override
    @ForceInline
    public Float512Vector lanewise(Binary op, Vector<Float> v, VectorMask<Float> m) {
        return (Float512Vector) super.lanewiseTemplate(op, Float512Mask.class, v, (Float512Mask) m);  
    }
    ...
    lanewise(Ternary op, Vector<Float> v1, Vector<Float> v2) {
        return (Float512Vector) super.lanewiseTemplate(op, v1, v2);  
    }
    ...
    lanewise(Ternary op, Vector<Float> v1, Vector<Float> v2, VectorMask<Float> m) {
        return (Float512Vector) super.lanewiseTemplate(op, Float512Mask.class, v1, v2, (Float512Mask) m);  
    }
    ...
    Float512Vector addIndex(int scale) {
        return (Float512Vector) super.addIndexTemplate(scale);  
    }
    ...
    public final float reduceLanes(VectorOperators.Associative op,
                                    VectorMask<Float> m) {
        return super.reduceLanesTemplate(op, Float512Mask.class, (Float512Mask) m);  
    }
    ...
    public final long reduceLanesToLong(VectorOperators.Associative op,
                                        VectorMask<Float> m) {
        return (long) super.reduceLanesTemplate(op, Float512Mask.class, (Float512Mask) m);  
    }
    ...
    public final Float512Mask test(Test op) {
        return super.testTemplate(Float512Mask.class, op);  
    }

    @Override
    @ForceInline
    public final Float512Mask test(Test op, VectorMask<Float> m) {
        return super.testTemplate(Float512Mask.class, op, (Float512Mask) m);  
    }
    ...
    public final Float512Mask compare(Comparison op, Vector<Float> v) {
        return super.compareTemplate(Float512Mask.class, op, v);  
    }

    @Override
    @ForceInline
    public final Float512Mask compare(Comparison op, float s) {
        return super.compareTemplate(Float512Mask.class, op, s);  
    }
    ...
    public Float512Vector slice(int origin, Vector<Float> v) {
        return (Float512Vector) super.sliceTemplate(origin, v);  
    }

    @Override
    @ForceInline
    public Float512Vector slice(int origin) {
        return (Float512Vector) super.sliceTemplate(origin);  
    }

    @Override
    @ForceInline
    public Float512Vector unslice(int origin, Vector<Float> w, int part) {
        return (Float512Vector) super.unsliceTemplate(origin, w, part);  
    }
    ...
    public Float512Vector unslice(int origin) {
        return (Float512Vector) super.unsliceTemplate(origin);  
    }
    ...
    FloatVector fromArray0(float[] a, int offset, VectorMask<Float> m, int offsetInRange) {
        return super.fromArray0Template(Float512Mask.class, a, offset, (Float512Mask) m, offsetInRange);  
    }
    ...
    FloatVector fromMemorySegment0(MemorySegment ms, long offset, VectorMask<Float> m, int offsetInRange) {
        return super.fromMemorySegment0Template(Float512Mask.class, ms, offset, (Float512Mask) m, offsetInRange);  
    }
