...
final class ConstantHTML {
    ...
    private void writeConstant(final int index) {
        ...
        case Const.CONSTANT_Methodref:
            ...
            shortMethodClass = Utility.compactClassName(shortMethodClass, classPackage + ".", true); 
        ...
        case Const.CONSTANT_Fieldref:
            ...
            shortFieldClass = Utility.compactClassName(shortFieldClass, classPackage + ".", true); 
        ...
        case Const.CONSTANT_Class:
            ...
            shortClassName = Utility.compactClassName(shortClassName, classPackage + ".", true); 
