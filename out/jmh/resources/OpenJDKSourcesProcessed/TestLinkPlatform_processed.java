...
public class TestLinkPlatform extends JavadocTester {
    ...
    final static String OLD_PLATFORM_URL = "https:
    final static String NEW_PLATFORM_URL = "https:
    final static String PRE_PLATFORM_URL = "https:

    final static String NON_MODULAR_CUSTOM_PLATFORM_URL = "https:
    final static String MODULAR_CUSTOM_PLATFORM_URL = "https:
    ...
    private Path writeCustomProperties(Path base) throws IOException {
        ...
        for (int version = EARLIEST_VERSION; version <= LATEST_VERSION; version++) {
            sb.append(String.format("doclet.platform.docs.%1$d= https:
        }
