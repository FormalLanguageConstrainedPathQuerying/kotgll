...
public class DebugeeBinder extends Log.Logger implements Finalizable {
    ...
    public static int TRY_DELAY = 1000;                     

    public static int CONNECT_TIMEOUT = 1 * 60 * 1000;      
    public static int CONNECT_TRY_DELAY = 2 * 1000;         
    public static int CONNECT_TRIES = CONNECT_TIMEOUT / CONNECT_TRY_DELAY;

    public static int THREAD_TIMEOUT = 2 * CONNECT_TRY_DELAY;  
    public static int PING_TIMEOUT = 30 * 1000;  

    public static int SOCKET_TIMEOUT = 2 * 1000;  
    public static int SOCKET_LINGER = 1;   
