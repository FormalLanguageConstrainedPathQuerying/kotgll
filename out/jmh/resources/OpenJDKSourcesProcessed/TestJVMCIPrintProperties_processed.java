...
public class TestJVMCIPrintProperties {
    ...
    static void test(String enableFlag) throws Exception {
        ...
        output.shouldContain("[JVMCI properties]"); 
        output.shouldContain("jvmci.Compiler := \"null\""); 
        output.shouldContain("jvmci.InitTimer = false"); 
        output.shouldContain("jvmci.PrintConfig = false"); 
        output.shouldContain("jvmci.TraceMethodDataFilter = null"); 
