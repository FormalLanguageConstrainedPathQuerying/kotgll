...
public class SAXParserFactTest {
    ...
    private static final String NAMESPACES = "http:
    private static final String NAMESPACE_PREFIXES = "http:
    private static final String STRING_INTERNING = "http:
    private static final String VALIDATION = "http:
    private static final String EXTERNAL_G_ENTITIES = "http:
    private static final String EXTERNAL_P_ENTITIES = "http:
