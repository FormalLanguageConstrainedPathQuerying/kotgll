...
public class isProtected001 extends Log {
    ...
    private final static String classes_for_check[][] = {
        ...
        {package_prefix + "pack_priv_cls", "package private", "reference_type"},  
        {package_prefix + "pack_priv_interf", "package private", "reference_type"},  

        {debugeeName+"$s_interf", "protected", "reference_type"},  
