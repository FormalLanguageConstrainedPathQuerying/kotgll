...
public class MethodHandles {
    ...
    class Lookup {
        ...
        public Lookup dropLookupMode(int modeToDrop) {
            ...
            if (newModes == oldModes) return this;  
...
return mh1;
        ...
        private MethodHandle restrictReceiver(MemberName method, DirectMethodHandle mh, Class<?> caller) throws IllegalAccessException {
            ...
            if (caller.isAssignableFrom(rawType.parameterType(0))) return mh; 
        ...
        private MethodHandle getDirectMethodCommon(byte refKind, Class<?> refc, MemberName method,
            ...
            if (refKind == REF_invokeSpecial &&
                ...
                assert(!method.getName().equals(ConstantDescs.INIT_NAME));  
...
assertEquals("[top, [[up, down, strange], charm], bottom]",
     ...
     * steps as follows:
     * {@snippet lang="java" :
     * mh = MethodHandles.dropArguments(mh, 1, coll.type().parameterList()); 
     * mh = MethodHandles.foldArguments(mh, coll); 
     * }
...
System.out.println((String) cat.invokeExact("x", "y")); 
MethodHandle f0 = filterReturnValue(cat, length);
System.out.println((int) f0.invokeExact("x", "y")); 
     * }
...
assertEquals("boojum", (String) catTrace.invokeExact("boo", "jum"));
     ...
     *     }
     *     body = dropArguments(body, 0, counterType);  
     *     MethodHandle[]
     *         loopLimit  = { end, null, pred, retv }, 
     *         bodyClause = { init, body },            
     *         indexVar   = { start, incr };           
     ...
     *     MethodHandle[]
     *         iterVar    = { startIter, null, MH_hasNext, retv }, 
     *         bodyClause = { init, filterArguments(step, 0, nextVal) };  
