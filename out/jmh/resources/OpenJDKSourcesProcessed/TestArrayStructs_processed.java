...
public class TestArrayStructs extends NativeTestHelper {
    ...
    public void testArrayStruct(String functionName, FunctionDescriptor baseDesc, int numPrefixArgs, int numElements) throws Throwable {
        FunctionDescriptor downcallDesc = baseDesc.insertArgumentLayouts(0, C_POINTER); 
        ...
        try (Arena arena = Arena.ofConfined()) {
            ...
            Object[] args = new Object[downcallDesc.argumentLayouts().size() + 1]; 
            ...
            structCheck.accept(MemorySegment.ofArray(elements)); 
        }
    }
