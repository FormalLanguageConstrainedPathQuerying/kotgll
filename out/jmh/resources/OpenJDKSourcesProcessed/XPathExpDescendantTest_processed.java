...
public class XPathExpDescendantTest extends XPathTestBase {
    ...
    public Object[][] getDescendantXpathExpression() {
        return new Object[][] {
                ...
                {"/Customers/descendant::Customer", "
                {"/Customers/descendant::foo:Customer", "
                ...
                {"/Customers/descendant::Name", "/Customers
                {"/Customers/descendant::Street", "/Customers
                {"/Customers/descendant::Street[2]", "Customers/Customer[@id='x2']/Address/Street"},
                {"/Customers/descendant::Street[2]", "(Customers
