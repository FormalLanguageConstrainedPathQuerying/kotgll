...
public class CycleTest {
    ...
    public void testCycle1() throws Exception  {
        ...
        assertEquals(deserializedObj.x(), 1);           
        assertEquals(deserializedObj.y(), 2);           
        assertTrue(deserializedObj.c() instanceof C);   
        assertEquals(deserializedObj.c().obj, null);    
    }
    ...
    public void testCycle2() throws Exception  {
        ...
        out.println("deserialized: " + deserializedObj);
        assertTrue(deserializedObj instanceof C);         
        assertTrue(deserializedObj.obj != null);          
        assertEquals(((R)deserializedObj.obj).x(), 3);    
        assertEquals(((R)deserializedObj.obj).y(), 4);    
    }
    ...
    public void testCycle3() throws Exception {
        ...
        out.println("deserialized: " + deserializedObj);
        assertEquals(deserializedObj.x(), 5);         
        assertEquals(deserializedObj.y(), 6);         
    ...
    public void testCycle4() throws Exception  {
        ...
        assertEquals(deserializedObj.l(), 9);              
        assertEquals(deserializedObj.r().x(), 7);          
        assertEquals(deserializedObj.r().y(), 8);          
        assertTrue(deserializedObj.r().c() instanceof C);  
        assertEquals(deserializedObj.r().c().obj, null);   
    }
