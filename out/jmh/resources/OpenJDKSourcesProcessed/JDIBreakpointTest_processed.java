 ...
 * lineOption         := "L" INTEGER                                                     
 * requiredHitsOption := "H" INTEGER | "H*"                                              
 * stepsToTraceOption  := "S" INTEGER                                                    
 *
 * stratum            := "/" stratumName "=" stratumSourceName ":" stratumSourceLine     
 * stratumName        := STRING
 * stratumSourceName  := STRING
 * stratumSourceLine  := INTEGER
 *
 * subBreakpoints := "=>(" breakpoints ")"                                               
 * </pre>
 */
