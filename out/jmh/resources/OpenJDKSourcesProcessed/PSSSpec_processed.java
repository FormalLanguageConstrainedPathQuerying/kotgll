...
public class PSSSpec {
    private static final String P2SM = "
    ...
    static void unmarshal() throws Exception {
                    ...
                    <ds:SignedInfo>
                        ...
                        <ds:SignatureMethod Algorithm="http:
                            <pss:RSAPSSParams>
                                ...
                                <pss:MaskGenerationFunction Algorithm="http:
                                    <ds:DigestMethod Algorithm="http:
        ...
        checkSpec(XMLUtils.withoutNode(doc, P2MGF + "/ds:DigestMethod"), 
                new PSSParameterSpec("SHA-512", "MGF1", new MGF1ParameterSpec("SHA-512"), 32, 2));
        checkSpec(XMLUtils.withoutNode(doc, P2MGF), 
                new PSSParameterSpec("SHA-512", "MGF1", new MGF1ParameterSpec("SHA-512"), 32, 2));
    ...
    static PSSParameterSpec getSpec(Document doc) throws Exception {
        var signatureNode = doc.getElementsByTagNameNS("http:
