...
public class ConnectionReuseTest {
    ...
    private static HttpTestServer http2_Server; 
    private static HttpTestServer https2_Server; 
    ...
    private static Stream<Arguments> requestURIs() throws Exception {
        ...
        arguments.add(Arguments.of(new URI("https:
        arguments.add(Arguments.of(new URI("http:
        if (IPSupport.preferIPv6Addresses()) {
