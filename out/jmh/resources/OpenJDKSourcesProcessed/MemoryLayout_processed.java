 ...
 * long offset1 = (long) offsetHandle.invokeExact(0L, 1L); 
 * long offset2 = (long) offsetHandle.invokeExact(0L, 2L); 
 * }
 *
...
public sealed interface MemoryLayout
     ...
     * targetHandle = MethodHandles.insertCoordinates(targetHandle, 1, 0L); 
     ...
     * follows:
     * {@snippet lang = "java":
     *     VarHandle handle = grp.varHandle(PathElement.groupElement("value")); 
     * }
     *
