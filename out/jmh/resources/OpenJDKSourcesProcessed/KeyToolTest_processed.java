...
public class KeyToolTest {
    ...
    void v3extTest(String keyAlg) throws Exception {
        ...
        testOK("", pre + "ku12a -ext KU=kE"); 
        testOK("", pre + "ku13a -ext KU=de"); 
        testOK("", pre + "ku13b -ext KU=dE"); 
        ...
        testOK("", pre+"san6 -ext san=dns:1abc.com"); 
        ...
        csia.check(ks, "sia1", 0,
                AccessDescription.Ad_CAREPOSITORY_Id, 6, "ldap:
        csia.check(ks, "sia2",
        ...
        csia.check(ks, "aia1", 1,
                AccessDescription.Ad_CAISSUERS_Id, 6, "ldap:
