...
public class HBShaper {
    ...
    static {
        ...
        Arena garena = Arena.global(); 
        FunctionDescriptor get_var_glyph_fd = getFunctionDescriptor(JAVA_INT,  
        ...
        FunctionDescriptor get_nominal_glyph_fd = getFunctionDescriptor(JAVA_INT, 
        ...
        FunctionDescriptor get_h_adv_fd = getFunctionDescriptor(JAVA_INT,  
        ...
        FunctionDescriptor get_v_adv_fd = getFunctionDescriptor(JAVA_INT,  
                   ADDRESS, ADDRESS, JAVA_INT, ADDRESS); 
        ...
        FunctionDescriptor get_contour_pt_fd = getFunctionDescriptor(JAVA_INT,  
            ADDRESS, ADDRESS, JAVA_INT, JAVA_INT, ADDRESS, ADDRESS, ADDRESS); 
