...
public class SAXParserTest02 {
    private static final String DOM_NODE = "http:
    private static final String XML_STRING = "http:
    private static final String DECL_HANDLER = "http:
    private static final String LEXICAL_HANDLER = "http:
