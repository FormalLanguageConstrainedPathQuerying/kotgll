 ...
 * @summary Test if SAXParserFactory set a Schema object, when SAXParser sets "http:
 * and/or "http:
 */
...
public class Bug5025825 {
    ...
    public void test1() throws Exception {
        ...
        final String aSchemaLanguage = "http:
        final String aSchemaSource = "http:

        try {
            sParser.setProperty(aSchemaLanguage, "http:
