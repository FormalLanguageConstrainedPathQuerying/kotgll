...
public class AArch64TestAssembler extends TestAssembler {
    ...
    public void emitPrologue() {
        ...
        if (config.ropProtection) {
            code.emitInt(0xf94003df);  
            code.emitInt(0xd503231f);  
        }
        code.emitInt(0xa9bf7bfd);      
        code.emitInt(0x910003fd);      
    ...
    public void emitIntRet(Register a) {
        ...
        code.emitInt(0x910003bf);      
        code.emitInt(0xa8c17bfd);      
        if (config.ropProtection) {
            code.emitInt(0xd503239f);  
            code.emitInt(0xf94003df);  
        }
