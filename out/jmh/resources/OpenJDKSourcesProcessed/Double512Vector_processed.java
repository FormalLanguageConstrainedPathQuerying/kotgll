...
final class Double512Vector extends DoubleVector {
    ...
    public final Double512Vector broadcast(double e) {
        return (Double512Vector) super.broadcastTemplate(e);  
    }
    ...
    Double512Vector uOp(FUnOp f) {
        return (Double512Vector) super.uOpTemplate(f);  
    }
    ...
    Double512Vector uOp(VectorMask<Double> m, FUnOp f) {
        return (Double512Vector)
            super.uOpTemplate((Double512Mask)m, f);  
    }
    ...
    Double512Vector bOp(Vector<Double> v, FBinOp f) {
        return (Double512Vector) super.bOpTemplate((Double512Vector)v, f);  
    }
    ...
    public Double512Vector lanewise(Unary op) {
        return (Double512Vector) super.lanewiseTemplate(op);  
    }

    @Override
    @ForceInline
    public Double512Vector lanewise(Unary op, VectorMask<Double> m) {
        return (Double512Vector) super.lanewiseTemplate(op, Double512Mask.class, (Double512Mask) m);  
    }

    @Override
    @ForceInline
    public Double512Vector lanewise(Binary op, Vector<Double> v) {
        return (Double512Vector) super.lanewiseTemplate(op, v);  
    }

    @Override
    @ForceInline
    public Double512Vector lanewise(Binary op, Vector<Double> v, VectorMask<Double> m) {
        return (Double512Vector) super.lanewiseTemplate(op, Double512Mask.class, v, (Double512Mask) m);  
    }
    ...
    lanewise(Ternary op, Vector<Double> v1, Vector<Double> v2) {
        return (Double512Vector) super.lanewiseTemplate(op, v1, v2);  
    }
    ...
    lanewise(Ternary op, Vector<Double> v1, Vector<Double> v2, VectorMask<Double> m) {
        return (Double512Vector) super.lanewiseTemplate(op, Double512Mask.class, v1, v2, (Double512Mask) m);  
    }
    ...
    Double512Vector addIndex(int scale) {
        return (Double512Vector) super.addIndexTemplate(scale);  
    }
    ...
    public final double reduceLanes(VectorOperators.Associative op,
                                    VectorMask<Double> m) {
        return super.reduceLanesTemplate(op, Double512Mask.class, (Double512Mask) m);  
    }
    ...
    public final long reduceLanesToLong(VectorOperators.Associative op,
                                        VectorMask<Double> m) {
        return (long) super.reduceLanesTemplate(op, Double512Mask.class, (Double512Mask) m);  
    }

    @ForceInline
    public VectorShuffle<Double> toShuffle() {
        return super.toShuffleTemplate(Double512Shuffle.class); 
    }
    ...
    public final Double512Mask test(Test op) {
        return super.testTemplate(Double512Mask.class, op);  
    }

    @Override
    @ForceInline
    public final Double512Mask test(Test op, VectorMask<Double> m) {
        return super.testTemplate(Double512Mask.class, op, (Double512Mask) m);  
    }
    ...
    public final Double512Mask compare(Comparison op, Vector<Double> v) {
        return super.compareTemplate(Double512Mask.class, op, v);  
    }

    @Override
    @ForceInline
    public final Double512Mask compare(Comparison op, double s) {
        return super.compareTemplate(Double512Mask.class, op, s);  
    }
    ...
    public Double512Vector slice(int origin, Vector<Double> v) {
        return (Double512Vector) super.sliceTemplate(origin, v);  
    }

    @Override
    @ForceInline
    public Double512Vector slice(int origin) {
        return (Double512Vector) super.sliceTemplate(origin);  
    }

    @Override
    @ForceInline
    public Double512Vector unslice(int origin, Vector<Double> w, int part) {
        return (Double512Vector) super.unsliceTemplate(origin, w, part);  
    }
    ...
    public Double512Vector unslice(int origin) {
        return (Double512Vector) super.unsliceTemplate(origin);  
    }
    ...
    static final class Double512Mask extends AbstractMask<Double> {
        ...
        Double512Vector toVector() {
            return (Double512Vector) super.toVectorTemplate();  
        }
    ...
    DoubleVector fromArray0(double[] a, int offset, VectorMask<Double> m, int offsetInRange) {
        return super.fromArray0Template(Double512Mask.class, a, offset, (Double512Mask) m, offsetInRange);  
    }
    ...
    DoubleVector fromMemorySegment0(MemorySegment ms, long offset, VectorMask<Double> m, int offsetInRange) {
        return super.fromMemorySegment0Template(Double512Mask.class, ms, offset, (Double512Mask) m, offsetInRange);  
    }
