...
public class CatalogTestBase extends TestBase {
    ...
    public Object[][] getConfigs(Processor processor) {
        ...
        return new Object[][]{
             ...
             * org.xml.sax.SAXException: javax.xml.catalog.CatalogException: JAXP09040001: No match found for publicId 'null' and systemId 'http:
             * javax.xml.catalog.CatalogException: JAXP09040001: No match found for publicId 'null' and systemId 'http:
             */
