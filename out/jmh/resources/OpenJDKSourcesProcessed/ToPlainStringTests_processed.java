...
public class ToPlainStringTests {
    public static void main(String argv[]) {
        ...
        String[] failingCases = {
            "1E-" + (Integer.MAX_VALUE - 0),            
            "1E-" + (Integer.MAX_VALUE - 1),            

            "-1E-" + (Integer.MAX_VALUE - 0),           
            "-1E-" + (Integer.MAX_VALUE - 1),           
            "-1E-" + (Integer.MAX_VALUE - 2),           

            "123456789E-" + (Integer.MAX_VALUE - 0),    
            "123456789E-" + (Integer.MAX_VALUE - 1),    

            "-123456789E-" + (Integer.MAX_VALUE - 0),   
            "-123456789E-" + (Integer.MAX_VALUE - 1),   
            "-123456789E-" + (Integer.MAX_VALUE - 2),   

            "1E" + Integer.MAX_VALUE,                   
            "123456789E" + Integer.MAX_VALUE,           
