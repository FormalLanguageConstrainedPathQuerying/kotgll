...
public class InvokeTest {
    ...
    static final MethodHandle virtualMH; 
    static final MethodHandle staticMH;  
    static final MethodHandle intfMH;    
    static final MethodHandle defaultMH; 
    static final MethodHandle specialMH; 
    static final MethodHandle privateMH; 

    static final MethodHandle intrinsicMH; 
