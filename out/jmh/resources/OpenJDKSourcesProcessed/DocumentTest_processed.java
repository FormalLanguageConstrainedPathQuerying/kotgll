...
public class DocumentTest {
    ...
    */
    ...
    public void testNormalizeDocument() throws Exception {
        ...
        final Attr attr = element.getOwnerDocument().createAttributeNS("http:
        attr.setValue("Id");
        element.setAttributeNodeNS(attr);

        final Attr attr2 = element.getOwnerDocument().createAttributeNS("http:
        ...
        Node wsu = element.getAttributes().getNamedItemNS("http:
        Node wsu2 = element.getAttributes().getNamedItemNS("http:
