...
public class WeakAlg {
    ...
    static void checkInplaceImportKeyStore() throws Exception {
        ...
        importkeystore("ks", "ks", "-srcstoretype jks") 
                .shouldContain("Warning:")
    ...
    static void checkImport() throws Exception {
        ...
        if (weakSigAlgCA != null) {
            ...
            kt("-printcert -file ca.cert -trustcacerts") 
                    .shouldContain("name: " + weakSigAlgCA + " (disabled)")
                    .shouldContain("Warning")
                    .shouldMatch("The certificate.*" + weakSigAlgCA + ".*is disabled");
        ...
        certreq("b", "");
        gencert("c-b", "");
        kt("-importcert -alias d -file c-b.cert")   
                .shouldContain("Warning")
        ...
        kt("-importcert -alias d -file c-b.cert", "no") 
                .shouldContain("Warning")
                .shouldContain("512-bit RSA key (disabled)")
                .shouldMatch("The input.*512-bit RSA key.*is disabled")
                .shouldContain("Trust this certificate?");
        ...
        certreq("a", "");
        gencert("c-a", "");
        kt("-importcert -alias d -file c-a.cert") 
                .shouldNotContain("Warning")
                .shouldNotContain("[no]");
        ...
        kt("-importcert -alias d -file c-a.cert", "no") 
                .shouldNotContain("Warning")
                .shouldContain("Trust this certificate?");
        ...
        kt("-importcert -alias c -file a-a-b-c.cert")   
                .shouldContain("Warning")
        ...
        kt("-importcert -alias c -file a-b-c.cert")     
                .shouldContain("Warning")
