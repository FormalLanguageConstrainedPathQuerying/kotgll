...
public class CatalogTest extends CatalogSupportBase {
    ...
    */
    ...
    public void sysIdCantBeNull() {
        ...
        InputSource is = catalogResolver.resolveEntity("-
    }
    ...
    */
    ...
    public void testRewriteSystem() throws Exception {
        ...
        try {
            ...
            String actualSystemId = resolver.resolveEntity(null, "http:
            Assert.assertTrue(!actualSystemId.contains("
        } catch (Exception e) {
            Assert.fail(e.getMessage());
        }
    ...
    */
    ...
    public void testRewriteUri() throws Exception {
        ...
        try {
            ...
            CatalogResolver resolver = CatalogManager.catalogResolver(CatalogFeatures.defaults(), catalog);
            String actualSystemId = resolver.resolve("http:
            Assert.assertTrue(!actualSystemId.contains("
        } catch (Exception e) {
            Assert.fail(e.getMessage());
        }
    ...
    */
    ...
    public Object[][] getDataForMatch() {
        return new Object[][]{
            {"public", "pubOnly.xml", id, "", "http:
            {"public", "sysOnly.xml", id, "", null},
            {"public", "sysAndPub.xml", id, "", "http:
            {"system", "pubOnly.xml", id, "", "http:
            {"system", "sysOnly.xml", id, "", null},
            {"system", "sysAndPub.xml", id, "", "http:
            {"public", "pubOnly.xml", "", id, null},
            {"public", "sysOnly.xml", "", id, "http:
            {"public", "sysAndPub.xml", "", id, "http:
            {"system", "pubOnly.xml", "", id, null},
            {"system", "sysOnly.xml", "", id, "http:
            {"system", "sysAndPub.xml", "", id, "http:
        };
    }
    ...
    public Object[][] getDataForResolve() {
        return new Object[][]{
            ...
            {"public", "pubOnly.xml", id, "", "http:
            {"public", "pubOnly.xml", "", id, null},
            {"public", "pubOnly.xml", id, id, "http:
            {"system", "sysOnly.xml", id, "", null},
            {"system", "sysOnly.xml", "", id, "http:
            {"system", "sysOnly.xml", id, id, "http:
            {"public", "sysOnly.xml", id, "", null},
            {"public", "sysOnly.xml", "", id, "http:
            {"public", "sysOnly.xml", id, id, "http:
            {"system", "sysAndPub.xml", id, "", "http:
            {"system", "sysAndPub.xml", "", id, "http:
            {"system", "sysAndPub.xml", id, id, "http:
            {"public", "sysAndPub.xml", id, "", "http:
            {"public", "sysAndPub.xml", "", id, "http:
            {"public", "sysAndPub.xml", id, id, "http:
        };
    }
    /*
