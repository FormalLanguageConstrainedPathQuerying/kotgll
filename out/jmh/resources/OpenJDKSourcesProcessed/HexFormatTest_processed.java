...
public class HexFormatTest {
    ...
    Object[][] badParseHexThrowing() {
        return new Object[][]{
                {"a", 0, 2, IndexOutOfBoundsException.class},        
                {"b", 1, 2, IndexOutOfBoundsException.class},        
                {"a", -1, 2, IndexOutOfBoundsException.class},       
                {"b", -1, 1, IndexOutOfBoundsException.class},       
                {"a", 0, -1, IndexOutOfBoundsException.class},       
                {"b", 1, -1, IndexOutOfBoundsException.class},       
                {"76543210", 0, 7, IllegalArgumentException.class},  
                {"zz00", 0, 4, IllegalArgumentException.class},      
                {"00zz", 0, 4, IllegalArgumentException.class},      
        };
    }
