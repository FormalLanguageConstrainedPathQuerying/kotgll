...
@Foo(Constants.class_annotation)  
class RedefineAnnotationTarg {
    @Foo(Constants.field_annotation)  
    ...
    public static void main(String[] args) {
        ...
        new RedefineAnnotationTarg().hi(true);  
        sub.hi(true);
        subsub.hi(true);
    }

    @Foo(Constants.method_annotation)  
    public void hi(
    @Foo(Constants.method_parameter_annotation)  
