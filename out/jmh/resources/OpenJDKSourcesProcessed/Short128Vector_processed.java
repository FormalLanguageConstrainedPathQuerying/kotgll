...
final class Short128Vector extends ShortVector {
    ...
    public final Short128Vector broadcast(short e) {
        return (Short128Vector) super.broadcastTemplate(e);  
    }
    ...
    Short128Vector uOp(FUnOp f) {
        return (Short128Vector) super.uOpTemplate(f);  
    }
    ...
    Short128Vector uOp(VectorMask<Short> m, FUnOp f) {
        return (Short128Vector)
            super.uOpTemplate((Short128Mask)m, f);  
    }
    ...
    Short128Vector bOp(Vector<Short> v, FBinOp f) {
        return (Short128Vector) super.bOpTemplate((Short128Vector)v, f);  
    }
    ...
    public Short128Vector lanewise(Unary op) {
        return (Short128Vector) super.lanewiseTemplate(op);  
    }

    @Override
    @ForceInline
    public Short128Vector lanewise(Unary op, VectorMask<Short> m) {
        return (Short128Vector) super.lanewiseTemplate(op, Short128Mask.class, (Short128Mask) m);  
    }

    @Override
    @ForceInline
    public Short128Vector lanewise(Binary op, Vector<Short> v) {
        return (Short128Vector) super.lanewiseTemplate(op, v);  
    }

    @Override
    @ForceInline
    public Short128Vector lanewise(Binary op, Vector<Short> v, VectorMask<Short> m) {
        return (Short128Vector) super.lanewiseTemplate(op, Short128Mask.class, v, (Short128Mask) m);  
    }
    ...
    lanewiseShift(VectorOperators.Binary op, int e) {
        return (Short128Vector) super.lanewiseShiftTemplate(op, e);  
    }
    ...
    lanewiseShift(VectorOperators.Binary op, int e, VectorMask<Short> m) {
        return (Short128Vector) super.lanewiseShiftTemplate(op, Short128Mask.class, e, (Short128Mask) m);  
    }
    ...
    lanewise(Ternary op, Vector<Short> v1, Vector<Short> v2) {
        return (Short128Vector) super.lanewiseTemplate(op, v1, v2);  
    }
    ...
    lanewise(Ternary op, Vector<Short> v1, Vector<Short> v2, VectorMask<Short> m) {
        return (Short128Vector) super.lanewiseTemplate(op, Short128Mask.class, v1, v2, (Short128Mask) m);  
    }
    ...
    Short128Vector addIndex(int scale) {
        return (Short128Vector) super.addIndexTemplate(scale);  
    }
    ...
    public final short reduceLanes(VectorOperators.Associative op,
                                    VectorMask<Short> m) {
        return super.reduceLanesTemplate(op, Short128Mask.class, (Short128Mask) m);  
    }
    ...
    public final long reduceLanesToLong(VectorOperators.Associative op,
                                        VectorMask<Short> m) {
        return (long) super.reduceLanesTemplate(op, Short128Mask.class, (Short128Mask) m);  
    }

    @ForceInline
    public VectorShuffle<Short> toShuffle() {
        return super.toShuffleTemplate(Short128Shuffle.class); 
    }
    ...
    public final Short128Mask test(Test op) {
        return super.testTemplate(Short128Mask.class, op);  
    }

    @Override
    @ForceInline
    public final Short128Mask test(Test op, VectorMask<Short> m) {
        return super.testTemplate(Short128Mask.class, op, (Short128Mask) m);  
    }
    ...
    public final Short128Mask compare(Comparison op, Vector<Short> v) {
        return super.compareTemplate(Short128Mask.class, op, v);  
    }

    @Override
    @ForceInline
    public final Short128Mask compare(Comparison op, short s) {
        return super.compareTemplate(Short128Mask.class, op, s);  
    }
    ...
    public Short128Vector slice(int origin, Vector<Short> v) {
        return (Short128Vector) super.sliceTemplate(origin, v);  
    }

    @Override
    @ForceInline
    public Short128Vector slice(int origin) {
        return (Short128Vector) super.sliceTemplate(origin);  
    }

    @Override
    @ForceInline
    public Short128Vector unslice(int origin, Vector<Short> w, int part) {
        return (Short128Vector) super.unsliceTemplate(origin, w, part);  
    }
    ...
    public Short128Vector unslice(int origin) {
        return (Short128Vector) super.unsliceTemplate(origin);  
    }
    ...
    static final class Short128Mask extends AbstractMask<Short> {
        ...
        Short128Vector toVector() {
            return (Short128Vector) super.toVectorTemplate();  
        }
    ...
    ShortVector fromArray0(short[] a, int offset, VectorMask<Short> m, int offsetInRange) {
        return super.fromArray0Template(Short128Mask.class, a, offset, (Short128Mask) m, offsetInRange);  
    }
    ...
    ShortVector fromCharArray0(char[] a, int offset, VectorMask<Short> m, int offsetInRange) {
        return super.fromCharArray0Template(Short128Mask.class, a, offset, (Short128Mask) m, offsetInRange);  
    }
    ...
    ShortVector fromMemorySegment0(MemorySegment ms, long offset, VectorMask<Short> m, int offsetInRange) {
        return super.fromMemorySegment0Template(Short128Mask.class, ms, offset, (Short128Mask) m, offsetInRange);  
    }
