...
public class StapleEnableProps {
    ...
    private static KeyStore rootKeystore;       
    private static KeyStore intKeystore;        
    private static KeyStore serverKeystore;     
    private static KeyStore trustStore;         
    private static SimpleOCSPServer rootOcsp;   
    private static int rootOcspPort;            
    private static SimpleOCSPServer intOcsp;    
    private static int intOcspPort;             
