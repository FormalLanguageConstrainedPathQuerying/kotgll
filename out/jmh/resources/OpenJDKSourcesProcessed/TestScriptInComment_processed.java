...
public class TestScriptInComment {
     ...
     */
    enum Comment {
        LC("<script>#ALERT</script>", true), 
        UC("<SCRIPT>#ALERT</script>", true), 
        WS("< script >#ALERT</script>", false, "-Xdoclint:none"), 
        SP("""
            <script src="file"> #ALERT </script>""", true), 
        ON("<a onclick='#ALERT'>x</a>", true), 
        OME("<img alt='1' onmouseenter='#ALERT'>", true), 
        OML("<img alt='1' onmouseleave='#ALERT'>", true), 
        OFI("<a href='#' onfocusin='#ALERT'>x</a>", true), 
        OBE("<a onbogusevent='#ALERT'>x</a>", true), 
        URI("<a href='javascript:#ALERT'>x</a>", true); 
