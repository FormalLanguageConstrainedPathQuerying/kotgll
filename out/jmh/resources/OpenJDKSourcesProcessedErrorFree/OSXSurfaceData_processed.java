...
public abstract class OSXSurfaceData extends BufImgSurfaceData {
    ...
    @Native static final int kLine = 5; 
    @Native static final int kRect = 6; 
    @Native static final int kRoundRect = 7; 
    @Native static final int kOval = 8; 
    @Native static final int kArc = 9; 
    @Native static final int kPolygon = 10; 
    @Native static final int kShape = 11; 
    @Native static final int kString = 13; 
    @Native static final int kGlyphs = 14; 
    @Native static final int kUnicodes = 15; 

    @Native static final int kCommonParameterCount = 1 + 1 + 4 + 4; 
    @Native static final int kLineParametersCount = kCommonParameterCount; 
    @Native static final int kRectParametersCount = kCommonParameterCount + 1; 
    @Native static final int kRoundRectParametersCount = kCommonParameterCount + 2 + 1; 
    @Native static final int kOvalParametersCount = kCommonParameterCount + 1; 
    @Native static final int kArcParametersCount = kCommonParameterCount + 2 + 1 + 1;
    @Native static final int kPolygonParametersCount = 0; 
    @Native static final int kShapeParametersCount = 0; 
    @Native static final int kImageParametersCount = kCommonParameterCount + 2 + 2 + 4 + 4; 
    @Native static final int kStringParametersCount = 0; 
    @Native static final int kGlyphsParametersCount = 0; 
    @Native static final int kUnicodesParametersCount = 0; 
    @Native static final int kPixelParametersCount = 0; 
    @Native static final int kExternalParametersCount = 0; 

    @Native static final int kChangeFlagIndex = 0; 
    ...
    @Native static final int kColorStateIndex = 19; 
    @Native static final int kColorRGBValueIndex = 20; 
    @Native static final int kColorIndexValueIndex = 21; 
    @Native static final int kColorPointerIndex = 22; 
    @Native static final int kColorPointerIndex2 = 23; 
    @Native static final int kColorRGBValue1Index = 24; 
    @Native static final int kColorWidthIndex = 25; 
    @Native static final int kColorRGBValue2Index = 26; 
    @Native static final int kColorHeightIndex = 27; 
    @Native static final int kColorIsCyclicIndex = 28; 
    ...
    @Native static final int kCompositeRuleIndex = 37; 
    @Native static final int kCompositeValueIndex = 38;
    @Native static final int kStrokeJoinIndex = 39; 
    @Native static final int kStrokeCapIndex = 40; 
