...
final class Double64Vector extends DoubleVector {
    ...
    public Double64Vector lanewise(Unary op, VectorMask<Double> m) {
        return (Double64Vector) super.lanewiseTemplate(op, Double64Mask.class, (Double64Mask) m);  
    }
    ...
    public Double64Vector lanewise(Binary op, Vector<Double> v, VectorMask<Double> m) {
        return (Double64Vector) super.lanewiseTemplate(op, Double64Mask.class, v, (Double64Mask) m);  
    }
    ...
    lanewise(Ternary op, Vector<Double> v1, Vector<Double> v2, VectorMask<Double> m) {
        return (Double64Vector) super.lanewiseTemplate(op, Double64Mask.class, v1, v2, (Double64Mask) m);  
    }
    ...
    public final double reduceLanes(VectorOperators.Associative op,
                                    VectorMask<Double> m) {
        return super.reduceLanesTemplate(op, Double64Mask.class, (Double64Mask) m);  
    }
    ...
    public final long reduceLanesToLong(VectorOperators.Associative op,
                                        VectorMask<Double> m) {
        return (long) super.reduceLanesTemplate(op, Double64Mask.class, (Double64Mask) m);  
    }

    @ForceInline
    public VectorShuffle<Double> toShuffle() {
        return super.toShuffleTemplate(Double64Shuffle.class); 
    }
    ...
    public final Double64Mask test(Test op, VectorMask<Double> m) {
        return super.testTemplate(Double64Mask.class, op, (Double64Mask) m);  
    }
    ...
    public Double64Vector slice(int origin) {
        return (Double64Vector) super.sliceTemplate(origin);  
    }
    ...
    public Double64Vector unslice(int origin) {
        return (Double64Vector) super.unsliceTemplate(origin);  
    }
    ...
    DoubleVector fromArray0(double[] a, int offset, VectorMask<Double> m, int offsetInRange) {
        return super.fromArray0Template(Double64Mask.class, a, offset, (Double64Mask) m, offsetInRange);  
    }
    ...
    DoubleVector fromMemorySegment0(MemorySegment ms, long offset, VectorMask<Double> m, int offsetInRange) {
        return super.fromMemorySegment0Template(Double64Mask.class, ms, offset, (Double64Mask) m, offsetInRange);  
    }
