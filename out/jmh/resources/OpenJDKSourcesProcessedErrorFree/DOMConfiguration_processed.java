 ...
 * objects are also used in [<a href='http:
 ...
 * <dd>[<em>optional</em>] Canonicalize the document according to the rules specified in [<a href='http:
 ...
 * <dl>
 * <dt><code>true</code></dt>
 * <dd>[<em>optional</em>] Check if the characters in the document are <a href='http:
 * normalized</a>, as defined in appendix B of [<a href='http:
 ...
 * <dl>
 * <dt><code>true</code></dt>
 * <dd>[<em>optional</em>] Expose schema normalized values in the tree, such as <a href='http:
 ...
 * normalization as defined in section 3.3.3 of [<a href='http:
 ...
 * nodes are normalized, as defined in <code>Node.normalize</code>. Only <a href='http:
 ...
 * <dt>
 * <code>true</code></dt>
 * <dd>[<em>required</em>]Keep in the document the information defined in the XML Information Set [<a href='http:
 ...
 * <dl>
 * <dt><code>true</code></dt>
 * <dd>[<em>optional</em>] <a href='http:
 * normalized</a> the characters in the document as defined in appendix B of [<a href='http:
 * <dt>
 * <code>false</code></dt>
 ...
 * production S</a> defined in section 2.3 [<a href='http:
 ...
 * normalized as defined by [<a href='http:
