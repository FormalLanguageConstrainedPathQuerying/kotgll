...
final class Float64Vector extends FloatVector {
    ...
    public final Float64Vector broadcast(float e) {
        return (Float64Vector) super.broadcastTemplate(e);  
    }
    ...
    Float64Vector uOp(FUnOp f) {
        return (Float64Vector) super.uOpTemplate(f);  
    }
    ...
    Float64Vector uOp(VectorMask<Float> m, FUnOp f) {
        return (Float64Vector)
            super.uOpTemplate((Float64Mask)m, f);  
    }
    ...
    Float64Vector bOp(Vector<Float> v, FBinOp f) {
        return (Float64Vector) super.bOpTemplate((Float64Vector)v, f);  
    }
    ...
    public Float64Vector lanewise(Unary op) {
        return (Float64Vector) super.lanewiseTemplate(op);  
    }

    @Override
    @ForceInline
    public Float64Vector lanewise(Unary op, VectorMask<Float> m) {
        return (Float64Vector) super.lanewiseTemplate(op, Float64Mask.class, (Float64Mask) m);  
    }

    @Override
    @ForceInline
    public Float64Vector lanewise(Binary op, Vector<Float> v) {
        return (Float64Vector) super.lanewiseTemplate(op, v);  
    }

    @Override
    @ForceInline
    public Float64Vector lanewise(Binary op, Vector<Float> v, VectorMask<Float> m) {
        return (Float64Vector) super.lanewiseTemplate(op, Float64Mask.class, v, (Float64Mask) m);  
    }
    ...
    lanewise(Ternary op, Vector<Float> v1, Vector<Float> v2) {
        return (Float64Vector) super.lanewiseTemplate(op, v1, v2);  
    }
    ...
    lanewise(Ternary op, Vector<Float> v1, Vector<Float> v2, VectorMask<Float> m) {
        return (Float64Vector) super.lanewiseTemplate(op, Float64Mask.class, v1, v2, (Float64Mask) m);  
    }
    ...
    Float64Vector addIndex(int scale) {
        return (Float64Vector) super.addIndexTemplate(scale);  
    }
    ...
    public final float reduceLanes(VectorOperators.Associative op,
                                    VectorMask<Float> m) {
        return super.reduceLanesTemplate(op, Float64Mask.class, (Float64Mask) m);  
    }
    ...
    public final long reduceLanesToLong(VectorOperators.Associative op,
                                        VectorMask<Float> m) {
        return (long) super.reduceLanesTemplate(op, Float64Mask.class, (Float64Mask) m);  
    }

    @ForceInline
    public VectorShuffle<Float> toShuffle() {
        return super.toShuffleTemplate(Float64Shuffle.class); 
    }
    ...
    public final Float64Mask test(Test op) {
        return super.testTemplate(Float64Mask.class, op);  
    }

    @Override
    @ForceInline
    public final Float64Mask test(Test op, VectorMask<Float> m) {
        return super.testTemplate(Float64Mask.class, op, (Float64Mask) m);  
    }
    ...
    public final Float64Mask compare(Comparison op, Vector<Float> v) {
        return super.compareTemplate(Float64Mask.class, op, v);  
    }

    @Override
    @ForceInline
    public final Float64Mask compare(Comparison op, float s) {
        return super.compareTemplate(Float64Mask.class, op, s);  
    }
    ...
    public Float64Vector slice(int origin, Vector<Float> v) {
        return (Float64Vector) super.sliceTemplate(origin, v);  
    }

    @Override
    @ForceInline
    public Float64Vector slice(int origin) {
        return (Float64Vector) super.sliceTemplate(origin);  
    }

    @Override
    @ForceInline
    public Float64Vector unslice(int origin, Vector<Float> w, int part) {
        return (Float64Vector) super.unsliceTemplate(origin, w, part);  
    }
    ...
    public Float64Vector unslice(int origin) {
        return (Float64Vector) super.unsliceTemplate(origin);  
    }
    ...
    static final class Float64Mask extends AbstractMask<Float> {
        ...
        Float64Vector toVector() {
            return (Float64Vector) super.toVectorTemplate();  
        }
    ...
    FloatVector fromArray0(float[] a, int offset, VectorMask<Float> m, int offsetInRange) {
        return super.fromArray0Template(Float64Mask.class, a, offset, (Float64Mask) m, offsetInRange);  
    }
    ...
    FloatVector fromMemorySegment0(MemorySegment ms, long offset, VectorMask<Float> m, int offsetInRange) {
        return super.fromMemorySegment0Template(Float64Mask.class, ms, offset, (Float64Mask) m, offsetInRange);  
    }
