...
public class RISCV64TestAssembler extends TestAssembler {
    ...
    public void emitPrologue() {
        emitNop();
        emitAdd(RISCV64.x2, RISCV64.x2, -32); 
        emitStoreRegister(RISCV64.x8, RISCV64Kind.QWORD, RISCV64.x2, 0); 
        emitStoreRegister(RISCV64.x1, RISCV64Kind.QWORD, RISCV64.x2, 8); 
    ...
    public void emitIntRet(Register a) {
        ...
        emitMv(RISCV64.x2, RISCV64.x8);  
        emitLoadRegister(RISCV64.x8, RISCV64Kind.QWORD, RISCV64.x2, 0);  
        emitLoadRegister(RISCV64.x1, RISCV64Kind.QWORD, RISCV64.x2, 8);  
        emitAdd(RISCV64.x2, RISCV64.x2, 32);  
        emitJalr(RISCV64.x0, RISCV64.x1, 0);  
    }
