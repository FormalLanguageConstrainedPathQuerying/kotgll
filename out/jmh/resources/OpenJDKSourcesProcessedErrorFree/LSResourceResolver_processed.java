 ...
 * use URNs.
 * <p ><b>Note:</b>  <code>LSResourceResolver</code> is based on the SAX2 [<a href='http:
 * interface.
...
public interface LSResourceResolver {
     ...
     * @param type  The type of the resource being resolved. For XML [<a href='http:
     ...
     *   e.g. the target namespace of the XML Schema [<a href='http:
     *    when resolving XML Schema resources.
     * @param publicId  The public identifier of the external entity being
     *   referenced, or <code>null</code> if no public identifier was
     *   supplied or if the resource is not an entity.
     * @param systemId  The system identifier, a URI reference [<a href='http:
