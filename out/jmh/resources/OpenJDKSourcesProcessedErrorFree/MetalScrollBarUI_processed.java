...
public class MetalScrollBarUI extends BasicScrollBarUI
{
    ...
    protected void paintTrack( Graphics g, JComponent c, Rectangle trackBounds )
    {
        ...
        else  
        {
            ...
            if ( c.isEnabled() ) {
                g.setColor( darkShadowColor );
                drawHLine(g, 0, trackBounds.width - 1, 0);  
                drawVLine(g, 0, 2, trackBounds.height - 2); 
                drawHLine(g, 0, trackBounds.width - 1, trackBounds.height - 2 ); 
                drawVLine(g, trackBounds.width - 1, 2,  trackBounds.height - 1 ); 

                g.setColor( shadowColor );
                drawHLine(g, 1, trackBounds.width - 2, 1 );  
                drawVLine(g, 1, 1, trackBounds.height - 3 ); 
                drawHLine(g, 0, trackBounds.width - 1, trackBounds.height - 1 ); 
                if (scrollbar.getValue() != scrollbar.getMaximum()) {  
