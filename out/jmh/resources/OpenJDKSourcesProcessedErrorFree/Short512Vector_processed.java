...
final class Short512Vector extends ShortVector {
    ...
    public final Short512Vector broadcast(short e) {
        return (Short512Vector) super.broadcastTemplate(e);  
    }
    ...
    Short512Vector uOp(FUnOp f) {
        return (Short512Vector) super.uOpTemplate(f);  
    }
    ...
    Short512Vector uOp(VectorMask<Short> m, FUnOp f) {
        return (Short512Vector)
            super.uOpTemplate((Short512Mask)m, f);  
    }
    ...
    Short512Vector bOp(Vector<Short> v, FBinOp f) {
        return (Short512Vector) super.bOpTemplate((Short512Vector)v, f);  
    }
    ...
    public Short512Vector lanewise(Unary op) {
        return (Short512Vector) super.lanewiseTemplate(op);  
    }

    @Override
    @ForceInline
    public Short512Vector lanewise(Unary op, VectorMask<Short> m) {
        return (Short512Vector) super.lanewiseTemplate(op, Short512Mask.class, (Short512Mask) m);  
    }

    @Override
    @ForceInline
    public Short512Vector lanewise(Binary op, Vector<Short> v) {
        return (Short512Vector) super.lanewiseTemplate(op, v);  
    }

    @Override
    @ForceInline
    public Short512Vector lanewise(Binary op, Vector<Short> v, VectorMask<Short> m) {
        return (Short512Vector) super.lanewiseTemplate(op, Short512Mask.class, v, (Short512Mask) m);  
    }
    ...
    lanewiseShift(VectorOperators.Binary op, int e) {
        return (Short512Vector) super.lanewiseShiftTemplate(op, e);  
    }
    ...
    lanewiseShift(VectorOperators.Binary op, int e, VectorMask<Short> m) {
        return (Short512Vector) super.lanewiseShiftTemplate(op, Short512Mask.class, e, (Short512Mask) m);  
    }
    ...
    lanewise(Ternary op, Vector<Short> v1, Vector<Short> v2) {
        return (Short512Vector) super.lanewiseTemplate(op, v1, v2);  
    }
    ...
    lanewise(Ternary op, Vector<Short> v1, Vector<Short> v2, VectorMask<Short> m) {
        return (Short512Vector) super.lanewiseTemplate(op, Short512Mask.class, v1, v2, (Short512Mask) m);  
    }
    ...
    Short512Vector addIndex(int scale) {
        return (Short512Vector) super.addIndexTemplate(scale);  
    }
    ...
    public final short reduceLanes(VectorOperators.Associative op,
                                    VectorMask<Short> m) {
        return super.reduceLanesTemplate(op, Short512Mask.class, (Short512Mask) m);  
    }
    ...
    public final long reduceLanesToLong(VectorOperators.Associative op,
                                        VectorMask<Short> m) {
        return (long) super.reduceLanesTemplate(op, Short512Mask.class, (Short512Mask) m);  
    }

    @ForceInline
    public VectorShuffle<Short> toShuffle() {
        return super.toShuffleTemplate(Short512Shuffle.class); 
    }
    ...
    public final Short512Mask test(Test op) {
        return super.testTemplate(Short512Mask.class, op);  
    }

    @Override
    @ForceInline
    public final Short512Mask test(Test op, VectorMask<Short> m) {
        return super.testTemplate(Short512Mask.class, op, (Short512Mask) m);  
    }
    ...
    public final Short512Mask compare(Comparison op, Vector<Short> v) {
        return super.compareTemplate(Short512Mask.class, op, v);  
    }

    @Override
    @ForceInline
    public final Short512Mask compare(Comparison op, short s) {
        return super.compareTemplate(Short512Mask.class, op, s);  
    }
    ...
    public Short512Vector slice(int origin, Vector<Short> v) {
        return (Short512Vector) super.sliceTemplate(origin, v);  
    }

    @Override
    @ForceInline
    public Short512Vector slice(int origin) {
        return (Short512Vector) super.sliceTemplate(origin);  
    }

    @Override
    @ForceInline
    public Short512Vector unslice(int origin, Vector<Short> w, int part) {
        return (Short512Vector) super.unsliceTemplate(origin, w, part);  
    }
    ...
    public Short512Vector unslice(int origin) {
        return (Short512Vector) super.unsliceTemplate(origin);  
    }
    ...
    static final class Short512Mask extends AbstractMask<Short> {
        ...
        Short512Vector toVector() {
            return (Short512Vector) super.toVectorTemplate();  
        }
    ...
    ShortVector fromArray0(short[] a, int offset, VectorMask<Short> m, int offsetInRange) {
        return super.fromArray0Template(Short512Mask.class, a, offset, (Short512Mask) m, offsetInRange);  
    }
    ...
    ShortVector fromCharArray0(char[] a, int offset, VectorMask<Short> m, int offsetInRange) {
        return super.fromCharArray0Template(Short512Mask.class, a, offset, (Short512Mask) m, offsetInRange);  
    }
    ...
    ShortVector fromMemorySegment0(MemorySegment ms, long offset, VectorMask<Short> m, int offsetInRange) {
        return super.fromMemorySegment0Template(Short512Mask.class, ms, offset, (Short512Mask) m, offsetInRange);  
    }
