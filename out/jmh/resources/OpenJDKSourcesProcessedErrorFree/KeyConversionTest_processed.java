...
public class KeyConversionTest {
    ...
    void run() throws Exception {
        checkKeyConversion(new KeyEvent(true, (short) 37, '\0', 256), "\033OD"); 
        checkKeyConversion(new KeyEvent(true, (short) 37, '\0', 264), "\033[1;5D"); 
        checkKeyConversion(new KeyEvent(true, (short) 37, '\0', 258), "\033[1;3D"); 
        checkKeyConversion(new KeyEvent(true, (short) 112, '\0', 256), "\033OP"); 
        checkKeyConversion(new KeyEvent(true, (short) 112, '\0', 264), "\033[1;5P"); 
        checkKeyConversion(new KeyEvent(true, (short) 112, '\0', 258), "\033[1;3P"); 
        checkKeyConversion(new KeyEvent(true, (short) 112, '\0', 272), "\033[1;2P"); 
        checkKeyConversion(new KeyEvent(true, (short) 112, '\0', 280), "\033[1;6P"); 
        checkKeyConversion(new KeyEvent(true, (short) 112, '\0', 274), "\033[1;4P"); 
        checkKeyConversion(new KeyEvent(true, (short) 112, '\0', 282), "\033[1;8P"); 
        checkKeyConversion(new KeyEvent(true, (short) 67, '\003', 8), "\003"); 
    }
