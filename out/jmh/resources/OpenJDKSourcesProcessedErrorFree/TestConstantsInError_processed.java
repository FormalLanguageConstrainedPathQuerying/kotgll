...
public abstract class TestConstantsInError implements OutputProcessor {
    ...
    static class TestConstantClass extends TestConstantsInError {
        public static void main(String[] args) {
            run("C1", NoClassDefFoundError.class, mv -> mv.visitLdcInsn(Type.getType("LUnknownClass;")));                
            run("C2",   IllegalAccessError.class, mv -> mv.visitLdcInsn(Type.getType("Ljava/lang/invoke/LambdaForm;"))); 
        ...
        public void process(OutputAnalyzer results, boolean isC1) {
            ...
            if (isC1 && (Platform.isAArch64() || Platform.isRISCV64())) { 
