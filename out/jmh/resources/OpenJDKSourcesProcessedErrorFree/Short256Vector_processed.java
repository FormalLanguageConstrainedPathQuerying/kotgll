...
final class Short256Vector extends ShortVector {
    ...
    public Short256Vector lanewise(Unary op, VectorMask<Short> m) {
        return (Short256Vector) super.lanewiseTemplate(op, Short256Mask.class, (Short256Mask) m);  
    }
    ...
    public Short256Vector lanewise(Binary op, Vector<Short> v, VectorMask<Short> m) {
        return (Short256Vector) super.lanewiseTemplate(op, Short256Mask.class, v, (Short256Mask) m);  
    }
    ...
    lanewiseShift(VectorOperators.Binary op, int e, VectorMask<Short> m) {
        return (Short256Vector) super.lanewiseShiftTemplate(op, Short256Mask.class, e, (Short256Mask) m);  
    }
    ...
    lanewise(Ternary op, Vector<Short> v1, Vector<Short> v2, VectorMask<Short> m) {
        return (Short256Vector) super.lanewiseTemplate(op, Short256Mask.class, v1, v2, (Short256Mask) m);  
    }
    ...
    public final short reduceLanes(VectorOperators.Associative op,
                                    VectorMask<Short> m) {
        return super.reduceLanesTemplate(op, Short256Mask.class, (Short256Mask) m);  
    }
    ...
    public final long reduceLanesToLong(VectorOperators.Associative op,
                                        VectorMask<Short> m) {
        return (long) super.reduceLanesTemplate(op, Short256Mask.class, (Short256Mask) m);  
    }
    ...
    public final Short256Mask test(Test op, VectorMask<Short> m) {
        return super.testTemplate(Short256Mask.class, op, (Short256Mask) m);  
    }
    ...
    public Short256Vector slice(int origin) {
        return (Short256Vector) super.sliceTemplate(origin);  
    }
    ...
    public Short256Vector unslice(int origin) {
        return (Short256Vector) super.unsliceTemplate(origin);  
    }
    ...
    ShortVector fromArray0(short[] a, int offset, VectorMask<Short> m, int offsetInRange) {
        return super.fromArray0Template(Short256Mask.class, a, offset, (Short256Mask) m, offsetInRange);  
    }
    ...
    ShortVector fromCharArray0(char[] a, int offset, VectorMask<Short> m, int offsetInRange) {
        return super.fromCharArray0Template(Short256Mask.class, a, offset, (Short256Mask) m, offsetInRange);  
    }
    ...
    ShortVector fromMemorySegment0(MemorySegment ms, long offset, VectorMask<Short> m, int offsetInRange) {
        return super.fromMemorySegment0Template(Short256Mask.class, ms, offset, (Short256Mask) m, offsetInRange);  
    }
