...
public class DOMEntityResolverWrapper
    ...
    /** XML 1.0 type constant according to DOM L3 LS CR spec "http:
    private static final String XML_TYPE = "http:

    /** XML Schema constant according to DOM L3 LS CR spec "http:
    private static final String XSD_TYPE = "http:
