 ...
 * <p> If the document's schema is an XML DTD [<a href='http:
 * are computed as follows:
 * <ul>
 * <li> If this type is referenced from an
 * <code>Attr</code> node, <code>typeNamespace</code> is
 * <code>"http:
 * represents the <b>[attribute type]</b> property in the [<a href='http:
 ...
 * </li>
 * </ul>
 * <p> If the document's schema is an XML Schema [<a href='http:
...
public interface TypeInfo {
     ...
     * , this constant represents the derivation by <a href='http:
     * restriction</a> if complex types are involved, or a <a href='http:
    ...
    /**
     *  If the document's schema is an XML Schema [<a href='http:
     * , this constant represents the <a href='http:
