...
public class TestLimitsUpdating {
    ...
    private static void testLimitUpdates() throws Exception {
        ...
        File flag = new File(sharedtmpdir, "limitsUpdated"); 
        ...
        targetOut.shouldContain("active_processor_count: 2"); 
        targetOut.shouldContain("active_processor_count: 3"); 
        targetOut.shouldContain("memory_limit_in_bytes: 512000 k"); 
        targetOut.shouldContain("memory_and_swap_limit_in_bytes: 512000 k"); 
        targetOut.shouldContain("memory_limit_in_bytes: 307200 k"); 
        targetOut.shouldContain("memory_and_swap_limit_in_bytes: 307200 k"); 
    }
