...
public class ForkJoinPool extends AbstractExecutorService {
    ...
    static final long UMASK           = ~LMASK;      

    static final int MAX_CAP          = 0x7fff;   
    static final int EXTERNAL_ID_MASK = 0x3ffe;   
    static final int INVALID_ID       = 0x4000;   

    static final int STOP             = 1 <<  0;   
    static final int SHUTDOWN         = 1 <<  1;   
    static final int TERMINATED       = 1 <<  2;   
    static final int RS_LOCK          = 1 <<  3;   

    static final int SPIN_WAITS       = 1 <<  7;   
    static final int MIN_SLEEP        = 1 << 10;   
    static final int MAX_SLEEP        = 1 << 20;   

    static final int FIFO             = 1 << 0;   
    static final int CLEAR_TLS        = 1 << 1;   
    static final int PRESET_SIZE      = 1 << 2;   

    static final long RESCAN          = 1L << 63; 
    static final long HMASK           = ((((long)SMASK) << 32) |
                                         (((long)SMASK) << 16)); 
    static final long NO_HISTORY      = ((((long)INVALID_ID) << 32) | 
                                         (((long)INVALID_ID) << 16)); 

    static final int DEREGISTERED     = 1 << 31;  
    static final int UNCOMPENSATE     = 1 << 16;  
    static final int IDLE             = 1 << 16;  
    ...
    private int tryCompensate(long c) {
        ...
        else if (active > minActive && total >= pc) {   
