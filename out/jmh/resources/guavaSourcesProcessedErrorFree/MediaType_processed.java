...
public final class MediaType {
  ...
  /**
   * L16 audio, as defined by <a href="https:
   *
   * @since 24.1
   */
  ...
  /**
   * L24 audio, as defined by <a href="https:
   *
   * @since 20.0
   */
  ...
  /**
   * Basic Audio, as defined by <a href="http:
   * 2046</a>.
   *
   * @since 20.0
   */
  ...
  /**
   * Vorbis Audio, as defined by <a href="http:
   *
   * @since 20.0
   */
  ...
  /**
   * WAVE format, as defined by <a href="https:
   *
   * @since 20.0
   */
  ...
  /**
   * Media type for the <a href="https:
  ...
  /**
   * WASM applications. For more information see <a href="https:
   * overview</a>.
   *
   * @since 27.0
   */
  ...
  /**
   * A collection of font outlines as defined by <a href="https:
   * 8081</a>.
   *
   * @since 30.0
   */
   ...
   *
   * <pre>{@code
   * PLAIN_TEXT_UTF_8.is(PLAIN_TEXT_UTF_8) 
   * PLAIN_TEXT_UTF_8.is(HTML_UTF_8) 
   * PLAIN_TEXT_UTF_8.is(ANY_TYPE) 
   * PLAIN_TEXT_UTF_8.is(ANY_TEXT_TYPE) 
   * PLAIN_TEXT_UTF_8.is(ANY_IMAGE_TYPE) 
   * PLAIN_TEXT_UTF_8.is(ANY_TEXT_TYPE.withCharset(UTF_8)) 
   * PLAIN_TEXT_UTF_8.withoutParameters().is(ANY_TEXT_TYPE.withCharset(UTF_8)) 
   * PLAIN_TEXT_UTF_8.is(ANY_TEXT_TYPE.withCharset(UTF_16)) 
   * }</pre>
   *
