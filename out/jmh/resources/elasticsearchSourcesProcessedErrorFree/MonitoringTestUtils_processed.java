...
public final class MonitoringTestUtils {
     ...
     */
    public static MonitoringBulkDoc randomMonitoringBulkDoc(final Random random, final XContentType xContentType) throws IOException {
     ...
     */
    public static MonitoringBulkDoc randomMonitoringBulkDoc(
        final Random random,
