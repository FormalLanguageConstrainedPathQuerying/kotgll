...
public class TransformInfoTransportAction extends XPackInfoFeatureTransportAction {
    ...
    static TransformIndexerStats parseSearchAggs(SearchResponse searchResponse) {
        ...
        return new TransformIndexerStats(
            statisticsList.get(0).longValue(),  
            statisticsList.get(1).longValue(),  
            statisticsList.get(2).longValue(),  
            statisticsList.get(3).longValue(),  
            statisticsList.get(4).longValue(),  
            statisticsList.get(5).longValue(),  
            statisticsList.get(6).longValue(),  
            statisticsList.get(7).longValue(),  
            statisticsList.get(8).longValue(),  
            statisticsList.get(9).longValue(),  
            statisticsList.get(10).longValue(),  
            statisticsList.get(11).longValue(),  
            statisticsList.get(12).longValue(),  
            statisticsList.get(13).longValue(), 
            statisticsList.get(14), 
            statisticsList.get(15), 
            statisticsList.get(16)  
        );
    }
