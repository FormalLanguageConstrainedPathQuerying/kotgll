...
public class CompareConditionTests extends ESTestCase {
    public void testOpEvalEQ() throws Exception {
        ...
        assertThat(CompareCondition.Op.EQ.eval(2, "2"), is(true));     
        assertThat(CompareCondition.Op.EQ.eval(3, "4"), is(false));    
        assertThat(CompareCondition.Op.EQ.eval(3, "a"), is(false));    
        assertThat(CompareCondition.Op.EQ.eval("3", 3), is(true));     
    ...
    public void testOpEvalNotEQ() throws Exception {
        ...
        assertThat(CompareCondition.Op.NOT_EQ.eval(2, "2"), is(false));     
        assertThat(CompareCondition.Op.NOT_EQ.eval(3, "4"), is(true));    
        assertThat(CompareCondition.Op.NOT_EQ.eval(3, "a"), is(true));    
        assertThat(CompareCondition.Op.NOT_EQ.eval("3", 3), is(false));     
    ...
    public void testOpEvalGTE() throws Exception {
        ...
        assertThat(CompareCondition.Op.GTE.eval(3, "2"), is(true));     
        assertThat(CompareCondition.Op.GTE.eval(3, "4"), is(false));    
        assertThat(CompareCondition.Op.GTE.eval(3, "a"), is(false));    
        assertThat(CompareCondition.Op.GTE.eval("4", 3), is(true));     
    ...
    public void testOpEvalGT() throws Exception {
        ...
        assertThat(CompareCondition.Op.GT.eval(3, "2"), is(true));     
        assertThat(CompareCondition.Op.GT.eval(3, "4"), is(false));    
        assertThat(CompareCondition.Op.GT.eval(3, "a"), is(false));    
        assertThat(CompareCondition.Op.GT.eval("4", 3), is(true));     
    ...
    public void testOpEvalLTE() throws Exception {
        ...
        assertThat(CompareCondition.Op.LTE.eval(3, "2"), is(false));     
        assertThat(CompareCondition.Op.LTE.eval(3, "4"), is(true));    
        assertThat(CompareCondition.Op.LTE.eval(3, "a"), is(true));    
        assertThat(CompareCondition.Op.LTE.eval("4", 3), is(false));     
    ...
    public void testOpEvalLT() throws Exception {
        ...
        assertThat(CompareCondition.Op.LT.eval(3, "2"), is(false));     
        assertThat(CompareCondition.Op.LT.eval(3, "4"), is(true));    
        assertThat(CompareCondition.Op.LT.eval(3, "a"), is(true));    
        assertThat(CompareCondition.Op.LT.eval("4", 3), is(false));     
